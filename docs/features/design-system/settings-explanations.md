...
The current implementation slice covers 189 controls:
...
| School mode | Shared display name and enabled state, setup credential and confirmation, credential-vault unlock input |
...
and one-time-link provenance, all 189 inventory IDs, and the deliberate red
inventory mutation.
