...
- [Historical Linux TUI prototype](linux-tui/README.md) — archived July 27
  mouse/keyboard, package, XDG, RE2, security, parity, and acceptance records;
  not a supported product edition or Windows-release blocker.
