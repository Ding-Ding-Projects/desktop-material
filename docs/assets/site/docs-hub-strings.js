...
;(function (global) {
  ...
  var en = {
    ...
    fixed: {
      ...
      subnavFeatures: 'Feature categories',
      subnavReference: 'Reference sections',
      subOverview: 'Overview',
      subGuides: 'Guides',
      categoryIndex: 'Category index',
      docsCount: 'documents',
      docsCountOne: 'document',
      secContributing: 'Contributing',
      secTechnical: 'Technical notes',
      secProcess: 'Process',
      secVerification: 'Verification records',
      secIntegrations: 'Provider integrations',
      secLearnMore: 'Learn more',
      secWiki: 'Wiki pages',
      secHandoff: 'Handoff records',
      secPostman: 'Postman collections',
      secRoot: 'Top-level pages',
      secReadmeTabs: 'README tabs',
      ...
      densityNote:
        'Compact removes whitespace only. Every control keeps its full click and touch target.',
      prefAccent: 'Accent colour',
      accentViolet: 'Violet',
      accentTeal: 'Teal',
      accentAmber: 'Amber',
      accentRose: 'Rose',
      ...
      heroBadge: 'Windows desktop · Linux TUI · Material Design 3',
      ctaInstall: 'Install on Windows',
      ctaFeatures: 'Browse features',
      ctaSearch: 'Search the docs',
      ctaRepo: 'View the repository',
      fact1: 'Windows x64 installer/ZIP · Linux TUI wheel',
      fact2: 'TypeScript · Electron · Python · Textual',
      ...
      searchDock: 'Documentation search',
      searchScope:
        'This search box stays on every tab, and results appear here whichever tab you are reading.',
    ...
    tone: {
      ...
      heroLead: [
        'Desktop Material is a Material Design 3 (M3 Expressive) remake of GitHub Desktop: a Windows graphical edition plus a separate Linux-first terminal preview. This hub indexes every feature document, reference, verification record and contributor guide in the repository.',
        'Desktop Material rebuilds the GitHub Desktop shell on Material Design 3 for Windows and now adapts a documented subset into a Linux-first TUI. Start here for feature documents, references, verification records and contributor guides.',
        'A Windows Material Design 3 desktop and a Linux-first terminal sibling: the same Git domain, two honest support boundaries. Every feature, reference and verification record is indexed below.',
        'Take GitHub Desktop, rebuild the graphical shell in Material Design 3, then give Linux terminals a clickable, text-box-friendly sibling with its own parity ledger. Everything shipped is written down below.',
        'GitHub Desktop went in, the Windows shell came out Material Design 3, and a Linux TUI turned up with a mouse and actual text boxes. Then somebody made both editions show their receipts. That page is this one.',
      ],
      installTitle: [
        'Install',
  ...
  var yue = {
    ...
    fixed: {
      ...
      navLabel: '文件分區',
      subnavFeatures: '功能分類',
      subnavReference: '參考分區',
      subOverview: '概覽',
      subGuides: '指南',
      categoryIndex: '分類索引',
      docsCount: '份文件',
      docsCountOne: '份文件',
      secContributing: '參與貢獻',
      secTechnical: '技術筆記',
      secProcess: '流程',
      secVerification: '驗證紀錄',
      secIntegrations: '供應商整合',
      secLearnMore: '延伸閱讀',
      secWiki: 'Wiki 頁面',
      secHandoff: '交接紀錄',
      secPostman: 'Postman 集合',
      secRoot: '頂層頁面',
      secReadmeTabs: 'README 分頁',
      ...
      densityCompact: '緊湊',
      densityNote: '緊湊模式淨係收窄留白，唔會縮細任何控制項嘅點撳同觸控範圍。',
      prefAccent: '主色',
      accentViolet: '紫',
      accentTeal: '藍綠',
      accentAmber: '琥珀',
      ...
      heroBadge: 'Windows 圖形版 · Linux TUI · Material Design 3',
      ctaInstall: '喺 Windows 安裝',
      ctaFeatures: '睇功能文件',
      ctaSearch: '搜尋文件',
      ctaRepo: '睇原始碼倉庫',
      fact1: 'Windows x64 安裝檔／ZIP · Linux TUI wheel',
      fact2: 'TypeScript · Electron · Python · Textual',
      ...
      searchDock: '文件搜尋',
      searchScope:
        '呢個搜尋框喺每個分頁都會留喺度，無論你睇緊邊個分頁，結果都會喺呢度出現。',
      searchLabel: '搜尋文件目錄',
    ...
    tone: {
      ...
      heroLead: [
        'Desktop Material 係 GitHub Desktop 嘅 Material Design 3（M3 Expressive）重製版：Windows 圖形版之外，另有獨立 Linux-first 終端預覽。呢度整理咗倉庫入面所有功能文件、參考、驗證紀錄同貢獻指南。',
        'Desktop Material 用 Material Design 3 重寫 Windows 圖形外殼，而家仲將有文件證據嘅功能搬入 Linux-first TUI。功能文件、參考、驗證紀錄同貢獻指南都由呢度入手。',
        'Windows 有 Material Design 3 圖形版，Linux 有獨立終端兄弟版；同一套 Git 範疇，兩條支援界線都講到明。所有功能、參考同驗證紀錄都喺下面。',
        '攞 GitHub Desktop，Windows 圖形殼用 Material Design 3 重砌，再俾 Linux 終端一個撳得、真係有 text box 嘅兄弟版；做過嘅嘢全部寫低晒喺下面。',
        'GitHub Desktop 拆咗殼，Windows 換上 Material Design 3，Linux TUI 仲帶埋滑鼠同真 text box 入場。兩邊做過咩都要交收據，你而家睇緊嘅就係嗰堆。',
      ],
      installTitle: [
        '安裝',
        '安裝 Desktop Material',
