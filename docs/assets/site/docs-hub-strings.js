...
;(function (global) {
  ...
  var en = {
    ...
    fixed: {
      ...
      accentCustom: 'Custom',
      accentCustomHint:
        'Any colour, entered or picked. Contrast against white and black is shown as you choose.',
      accentPicker: {
        picker: 'Accent colour picker',
        field: 'Saturation and brightness',
        hue: 'Hue',
        alpha: 'Opacity',
        entry: 'Enter any colour',
        translator: 'Every notation',
        valueSuffix: 'value',
        copy: 'Copy',
        copyPrefix: 'Copy',
        copied: 'Copied',
        recent: 'Recent',
        reset: 'Reset to violet',
        previewPrefix: 'Current accent',
        clipped: 'outside sRGB — clipped',
        undefinedName: 'no CSS name',
        gamutWarning:
          'That colour lies outside sRGB. The value shown is the nearest colour this screen can display.',
        contrastOnLight: 'On white',
        contrastOnDark: 'On black',
        invalid:
          'That is not a colour this page can read. Your text is kept so you can correct it.',
      },
      tabsUi: {
        announceClosed: 'Tabs hidden from the strip',
        announceGroupCreated: 'Group created',
        announceGroupRemoved: 'Group removed. Its tabs are now ungrouped.',
        announceMoved: 'Tab moved',
        announcePinned: 'Tab pinned',
        announceUnpinned: 'Tab unpinned',
        builder: 'Open the regex builder',
        builderShort: '.*',
        bulkContains: 'Close tabs containing text',
        bulkEmpty: 'Enter text first. An empty query never closes a tab.',
        bulkInvalid: 'Invalid pattern. Nothing will close.',
        bulkNotContains: 'Close tabs not containing text',
        bulkPinnedExcluded: 'Pinned tabs kept',
        bulkPinnedIncluded: 'Pinned tabs that would close',
        bulkQuery: 'Text to match',
        bulkStale: 'Preview again to see what would close.',
        bulkTimeout: 'Pattern took too long. Nothing will close.',
        bulkUnavailable: 'Could not match. Nothing will close.',
        ...
        groupMembers: 'Tabs in this group',
        ...
        noGroupMatches: 'No group name matches that query.',
        noMatches: 'No tab matches that query.',
        overflow: 'More',
        overflowHint: 'Tabs that do not fit',
        pinned: 'Pinned',
        regex: 'Regex',
        removeGroup: 'Remove group',
        restore: 'Restore',
        searchAll: 'Search every open tab',
        searchGroups: 'Search tab groups by name',
        searchInGroup: 'Search tabs in this group',
        searchStrip: 'Search this tab strip',
        statusInvalid: 'Invalid pattern. Showing every tab.',
        statusInvalidFlags: 'Unsupported or repeated flag. Showing every tab.',
        statusTimeout: 'Pattern took too long. Showing every tab.',
        statusTooLong: 'Pattern is too long.',
        statusTooMany: 'Too many tabs to match safely.',
        statusUnavailable: 'Could not match. Showing every tab.',
    ...
    tone: {
      ...
      changelogTitle: [
        'Changelog',
        'Release changelog',
        'Every release, all the way back',
        'The whole paper trail',
        'Six hundred-odd releases and counting',
      ],
      changelogLead: [
        'Every recorded release, with its date where one exists.',
        'Every recorded release and its date, filterable and searchable.',
        'Filter by date, search the text, export what you see.',
        'All of it. Filter by date, search it, take a copy away.',
        'The lot. Sift by date, hunt with regex, and take a Markdown copy.',
      ],
      linksTitle: [
        'Project links',
  ...
  var yue = {
    ...
    fixed: {
      ...
      navChangelog: '更新記錄',
      accentCustom: '自訂',
      accentCustomHint: '任何顏色都揀得,揀嘅時候會即時顯示白底同黑底嘅對比度。',
      accentPicker: {
        picker: '主色選擇器',
        field: '飽和度同亮度',
        hue: '色相',
        ...
        reset: '還原做紫色',
        previewPrefix: '而家嘅主色',
        clipped: '超出 sRGB — 已夾到最近色',
        undefinedName: '冇 CSS 名',
        gamutWarning: '呢隻色超出 sRGB。顯示嘅係螢幕最接近嘅顏色。',
        contrastOnLight: '白底',
        contrastOnDark: '黑底',
        invalid: '呢個唔係本頁讀得明嘅顏色。你打嘅字會留住,可以改。',
      },
      tabsUi: {
        announceClosed: '已經喺分頁列收埋',
        announceGroupCreated: '已經開好群組',
        announceGroupRemoved: '已經移除群組。入面嘅分頁而家冇群組。',
        announceMoved: '分頁已經搬位',
        announcePinned: '分頁已經釘住',
        announceUnpinned: '分頁已經解除釘住',
        builder: '打開正則表達式砌法器',
        builderShort: '.*',
        bulkContains: '關閉含有指定文字嘅分頁',
        bulkEmpty: '要先輸入文字。空白查詢唔會關任何分頁。',
        bulkInvalid: '樣式唔正確。唔會關任何分頁。',
        bulkNotContains: '關閉唔含有指定文字嘅分頁',
        bulkPinnedExcluded: '釘住嘅分頁會保留',
        bulkPinnedIncluded: '會一齊關嘅釘住分頁',
        bulkQuery: '要配對嘅文字',
        bulkStale: '再預覽一次先睇得到會關咩。',
        bulkTimeout: '樣式行得太久。唔會關任何分頁。',
        bulkUnavailable: '配對唔到。唔會關任何分頁。',
        collapse: '收起群組',
        collapsed: '已收起',
        expand: '展開群組',
        expanded: '已展開',
        groupColor: '群組顏色',
        groupDefaultName: '新群組',
        groupMembers: '呢個群組入面嘅分頁',
        groupName: '群組名',
        manage: '管理分頁',
        modePlain: '文字',
        modeRegex: '正則',
        ...
        restore: '還原',
        searchAll: '搜尋所有開住嘅分頁',
        searchGroups: '用名搜尋分頁群組',
        searchInGroup: '搜尋呢個群組入面嘅分頁',
        searchStrip: '搜尋呢條分頁列',
        statusInvalid: '樣式唔正確。顯示全部分頁。',
        statusInvalidFlags: '唔支援或者重複嘅旗標。顯示全部分頁。',
        statusTimeout: '樣式行得太久。顯示全部分頁。',
        statusTooLong: '樣式太長。',
        statusTooMany: '分頁太多,安全咁配對唔到。',
        statusUnavailable: '配對唔到。顯示全部分頁。',
        toolbar: '分頁控制',
        ungrouped: '未分組',
        unnamedGroup: '未命名群組',
      },
    ...
    tone: {
      ...
      changelogLead: [
        ...
        '揀日期、搵字、將睇到嘅嘢匯出。',
        '全部都喺度。篩日期、搵字,仲可以帶份走。',
        '一個都冇少。用日期篩、用 regex 掘,再攞份 Markdown 走。',
      ],
      linksTitle: [
        '專案連結',
        '專案同社群連結',
