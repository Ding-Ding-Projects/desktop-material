...
;(function (global) {
    ...
    releases: [
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Dragging commits in History onto the spot they already occupy is ignored again instead of reordering them through a rebase. Row numbers were compared as text, so a selection spanning row ten stopped looking contiguous',
            '4ec0782ef0e6556165936f333382b9fb1591f8a2',
          ],
          [
            'Fixed',
            'Expanding a diff hunk moves the keyboard to the nearest remaining expansion button rather than a distant one, on files with ten or more expandable hunks',
            '38ca712e34fe3dc03b19aa4da9fc04e480197ed7',
          ],
          [
            'Fixed',
            'A diff selection group is announced as its real line range. Screen readers heard "Lines 10 to 9" for a group covering lines 8 to 12',
            '98a831eac2cfa1e57e2af23d9b9fbf248632e2ef',
          ],
          [
            'Fixed',
            'Typing a letter in a menu reaches the item directly below the selection, and repeated presses cycle through every match instead of sticking',
            '36fe1e66243b80de88d4324683bc9dba6b5ae6a8',
          ],
          [
            'Fixed',
            'Exporting several stashes no longer leaves one cancellation listener behind per archived tree, which Node reported as a leak past ten',
            '6d8d3140e4b88ad9823f4e841c67b2c794d8b232',
          ],
          [
            'Fixed',
            'Closing the repository list while a row is refreshing its appearance no longer updates a row that is already gone',
            '1ca3cc9272c554e9d31d1f19900f7ed912945839',
          ],
          [
            'Added',
            'The application chrome is the Material Design 3 shell: eight destinations behind a navigation drawer, a 56px application header with a global search field, and a content pane whose header carries the repository and branch breadcrumbs, the fetch and push controls and the pane menu',
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Added',
            "Every one of the shell's eleven search fields keeps its own query and its own regex mode. A pattern built in the regex builder is written into the field that opened it and arms that field alone, so building one pattern can no longer rewrite a query somebody is still looking at",
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Added',
            "The regex builder opens from every search field and from every menu's own filter row. Applying a pattern to a menu filter reopens that menu with the pattern already in place",
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Added',
            'Show the classic toolbar, on Settings then Appearance. The toolbar band the shell replaced is kept rather than retired and the setting ships on; turning it off loses nothing, because every action the band carries is also on the pane header or in the pane menu',
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Added',
            'The repository tab strip is unchanged and still shown by default. Multi-repository tabs are a real capability of this fork that the single-repository design prototype never drew',
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Added',
            'The eight destination views - History, Changes, Branches, Actions, Inbox, Terminal, Agents and Repositories - together with a shared destructive-action gate, the show-emojis-in-dialogs toggle, an offline documentation browser over every feature article, QR registration with a built-in RFC 6238 authenticator, the Support Tickets recovery desk, and per-tab and per-appearance-value locks that each carry their own credential',
            'ed0749fc1604fd0cff4a21d1b6a65927e96a9cef',
          ],
          [
            'Fixed',
            "A disabled affirmative button no longer gates only the mouse. A dialog marked destructive made its cancel control the form's submit button, so pressing Enter anywhere in the form ran the destructive path however the button looked",
            'ed0749fc1604fd0cff4a21d1b6a65927e96a9cef',
          ],
          [
            'Fixed',
            'A removal that silently becomes a permanent delete when the Recycle Bin step fails now re-arms its confirmation gate against what will actually happen, instead of carrying the approval given for the gentler outcome',
            'ed0749fc1604fd0cff4a21d1b6a65927e96a9cef',
          ],
          [
            'Added',
            'The shared shell foundation: the style contract and primitives, the application header, the navigation drawer, the pane header, the filterable menu overlay covering all 23 menu kinds, the regex builder dialog, the commit composer and the toast host',
            '4f587f092616776c8763461f7818b08c6d5678b0',
          ],
          [
            'Fixed',
            'The navigation model is readable again. The drawer wrote its destination separator as a raw NUL byte rather than the escape, so git, grep and every diff viewer classified the one file carrying that model as binary',
            '72867cf170119313f91386719bec5f90157ae949',
          ],
          [
            'Fixed',
            "The dark theme's green container token matches the design contract. It was the last colour of the set still out of step; contrast against its on-colour is 9.97:1 either way",
            '72867cf170119313f91386719bec5f90157ae949',
          ],
          [
            'Improved',
            'The bundled icon font carries 158 ligatures instead of 98. More than half the new interface would otherwise have rendered the literal English word where a glyph was meant to be, because a ligature font that does not know a name simply prints it',
            '0f48c44ad05233bf50a58db2e966f7924278b07b',
          ],
          [
            'Improved',
            'The design contract is a checkable inventory read out of the design file rather than a hand-typed checklist, so a surface nobody noticed was in the design cannot pass unbuilt',
            'e45d54d0e18891f91c3af655e2928ded8b9bcec7',
          ],
          [
            'Improved',
            'A frozen feature ledger runs from the recorded baseline at the tree and fails naming anything that went missing during the rewrite. A capability may move; it may only disappear by being recorded as retired with a reason',
            '51ed516b8b25a3316ac0928de226149d3c32d67e',
          ],
          [
            'Improved',
            'Nine conformance checks walk the design file and demand the implementation carry what they find, including every menu item label and every icon ligature resolved against the bundled font',
            'c663645db8115329157385c604bb86248d52b29d',
          ],
          [
            'Improved',
            'Screenshot coverage is enumerated rather than asserted, so a surface the new shell introduced cannot go unphotographed simply because no test ever named the file',
            'ab23749689d164df33e0adee375410bfdccc0f37',
          ],
          [
            'Added',
            'Show the classic toolbar is reachable from the command palette as a live switch and from settings search, and teleports to its own row on Settings then Appearance',
            '5aa2b582c23de7256dbed0b860b79934f618272e',
          ],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            ...
            '549839c45965f420f324ea7a8245f4779725720c',
          ],
          [
            'Added',
            'The Create Branch dialog shows live checkout progress and offers a checkbox to skip cloning submodules',
            '549839c45965f420f324ea7a8245f4779725720c',
          ],
          [
            'Fixed',
            'Submitting the Create Branch dialog from the keyboard no longer creates the same branch twice',
            '549839c45965f420f324ea7a8245f4779725720c',
          ],
          [
            'Added',
            'The push dropdown offers to diagnose a rejected push with OpenCode, with force-pushing, commit rewriting and branch switching ruled out',
            '549839c45965f420f324ea7a8245f4779725720c',
          ],
          [
            'Added',
            'Forking a repository lets you pick which signed-in account performs the fork and which organization it lands in',
            '25a1858fe3ead498ed1f1473bcdccefc8e4fe628',
          ],
          [
            'Added',
            'Repositories hosted where forking is unavailable can be copied into a new repository instead, keeping the original as upstream',
            '25a1858fe3ead498ed1f1473bcdccefc8e4fe628',
          ],
          [
            'Improved',
            'The Releases page starts with its five statistic cards collapsed, keeps the headline counts in the toggle, and remembers whether they were reopened',
            'eacdc17e96fab1fd61525bf33e64a16996b19f66',
          ],
          [
            'Improved',
            'The missing read:packages permission message now offers a sign-in button that requests the permission instead of only naming it',
            'eacdc17e96fab1fd61525bf33e64a16996b19f66',
          ],
          [
            'Fixed',
            'The Releases search and filter row can be collapsed at any window size, not just in a very narrow window',
            '40d5ff679b9732849b44493c84267e81a0ecba5c',
          ],
          [
            'Fixed',
            'The Reload buttons on the crash screen and the startup screen work again instead of doing nothing',
            '66d446266ecbd6c9dccf2a9d5ac9dacabc0fa17a',
          ],
          [
            'Fixed',
            'The repository logo editor no longer grows a second, redundant scrollbar',
            '66d446266ecbd6c9dccf2a9d5ac9dacabc0fa17a',
          ],
          [
            'Improved',
            'The feature gallery screenshots are re-shot against the current build, so they show the app as it looks today',
            '66d446266ecbd6c9dccf2a9d5ac9dacabc0fa17a',
          ],
          [
            'Added',
            'The website now covers the language modes, the two playfulness sliders, the in-app changelog viewer, external editor integration, the spoken narrator and the dim sum surprise',
            '309ad27736e5657907398fcc0d1491ee7233f40c',
          ],
          [
            'Improved',
            'The installer, package and portable download buttons hand over the newest published build directly instead of opening a list of releases',
            '309ad27736e5657907398fcc0d1491ee7233f40c',
          ],
          [
            'Removed',
            "The website's setting for turning off the dim sum surprise is gone, and the surprise now appears on one visit in ten",
            '309ad27736e5657907398fcc0d1491ee7233f40c',
          ],
          [
            'Improved',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Release history lists every recorded release and its entries inside the app, searchable, filterable by category and date range, and readable with no network connection',
            'f89f162d3d0edbcf2a161514c98603312f721c78',
          ],
          [
            'Added',
            'A shared date picker offers presets, month and year jumps, range selection, and typed dates in either ISO or the local format, reporting an incomplete date without erasing what was typed',
            'f89f162d3d0edbcf2a161514c98603312f721c78',
          ],
          [
            'Improved',
            "The command palette opens as a full-screen search view and renders each setting's real switch, text box, or dropdown inline, so a setting can be changed without hunting for the screen it lives on",
            'da6cf4e83346bb6552fedb9761fd06bc16cdcffe',
          ],
          [
            'Added',
            'Choosing a command palette result jumps to where that feature lives and highlights it, while Ctrl+Enter still runs the command directly',
            'da6cf4e83346bb6552fedb9761fd06bc16cdcffe',
          ],
          [
            'Fixed',
            "The regex builder opened from a right-click menu can be clicked and typed into instead of sitting under the menu's invisible backdrop, where the first press dismissed the menu and discarded the half-built pattern",
            '4942f2025c269b4db0c8994ba0496d56fccd8038',
          ],
          [
            'Fixed',
            'Right-clicking a text field lists Cut, Copy, Paste, and Select all instead of showing a single blank row',
            '4942f2025c269b4db0c8994ba0496d56fccd8038',
          ],
          [
            'Added',
            'Right-click menu items show their keyboard shortcut and announce it to screen readers',
            '4942f2025c269b4db0c8994ba0496d56fccd8038',
          ],
          [
            'Fixed',
            'A transient Git launch failure is retried once and a failed refresh of a single repository no longer interrupts the rest, so repeated background error popups stop',
            '20d1390430ca85267d0c51dfe7f55a17bd16bca2',
          ],
          [
            'Fixed',
            'Automatic large-file discovery skips ordinary Git metadata such as .gitmodules while still refusing an explicitly selected oversized protected path',
            '20d1390430ca85267d0c51dfe7f55a17bd16bca2',
          ],
          [
            'Fixed',
            'An already-staged .gitmodules entry is restored exactly as it was when a submodule operation has to roll back',
            '20d1390430ca85267d0c51dfe7f55a17bd16bca2',
          ],
          [
            'Improved',
            'The repository list filter collapses into a disclosure panel instead of permanently occupying the top of the list',
            '8912bcf3cdf9bbd5298884dde5e827801282e619',
          ],
          [
            'Added',
            'Hovering a commit in History shows its relative time as a tooltip',
            '8912bcf3cdf9bbd5298884dde5e827801282e619',
          ],
          [
            'Improved',
            'The force-cancel option in the workflow run cancellation dialog carries an accessible name, so a screen reader announces what the checkbox does',
            '35f8a25ded1b74ecbb2debba87b21ad71ae74c83',
          ],
          [
            'Fixed',
            'The security policy and contributing guides point at this project, so vulnerability reports are no longer routed to the upstream repository',
            'f35fcb76da7f51b9f7868ce6f05738d0513eb8b0',
          ],
          [
            'Added',
            'The documentation site gains a Changelog tab listing every recorded release with its date and entries',
            '8cfd28bab1596a5a797ce342848800910e69fe54',
          ],
          [
            'Added',
            'The documentation site uses browser-style tabs with an overflow surface, pinning, grouping, four tab searches, and both bulk-close actions',
            '471e086ddd7d89dd1b011dd59449c15a20ec1b5d',
          ],
          [
            'Improved',
            "The documentation site's accent colour comes from a continuous colour picker with twelve editable notations and a live contrast readout instead of four fixed swatches",
            'cc6c0338696ffc2e90040e8e87fbef1ece1dfb7a',
          ],
          [
            'Fixed',
            "The landing page and every rendered documentation page load the site's interactive features, including the dim sum surprise, which previously appeared on neither",
            'b4d9d6f8200328c4c98cda256ff571e8e0ec09b3',
          ],
          [
            'Improved',
            'Release entries show a 24-hour time beside the date wherever the release tag recorded one, and a release with no tag still says its date is unrecorded rather than showing a guess',
            'b4d9d6f8200328c4c98cda256ff571e8e0ec09b3',
          ],
          [
            'Improved',
            'The documentation site loads its changelog data when that tab is opened rather than making every visitor wait for it before the first page appears',
            'fe9a6a312b059090533305d4ec56241b89c4c998',
          ],
          [
            'Added',
            'Every screenshot in the gallery gets its own documentation page with working search, theme, language, and appearance controls',
            '443234a236eefe08de232db1fc75978708e59389',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            'The cancel confirmation for a workflow run offers a Force cancel option for runs that ignore an ordinary cancellation, and says which kind was sent',
            'aa74bcc42f1f39b37d4e622135fafee8c805159a',
          ],
          [
            'Added',
            "The Workflows tab shows how long each workflow's most recent completed run took, and omits the duration rather than guessing when it cannot be stated accurately",
            '10446a1c195325322c19401490f2b184c5198b66',
          ],
          [
            'Fixed',
            'The built-in browser renders the page instead of opening to a blank area below its toolbar and address bar',
            '10446a1c195325322c19401490f2b184c5198b66',
          ],
          [
            'Fixed',
            'A tooltip from a right-click menu disappears with the menu instead of lingering in the corner of the window describing a button that is gone',
            'b2c107990ac1cc2c130cc683e641ddefbac8cfd6',
          ],
          [
            'Fixed',
            'A failed scheduled commit shows a single notification naming the real cause instead of two, one of which said only that the commit failed',
            'b2c107990ac1cc2c130cc683e641ddefbac8cfd6',
          ],
          [
            'Improved',
            'Text in the repository releases pane is legibly sized, including the release dates, status badges, asset digests and the filter-mode buttons',
            'd4471884435d1b42f324cbb3590c9ef5b1286503',
          ],
          [
            'Improved',
            'Web links open in the system browser by default, an explicit choice of the built-in browser survives a profile restore, and a link that fails to open reports it instead of doing nothing',
            'd0afea98ed5d770888e2f949d6e44cb26e02e2df',
          ],
          [
            'Improved',
            'Moving a tab into a group opens a searchable, keyboard-operable chooser instead of a context menu that grew with every group',
            'b4f3aabc5a537d1aed812aecf286769a4ae0c338',
          ],
          [
            'Fixed',
            'The window close, minimize and maximize buttons stay on screen at narrow widths instead of being pushed past the right edge',
            'ac8e2b6a6be07ec5215a30b7fab5c2fdf0981304',
          ],
          [
            'Fixed',
            'The Windows title bar keeps a dedicated drag area, so the window can be moved by its top edge again',
            'a647bd33ea8fd3350ed73917764f9268e19a6b49',
          ],
          [
            'Fixed',
            'Choosing an organization when publishing a repository uses a searchable, keyboard-complete list that no longer hides choices or overflows a narrow dialog',
            '63c1ec08c4f24f85d87f21d98851dcd5784c7800',
          ],
          [
            'Added',
            'The Sync repositories dialog can merge reviewed branches into the main branch, push without forcing, and remove local branches and worktrees only after proving each one is already contained remotely',
            'a9a154380ea3b32c4dff71666bbc32496873d487',
          ],
          [
            'Fixed',
            'Turning on Cheap LFS cloud compression for a confirmed private repository now actually publishes its workflow instead of preparing one that never ran',
            'de3522eaeb9fc2302381119723edcd09b237753b',
          ],
          [
            'Improved',
            "Cheap LFS keeps submodules out of a parent repository's setup, refuses to commit while a restore still owns the files, and verifies each workflow file, branch and remote tip before changing it",
            '118e47931d36c6e078bd6e934d1aaa5f5fb8236c',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            'Merge conflicts can be handed to a local Codex or OpenCode session straight from the conflicts dialog, with the branches and conflicted files already described in the prompt',
            'f401e7d49a7c9e688105aa200d4c66ec14f35912',
          ],
          [
            'Added',
            'A failed workflow run offers a Fix CI action that opens a local Codex or OpenCode task describing the failing jobs, so the fix can be verified locally before pushing',
            'f401e7d49a7c9e688105aa200d4c66ec14f35912',
          ],
          [
            'Improved',
            'Long-running background work now reports elapsed time and an estimated finish, and its progress panel can be hidden and reopened without stopping the task',
            'f401e7d49a7c9e688105aa200d4c66ec14f35912',
          ],
          [
            'Improved',
            'Cheap LFS restore progress details can be collapsed and expanded instead of always occupying the full panel',
            'f401e7d49a7c9e688105aa200d4c66ec14f35912',
          ],
          [
            'Added',
            'The command palette can now reach conflict repair, CI repair, showing or hiding background progress, and toggling Cheap LFS restore details',
            'f401e7d49a7c9e688105aa200d4c66ec14f35912',
          ],
          [
            'Improved',
            'The repository list toolbar keeps Add and Select in view and moves the remaining workspace actions into a localized More menu so the toolbar no longer crowds at narrow widths',
            'd99c09886001f778f11cbf51db67021e76b4f4ad',
          ],
          [
            'Added',
            'Logs can optionally be sent to a self-hosted diagnostic server with credentials redacted on both ends, while local-only logging stays the default and a slow or unreachable server never holds up the app',
            '1f777ad518d740dec5e1334de1a1e36e32f85ac2',
          ],
          [
            'Fixed',
            'A failing post-commit hook in the repository no longer makes an automatic Cheap LFS workflow commit report as failed after Git has already committed it',
            '1f777ad518d740dec5e1334de1a1e36e32f85ac2',
          ],
          [
            'Fixed',
            'Closing Desktop Material on Windows waits for pending settings and profile history writes to finish instead of quitting mid-write',
            'ac0e50fc2d4571ffe0ec8c6d72f929988daf35cb',
          ],
          [
            'Fixed',
            'Cancelling a quit or window close returns the app to a fully usable state rather than leaving it half shut down',
            'ac0e50fc2d4571ffe0ec8c6d72f929988daf35cb',
          ],
          [
            'Fixed',
            'Profile history writes no longer stall behind a stale lock file left over from an interrupted session',
            'ac0e50fc2d4571ffe0ec8c6d72f929988daf35cb',
          ],
          [
            'Improved',
            'Sign-in credentials are compiled into the main window only, keeping them out of the command-line, crash reporter, and quick action bundles',
            'fb2dd929ee9e280db7528d3ba7eb3df2b4fdf55b',
          ],
          [
            'Improved',
            'The releases view search filter, case, and regex builder buttons now fit inside the search field in short, narrow windows and at high zoom',
            'b3d4701fe83a30307b6321936b8f29b45fd11b20',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            "Right-clicking a tab, a repository row, or a diff opens that surface's own context menu again, with Shift+right-click reserved for the appearance editor",
            'da345bf2206fb4b11bef1d8a733d38c2c1ed5511',
          ],
          [
            'Fixed',
            'Removing a repository also clears its saved large-file encryption password from the operating system credential store',
            '334a60158987000b0f27cfe1f41fab49ea2f3553',
          ],
          [
            'Fixed',
            'A scheduled commit in a repository with encrypted large-file storage and no saved password now skips those large files and reports the skip, instead of waiting on a password dialog with nobody there to answer it',
            '911f23d644eb5caf0c0ad6da32d2c69bbda1f957',
          ],
          [
            'Fixed',
            'The New and Edit tab group dialogs open as proper centered dialogs instead of being laid out inside the tab strip, where toolbar buttons painted over the group colour swatches',
            'a3e81b7aeedc7f880f8ec7ace3e24f67c8b82d0b',
          ],
          [
            'Fixed',
            'A tooltip opened by keyboard focus appears beside its control and stays inside the window instead of landing half off the top-left corner',
            'a3e81b7aeedc7f880f8ec7ace3e24f67c8b82d0b',
          ],
          [
            'Fixed',
            'Tab group colour swatches wrap onto a second row so every colour stays visible and selectable at any window size',
            '58d543a1807b26d0b97f61a7aad74a8ae0b223f8',
          ],
          [
            'Fixed',
            'A tab group holding a single tab reads "1 tab" in its dropdown and in what screen readers announce, instead of "1 tabs"',
            '398c18695505b6a82fc12ff222785d4524bba6f2',
          ],
          [
            'Improved',
            "The two playfulness sliders are no longer duplicated under the Sound tab's text-to-speech heading, leaving a single pair in Appearance settings",
            '14eb8c62a71aa285442213f984415d202b3d4795',
          ],
          [
            'Added',
            'Each repository can upload large files over one, two, or three parallel connections instead of a single on-or-off setting',
            'be1f167b18d4dee3ebaea4d00909507cdab52ccc',
          ],
          [
            'Added',
            'The branch list marks branches already checked out in another worktree and offers to switch to that worktree instead of creating a second one',
            'adf29991ebb2cabeec31c6eac7153f758de8c7c6',
          ],
          [
            'Fixed',
            'Scanning a working tree for large-file pointers no longer exhausts memory on multi-gigabyte files such as model weights',
            '2fedf140e394fa2fea3e380203e716b6f7aa8628',
          ],
          [
            'Fixed',
            "Restoring large files in several repositories at once keeps each repository's progress separate instead of one restore clearing another's status",
            'a15e2a8804c72915e1c29fc98a4f32b1a6a85e13',
          ],
          [
            'Improved',
            "Switching between a repository's sections responds immediately, and author details load only for the commits actually on screen",
            'ac718ef75490a91a63eb2bc08d8837488d79195f',
          ],
          [
            'Fixed',
            'Author avatars and keyboard tooltips no longer show details cached from an earlier session, repository, or pointer position',
            'fe8b5b0eb759310dcd0ed94936b98ad2bdd0a193',
          ],
          [
            'Fixed',
            'Clicking inside the Regex Builder no longer closes the search popover it was opened from',
            'a8e32008cfc880a27851fe84b7deef8794836e15',
          ],
          [
            'Fixed',
            'Arrow keys keep working in tab and settings search when a query has no results, and those fields no longer announce a results list that is not on screen',
            '9486bd4f0ac5941ac8b1248d901903c02ff9024a',
          ],
          [
            'Improved',
            'The open-tab search renders entirely in the selected language mode, including its status text, chips, and screen-reader labels',
            'a12edcf5a1fd5d831c864376a6d737aa7e557553',
          ],
          [
            'Improved',
            'The plain-text and regex mode controls beside search fields meet the minimum 40-pixel target size and keep a visible focus outline',
            '2d1baa98105d7827470dae5abcbbbed7de31d6e7',
          ],
          [
            'Fixed',
            'Bundled dependencies move to patched releases, clearing the known security advisories reported against the app',
            'b339c5a21b7ec519fa4bf1d6506bb30aee82a067',
          ],
          [
            'Fixed',
            'An update that has finished downloading offers to restart and install right away instead of waiting for release notes to be fetched first',
            '85ba698f56ef94c433e65b4427acb0e098ca52cc',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Cheap LFS payloads can be encrypted with a passphrase before they are uploaded, so a release asset never carries readable file contents',
            '75b45da89d494e031d01332a6c30c5407d371e21',
          ],
          [
            'New',
            'Links and provider sign-in prompts open in a built-in tabbed browser with URL entry, bookmarks, and a one-press switch to the system browser',
            'ba6d6b246dbdcd975606c5d159f18b0c767f143a',
          ],
          [
            'Added',
            'Every repository row shows how many commits are waiting to push or pull, and says so plainly when there is no upstream to compare against instead of reporting a false zero',
            '63a6b08c0f1a92ae75a848f128b5cf11a3b0bd0c',
          ],
          [
            'Added',
            'Repository list group headings collapse and expand, remember which groups are folded across restarts, and always open while a filter is running so a search hit can never hide inside a fold',
            '066b8cf3187160964740ee32e30422094be47606',
          ],
          [
            'Added',
            'Repository and tab groups can be created, renamed, recoloured and removed from their own menus, and a collapsed tab group lists its members in a dropdown so you can switch without expanding it first',
            '3aab211e3e5c47e6da9dcda0955655b937146a15',
          ],
          [
            'Added',
            'The overflowed-tabs dropdown has its own search field with the full regex builder, plus per-row appearance editing and the complete tab command menu on right-click',
            '78ca28ad1b24f626d1b9339a4dde0b27c1c994b6',
          ],
          [
            'Added',
            'Cheap LFS restore shows a detailed progress card with the current and prefetched downloads, file and byte totals, transfer rate, estimated time remaining, and a cancel action',
            'ba6d6b246dbdcd975606c5d159f18b0c767f143a',
          ],
          [
            'Added',
            'A pull whose upstream branch was deleted on the remote now offers to check out the default branch and pull that instead, and refuses to move a worktree with uncommitted or conflicted changes',
            '89dda34356b282495c0ddca6e2ab37b903fea9bb',
          ],
          [
            'Added',
            'Ignored files such as node_modules, virtual environments or large checkpoints can be moved into a new local submodule, with every copy verified before the original repository is touched',
            'dcbdd07b3c955cdea46d23507e3cd898daa574ed',
          ],
          [
            'Added',
            'The documentation site is now organized into tabs with a search field, plain-text or regular-expression matching, and the regex builder available on every tab',
            '963505001b3e9b65861e5375630690890f6a182f',
          ],
          [
            'Improved',
            'The app window paints immediately at launch, scanning for installed external editors in the background and loading heavy repository tabs only when they are opened',
            '48f27c3f6037dd2c5a950d4b2218cae8dacbf571',
          ],
          [
            'Improved',
            "Cloud compression on a private repository no longer runs on that repository's own Actions minutes and no longer publishes its name or file paths",
            'b07bcd3d16d213e6af8467468a2c223e50d049dc',
          ],
          [
            'Improved',
            'Pinning a file to an OCI registry reads the payload three times instead of seven, so pinning a multi-gigabyte file finishes considerably sooner',
            '50b5645da2560c57a5c3d5b30d1f8cee29cf400d',
          ],
          [
            'Improved',
            'The two funny-level sliders now sit in Appearance beside the language mode with a live preview for each language, instead of being filed under Sound',
            '102abbb0f88fe5e198cb83d64eecbef634b62d69',
          ],
          [
            'Fixed',
            'A failed push, force push, pull or fetch reports the actual error instead of a generic notice saying a background action stopped unexpectedly',
            '35ce1e059ed6aed22b6e4965144ff03efdba7254',
          ],
          [
            'Fixed',
            'The Windows Explorer right-click menu no longer silently disappears after the app updates, and Settings reports a stale registration instead of showing an enabled toggle that does nothing',
            '9da9586c617fd82cbc524a7fed5ba207d3a26db4',
          ],
          [
            'Fixed',
            'Cheap LFS no longer picks up its own in-progress download files and uploads them to a release when a commit runs during a clone',
            'dd3e79143b18b55dc398fb3303ed44094b706905',
          ],
          [
            'Fixed',
            'A file just pinned to Cheap LFS stays on disk after the commit instead of being downloaded again on the next fetch, pull or repository open',
            'b9275ac0197b5c66078b0840812a2be33125242f',
          ],
          [
            'Fixed',
            'Long Chinese and other non-Latin file names pin to Cheap LFS instead of failing partway through an upload with assets already on the release',
            '694f3405de9ecd6cd7d73678c6d1a30f00411cdd',
          ],
          [
            'Fixed',
            "Committing and pushing in a repository that uses Cheap LFS no longer copies every materialized multi-gigabyte payload into the repository's object database",
            'd5a1223a675f4ef7bfc9d1d179b411b627a1d914',
          ],
          [
            'Fixed',
            'Settings > Git shows a visible label above the email box when no account is signed in, instead of an unlabelled field under Name',
            'e28d940eff3e28e1b1a1dcc16b10cb9252d78cfa',
          ],
          [
            'Fixed',
            'Diagrams on the documentation site render as pictures in both light and dark themes instead of shipping as raw diagram source',
            '60b19f3801d93417ca4ba967bbfbcb01cb84f506',
          ],
          [
            'Fixed',
            'The documentation search page no longer freezes the tab on a slow or malicious regular expression, evaluating patterns in a background worker with a hard deadline',
            '24ba111b5bd868b6a6d3eb1e622bae5bd457f7f1',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Right-clicking a folder in Windows Explorer offers Desktop Material entries, appearing in the top-level Windows 11 menu on packaged builds',
            '12d3ed460074755b669b272efde7e3e314b8daf3',
          ],
          [
            'New',
            "A GitHub Packages explorer browses packages and versions and transfers files to and from a repository's container registry",
            'f8eca3ac844e8eaec2dc2dce635f57874b4e92bc',
          ],
          [
            'Added',
            "The Add Submodule dialog loads the remote's branches into a searchable picker instead of requiring the branch name to be typed by hand",
            '9b375560d953b8a72d39de9b1c7bd2f512e56ec7',
          ],
          [
            'Added',
            'Repository Settings gains an Appearance tab collecting the list name, logo, tab, toolbar, and workspace colour editors for that repository',
            '2ec16ceea8f6c302f11285cdb3799d82d76fc615',
          ],
          [
            'Added',
            "Editing a pinned large file uploads a new version of it, so checking out an older commit still restores that commit's exact bytes",
            '3e7bf75d201172608b21b55eccdd1dd15c949e0b',
          ],
          [
            'Added',
            'The Repository Tools tracked-content search supports the shared filter modes, a case toggle, and the full regex builder',
            'e61eb9bd2dc16232f13f781c6f6d6ea439dedb98',
          ],
          [
            'Fixed',
            'Signing in to an additional account is kept instead of being silently dropped and gone again on the next launch',
            '46c442350e25b58da43364b214cd1f1dd80cd1d6',
          ],
          [
            'Fixed',
            'An expired token signs out only the account it belongs to rather than whichever account sorts first on that host',
            '3e692befb2c5df4fc8faee4c5a2f4f4688e89285',
          ],
          [
            'Fixed',
            'Answering "Not now" to the additional-permissions prompt is remembered instead of the prompt returning at every launch',
            '6a8a752ae1791c4347a4dc117ebd2c2337aeabec',
          ],
          [
            'Fixed',
            'A large-file upload whose helper exits mid-transfer no longer brings down the app with an unrecoverable error',
            'e7be123636eb3277c0256eaa0e51f3892c4ad346',
          ],
          [
            'Fixed',
            'Pushing works when the unpushed commits include a merge commit, instead of failing with a non-linear history error',
            'fa6f9a954b329b0615b0db96f9981c56c89bb725',
          ],
          [
            'Fixed',
            'Pinning a large batch of files no longer aborts partway through claiming that the release, asset, repository, or account changed',
            '297ccc82b8924b90ebf08ab24a9d44cee9532dd0',
          ],
          [
            'Fixed',
            'Large-file uploads and probes confirm the remote first, so a renamed or transferred repository is never pushed to its old address',
            '72ad7d33a1b38ed5b7f20620dfafca02704fd7ff',
          ],
          [
            'Fixed',
            'The version history search bar shows its filter mode controls and regex builder like every other search bar',
            '789caaa1904c6cc52787d4b0d360e06a202c5acf',
          ],
          [
            'Fixed',
            'Text no longer clips in the conflict banner, long Actions log lines scroll horizontally, and the filtered empty state stops covering Clear filters',
            '9d3552aa0e4d9bd009cdf23686c309388460c0e1',
          ],
          [
            'Fixed',
            'Searching no longer pauses with a slow-pattern warning after a momentary stall, and never warns during plain-text search',
            'cdd39d03011b259d011ccfec0e2f369a9da176e2',
          ],
          [
            'Fixed',
            'Viewing one diff after another no longer holds every previous diff in memory for the rest of the session',
            '290ec7dcdfb031364f598a7d5c996a3abd9cbe07',
          ],
          [
            'Fixed',
            'Installed apps keep receiving updates when a push lands while a release is still building',
            '2e62c5a2a632cde8e4a079810488b84c3dd162ed',
          ],
          [
            'Improved',
            'Times display in 24-hour format by default, with the 12-hour choice still available in Date and time settings',
            '7cc31d9a8b6af8007dcb126200301ed36df47437',
          ],
          [
            'Improved',
            'Long lists in History, Actions, and Releases scroll and filter smoothly in large repositories',
            'e5e4a2c68b09e43dc8ff2ee0e01f5fd3215ff862',
          ],
          [
            'Improved',
            'The notification centre, large TGA image previews, and streaming Ollama chat replies no longer freeze the window while they work',
            'd877d1eba538f608957edb0b63997d0e29d6d68c',
          ],
          [
            'Improved',
            'Large files upload in 500 MiB parts, so a dropped transfer retries far less data and progress updates more often',
            'e27976c33758a306677e439f816ddbd03bf956a9',
          ],
          [
            'Improved',
            'Pinning and committing large files finishes noticeably faster, especially with many files at once',
            '1e16f5d01b6a5af7b465e6fc1f7b479370ffd5d3',
          ],
          [
            'Improved',
            'Cancelling a package upload or download restores the transfer controls instead of leaving them stuck',
            '7cf168fbd4f534edb71f7686254224efe817dec5',
          ],
          [
            'Improved',
            'Large-file preferences move into their own Cheap LFS tab in Repository Settings instead of sharing the Build and run tab',
            '37077d8cf53923efd90d8c1aaea2e74f99b4eeef',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Long-running operations such as history deepening, tag pushes, bulk branch deletion, bisect, subtree splits, and batch cloning show a progress bar and status instead of appearing frozen',
            'b3d7d626b89148e218efe06779ad3f4402f34958',
          ],
          [
            'Added',
            'The repository list gains a multi-select mode for fetching, pulling, favoriting, grouping, or removing several repositories at once, with per-repository progress that can be cancelled between repositories',
            'ce2406b5282ed47253aa930088339b50fed7a855',
          ],
          [
            'Added',
            'Ollama has its own Settings tab with an endpoint field and connection test, instead of being reachable only through the Copilot provider list',
            'ef559866a024cda53150a1d245d3739627318883',
          ],
          [
            'Added',
            'An incoming build is announced in a dismissible banner with an estimated arrival time and a details view showing the signals the estimate is based on',
            '37b30c326e18e1408224f0a479019218133e7b1c',
          ],
          [
            'Added',
            'A Load all button pages through every release in the repository, so search and filters cover the whole list instead of only the pages already on screen',
            '9b1f0b043c6ce5b1e0c63a0c7ed1dff62ac791af',
          ],
          [
            'Added',
            'Releases can be sorted newest or oldest first from a control beside the status filter, and the choice persists and composes with search',
            '08bb47fad086bfd1c9b7f6e1978139a5f614ff63',
          ],
          [
            'Added',
            'A downloaded installer asset offers a Silent install button that names the exact file it will run and reports the real exit code when it finishes',
            '08bb47fad086bfd1c9b7f6e1978139a5f614ff63',
          ],
          [
            'Fixed',
            'Double-clicking an action that opens a file, folder, terminal, or external editor launches it once instead of starting duplicates',
            '4d6729f151c84d402d4d1d41d0fb8994d6c137d6',
          ],
          [
            'Fixed',
            'Committing an untracked nested repository records its submodule link, so a fresh clone no longer comes back with a missing Git link',
            '7b069262eefadda3be7ee1c49a40011ba8f76d17',
          ],
          [
            'Fixed',
            'Long pushes and fetches no longer fail partway with an invalid credential token or leave a repository holding its lock files behind a background-failure notice',
            'b363c82ba06bf2c3ed174fc30031d8dd72eafa2d',
          ],
          [
            'Fixed',
            'An update feed advertising a version older than the installed app is treated as no update instead of moving the installation backwards',
            '1aebfc9424113a373b955ac6527255fce7760d88',
          ],
          [
            'Fixed',
            "The local version history panel no longer repeats entries while paging or shows two repositories' timelines mixed together",
            '843ef1253ec9fbac1b689231eba378bb90eb1ce4',
          ],
          [
            'Fixed',
            'Git hooks that read standard input, including the stock Git LFS hooks, run correctly under the bundled Git on Windows instead of failing before they start',
            '1323fa49b933096ddda56852b0af66584902d428',
          ],
          [
            'Fixed',
            'Uploading Cheap LFS files from a branch that has never been published now publishes the branch first instead of failing validation on every file',
            '3a7f5984cff7d3c0326096c719c3af5e93a09736',
          ],
          [
            'Fixed',
            'A Cheap LFS publish that is aborted names the reason on every affected file row, in the summary, and in a notification that stays until dismissed instead of stopping silently',
            '1323fa49b933096ddda56852b0af66584902d428',
          ],
          [
            'Fixed',
            'Pushing a very large repository no longer aborts with a file-busy error while its temporary index is being cleaned up',
            '96d4375c077f40c62ec44871ef67a830fb46eb69',
          ],
          [
            'Fixed',
            'Enabling Cheap LFS cloud compression commits and publishes the workflow it needs in the background, so compression actually runs instead of waiting on a manual commit',
            '054e0e6bb18543bd3f34fa8ee019a758c17f7d75',
          ],
          [
            'Fixed',
            'Double-clicking Manual upload starts a single upload instead of two',
            '4578d0820ffa485ade3f49edaa7ac85dfb429d54',
          ],
          [
            'Fixed',
            'A slow but progressing multi-gigabyte release upload no longer times out, while a connection that moves no data for fifteen minutes still fails and can be retried',
            '4578d0820ffa485ade3f49edaa7ac85dfb429d54',
          ],
          [
            'Fixed',
            'An oversized update-check response is reported once as a clear notification instead of a generic message about a background action stopping unexpectedly',
            '96d4375c077f40c62ec44871ef67a830fb46eb69',
          ],
          [
            'Improved',
            'A repository that appears not to exist is retried under every other signed-in account on the same host across releases, issues, and Actions instead of stopping at the first not-found response',
            '115ec875dfc1531ec27d76205ae79a00fa0260fc',
          ],
          [
            'Improved',
            'Bulk release deletion shows determinate progress, offers to stop after the release in flight, and continues past a failure with a reason listed for each release it could not delete',
            '9b1f0b043c6ce5b1e0c63a0c7ed1dff62ac791af',
          ],
          [
            'Improved',
            'Repositories with hundreds of thousands of files can be published in one pass, with the path ceiling raised from 100,000 to 600,000',
            '1323fa49b933096ddda56852b0af66584902d428',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'An optional sound system adds a spoken narrator, sound effects and per-repository music, all off by default and controlled from a new Sound pane in Preferences',
            '4a081380f1acc2f9fb36054ea81a15e01614d154',
          ],
          [
            'Added',
            'The narrator plays pre-recorded English and Cantonese voice clips for each event through a single non-overlapping queue, falling back to live speech when a clip is missing',
            '082f16a72a44f9dc7619afcf67bfd9b849ceca38',
          ],
          [
            'Added',
            'Push, fetch, pull and each Build and run phase get their own sound cue instead of sharing the commit sound, with a per-cue audition grid in Sound settings',
            'b21728560cacbbb86408cc27600d69f7b0df0b9c',
          ],
          [
            'Added',
            'Each repository gets its own generated theme music, with preview, track choice and mute controls in Sound settings',
            '85a9d311f50dac7f5bdaf7bcad41f880d4a9edb9',
          ],
          [
            'New',
            'The Preferences dialog gains a search box that finds settings across every tab by title, description or keyword and jumps to the tab holding the match',
            'a19b9e0ef3495f0ada95c901289522f675338009',
          ],
          [
            'Added',
            'Repository tabs that no longer fit the strip move into a keyboard-accessible overflow menu instead of being clipped, keeping the active tab and collapsed group chips on screen',
            '4e3fa0ee46755e1741e40e54eb692c0031e4b19a',
          ],
          [
            'New',
            "Run a repository's GitHub Actions workflows on your own machine with act and Docker, including streaming logs, dispatch inputs, per-run secrets, a dry run and cancel",
            '085acb241f2bdf6c0c9ff112d21c5ba0bdcdaf85',
          ],
          [
            'New',
            'Recognized Git failures such as a stale index lock, a stalled background maintenance run, a rejected non-fast-forward push or a commit on a detached HEAD offer a one-click fix in the error notification, and destructive fixes never run on their own',
            '2b5f790238372eb01bfa48bb6efa8293bdbc5ff7',
          ],
          [
            'Added',
            'Very large repositories pause background Git maintenance during status, staging, checkout and fetch, clear stale index locks, show an explicit checking-for-changes state instead of claiming no changes, and offer to compress a nested Git folder',
            '264ccae1e0480edc84f19cd93e5387a22819d6bb',
          ],
          [
            'Added',
            'With the repack-when-idle setting on, a large repository is repacked once at a quiet moment, with progress, success or failure reported in the notification centre',
            'f6f748db48e64fe9912c2c9fa270782303c5023a',
          ],
          [
            'Added',
            'Committing and pushing an enormous set of changes is split into batches capped at 10,000 files or 1.4 GB, with per-batch progress and each batch pushed before the next one starts',
            '1bf5a8a0f7cd46362a3515af86568b30c0659452',
          ],
          [
            'Improved',
            'Status refreshes, commits and large-file detection no longer rescan the whole working tree, cutting a refresh on a repository of over 200,000 files from roughly 49 seconds to milliseconds',
            '473f14e2eb8762d68c1d500aad5e8607e8a624c2',
          ],
          [
            'Fixed',
            'Committing in a large-file repository no longer aborts because of an unusual Windows path, an included submodule folder or a shortened repository root, and any remaining refusal names the file it applies to',
            '560fe8f7bce5363a66a4d8f261ab708b4ae45fb3',
          ],
          [
            'Fixed',
            'Committing an untracked submodule records a real submodule link again, so a fresh clone no longer reports a missing Git link and the submodule diff shows its target commit',
            '5394e607c539e7c5a4d83399eeeacac7d7bfda2e',
          ],
          [
            'Fixed',
            'The regex builder is no longer clipped inside smaller dialogs such as clone, preferences and repository settings, keeping its pattern palette, test area and Apply button reachable',
            '25906657b3977b30902311fbeb125a240134ba72',
          ],
          [
            'Added',
            'The stash manager inventory gains a search filter with plain text, fuzzy and regex modes and the full inline regex builder',
            '13f92244f4eb804229a050a86157818673b9e467',
          ],
          [
            'Added',
            'The batch clone queue, the local workflow run log and the branch rules inspector each gain a search filter with the full regex builder, including live filtering of streaming log output',
            'd8289a2f013778d415cb711519325ab43dc2d7f0',
          ],
          [
            'Improved',
            'Sound settings, Ollama chat, large-file settings, per-repository automation overrides, the tag lifecycle manager and the GitHub API explorer can now be found by name from the command palette and settings search',
            'd04c97bae999ad313a09a54fce12f8f9a66ffa94',
          ],
          [
            'Improved',
            'Build and run results reach the notification centre even when its panel is closed or minimized, and the toolbar button and panel controls are fully translated',
            'f9a683ed169b51e8e70f6d45e862512abdb80772',
          ],
          [
            'Added',
            'The Windows install script gains a build-from-source mode that checks prerequisites, clones or updates the repository, builds it and launches the result, with a dry run that prints the plan first',
            '5756d30816a2d81467789d9cecc53f94386bace0',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Large files can be stored in a GitHub Container Registry or Docker Hub image instead of prerelease assets, chosen per repository, with encrypted chunks for private sources and restore-while-signed-out for public ones',
            '5d63a22b0fcdf14491200f2ad437b349e67f1474',
          ],
          [
            'New',
            'Commits that would push more than about 1.5 GB at once are split automatically into smaller commits and pushes, with each remote tip proven before the next one is created and a durable checkpoint to resume after a failure',
            '5d63a22b0fcdf14491200f2ad437b349e67f1474',
          ],
          [
            'New',
            "A compact progress panel below Commit reports each large file's upload phase and byte progress across up to three parallel uploads, reachable and readable with the keyboard",
            '5d63a22b0fcdf14491200f2ad437b349e67f1474',
          ],
          [
            'Added',
            'The Changes list can be filtered to show only files over the 100 MiB large-file threshold',
            '5d63a22b0fcdf14491200f2ad437b349e67f1474',
          ],
          [
            'Added',
            'A downloaded release asset can be opened directly from the Releases view once its contents are verified',
            'e3e574358bb88810fcd19f8c35788662478251c8',
          ],
          [
            'Improved',
            'The Releases view keeps its cards, tools, and buttons on screen at narrow window widths and up to 200% display scale, and announces the current selection to screen readers',
            '513c5cc96aee045a218837530a11951e8466b618',
          ],
          [
            'Improved',
            'Release timestamps use an unambiguous 24-hour clock, so midnight is shown as 00 instead of 24',
            'c3db37ea5524b91f9603151ae5d1107205f16a59',
          ],
          [
            'Improved',
            'Committing ordinary files is faster because their contents are no longer hashed for large-file checks unless the file is actually oversized',
            '34e156039f40d7d4b29b0ac2650b0149d984b723',
          ],
          [
            'Improved',
            'Automatic batched pushes complete faster by skipping redundant repacking, while hooks, credentials, and remote verification are unchanged',
            '21c4de4a7311d7024b69a0796eedb062d375d98c',
          ],
          [
            'Fixed',
            'Ordinary files under .github can be committed again instead of being rejected by the large-file path check',
            '4935e133134c855dbd5e66015057e9094bb5112a',
          ],
          [
            'Fixed',
            'Committing the deletion of a file whose path Windows cannot represent, such as one created on another platform, is no longer blocked',
            '9a0be385a149169e4f974703563b6c0a66547112',
          ],
          [
            'Added',
            'The Large files manager says where its settings live and opens Repository settings → Build & run directly',
            '9a0be385a149169e4f974703563b6c0a66547112',
          ],
          [
            'Fixed',
            'Automatic, single-file, and Materialize all restores share one queue per repository, so overlapping restores no longer collide or leave duplicate recovery files behind',
            'a64c1cb54c456d2d0a8a8873002f3b0257bd001f',
          ],
          [
            'Fixed',
            'Canceling Materialize all stops every queued download in the repository rather than letting a background fetch restart them, and the panel reports how many files failed instead of always claiming success',
            'e3fb8c8664506033ddee687a4e1e9f37770a6020',
          ],
          [
            'Fixed',
            'Queued cloud compression runs no longer cancel one another, so a run started while another is in progress still finishes',
            'fd8f35ff00940a77d919ae3268e8a7d457d4a11d',
          ],
          [
            'Improved',
            'Commits written by the automatic cloud compression job are recorded in both English and Cantonese',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Repository tabs can be collected into named, colored groups that collapse behind a chip, stay together when the strip is sorted, and survive a restart',
            '58be6fe5953477b015a134c414a8cf82363ecc75',
          ],
          [
            'New',
            'Files pinned with Cheap LFS can be compressed in the cloud after upload, automatically for public repositories and only after opting in for private ones, with the manager showing whether each file is raw, compressed, or mixed',
            'f7b4760a13894f0320f7b361f055f6fba40d913f',
          ],
          [
            'Added',
            'The Ollama model manager, the Copilot providers settings tab, and the background action queue can be found by name in the command palette',
            'dfdf144154793ffdcaac22c5db60632fedec3bb9',
          ],
          [
            'Fixed',
            'Pressing Alt opens the application menu again immediately after a key press that another surface had already handled',
            '58be6fe5953477b015a134c414a8cf82363ecc75',
          ],
          [
            'Fixed',
            'New Cheap LFS parts are capped at 1.5 GiB so large uploads no longer fail near the 2 GiB release-asset ceiling, while existing pointers up to 2 GiB stay readable',
            'd1d9a29f038795fb001cd29abd2e904a1e06adc9',
          ],
          [
            'Improved',
            'Release asset uploads no longer apply stall or total-runtime timeouts, so a slow transfer ends only on completion, failure, or cancellation',
            'd1d9a29f038795fb001cd29abd2e904a1e06adc9',
          ],
          [
            'Fixed',
            'The large files manager finds a release by tag even while it is still an unpublished draft, instead of reporting the tag as missing',
            '58be6fe5953477b015a134c414a8cf82363ecc75',
          ],
          [
            'Added',
            'The documentation site gains a sticky search field wired to the regex builder and a collapsible menu on narrow screens',
            '0413a6f29b909c815cbc3d2f4681f4609438214c',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Right-clicking the toolbar Pull button opens the reviewed pull preview that fetches first and summarizes the incoming commits, changed files and integration route, while a plain left click still pulls straight away',
            'e78461a5fe10c7296517ed4d3154b1cf609ceaf5',
          ],
          [
            'New',
            'Settings gains a Clone queue page where each signed-in account sets its own base directory, parallel or sequential mode, and whether newly discovered repositories are cloned automatically in the background',
            'fa4806971c5515766fee5a0ab03a76adfdd11d79',
          ],
          [
            'Added',
            'Agent access settings can open a mobile connection page that generates a fresh five-minute single-use pairing link and opens it in the default browser once paired LAN mode is running',
            'fa4806971c5515766fee5a0ab03a76adfdd11d79',
          ],
          [
            'New',
            'A chat workspace for local Ollama models keeps named conversations with model selection, streaming replies and saved history across sessions',
            'd6dd74b9d761f3b384788af8b2a8889213017d4b',
          ],
          [
            'Added',
            'A Send to opencode composer lets a free-form request be written, sent, and watched live in the Build & Run panel, with install guidance when opencode is missing',
            'b5534c67077befc849328324d718c5eb7887fa40',
          ],
          [
            'Improved',
            'The workflow dispatch selector is now a searchable list with fuzzy, substring and regular-expression filtering plus full keyboard navigation instead of a row of chips',
            'b5534c67077befc849328324d718c5eb7887fa40',
          ],
          [
            'Added',
            'Deleting a repository folder falls back to permanent deletion when the Recycle Bin refuses it, so a removal no longer simply fails',
            'b5534c67077befc849328324d718c5eb7887fa40',
          ],
          [
            'Added',
            'The repository rail carries a Large files entry that opens the release-backed large-file manager directly instead of going through Repository Tools',
            '08744f77b70e1e418236da5f754424a7619b6ebc',
          ],
          [
            'Added',
            'Large files can be pinned to release assets by hand from the commit area, with separate hashing, upload and verification progress and a pointer staged in place of the binary',
            '41ce24d6b8c573a6378f28657ea4a64155ebec53',
          ],
          [
            'Added',
            'The Build & Run log adds jump-to-newest, auto-scroll and truncate-long-lines controls, with the two toggles remembered between sessions and full text still copied by Copy all output',
            '0de3e08b01b7e62f359074cbdbe71876dd4effd5',
          ],
          [
            'Fixed',
            'The whole window no longer oscillates when auto-fit is on, because the zoom calculation is driven by a zoom-invariant window size instead of one that changed each time the zoom was applied',
            'b94445f6a2c005833dbdaa516ca45b4c871fdea0',
          ],
          [
            'Improved',
            'The last remaining legacy icons, empty-state illustrations, window controls, tooltips, spinners and easing curves are replaced with Material Symbols and design tokens across the navigation rail, lists, toolbar and dialogs',
            'b94445f6a2c005833dbdaa516ca45b4c871fdea0',
          ],
          [
            'Fixed',
            "The clone dialog lists an account's organizations again instead of showing nothing when that account's repositories were already cached",
            'f9043531eb27ed50162a44c5d37e5a3d48036412',
          ],
          [
            'Fixed',
            'Automatic repository detection no longer offers linked worktrees or repositories that have already been added',
            'f9043531eb27ed50162a44c5d37e5a3d48036412',
          ],
          [
            'Fixed',
            'Local file paths are hidden in the settings history diff, so a home or profile folder is not exposed while screen-sharing',
            '7b319f92d87af188e47bea16ab467e70c103dcf8',
          ],
          [
            'Fixed',
            'Toolbar actions that collapse into the overflow menu on a narrow window show their full name and icon instead of a blank row',
            '148b297f2baa4bff6384a8b592869d97c98f888d',
          ],
          [
            'Fixed',
            'Pressing Escape to close the regex builder, a context menu or a dropdown inside the anchored appearance editor closes only that overlay rather than discarding the whole editing session',
            'daab0ac8e14e1f4cf3970fcd0278cc70162e6f62',
          ],
          [
            'Fixed',
            'Wide appearance editors are no longer clipped at the edge of the window',
            'ccef2d150786bc25f37eeb0898de522f77075250',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Preferences gains an Ollama model manager for browsing, downloading, and removing models on a local Ollama server',
            '90a1763dd32a04aa28ab925f27fa3f00a500942b',
          ],
          [
            'Improved',
            'Cancelling an Ollama model download restores the installed model list instead of leaving it empty',
            '2455814988b5771b6e2a1b9ea8f136dea2664832',
          ],
          [
            'Added',
            'Ollama is offered as a ready-made preset when adding a local model provider',
            '1b72868b8c87dc4c1f42159bac76c1b0fd03b8d0',
          ],
          [
            'New',
            'GitLab merge requests can be created, updated, and merged from the branch menu, the push flow, and a dedicated merge request workspace',
            '245d6628d9e59e1efc87d462e06230cdd7a9549c',
          ],
          [
            'Added',
            'A failed HTTPS push to an organization repository retries once with GitHub CLI credentials before reporting an error',
            '5cb569ea88fc9a3d20e4e0350ed82f05eb40214d',
          ],
          [
            'Improved',
            'Repository rows in the clone dialog show description, language, stars, forks, size, default branch, last update, and visibility, with filter chips for language',
            '5cb569ea88fc9a3d20e4e0350ed82f05eb40214d',
          ],
          [
            'Improved',
            'Notification, automation, integration, and advanced settings use Material switches, segmented controls, and card-based selectors',
            '5cb569ea88fc9a3d20e4e0350ed82f05eb40214d',
          ],
          [
            'Added',
            'The tab strip carries a settings commit chip, a settings history button, and undo and redo actions that disable when there is nothing to undo',
            '5cb569ea88fc9a3d20e4e0350ed82f05eb40214d',
          ],
          [
            'Improved',
            'Fetch, pull, and push on an organization repository use the account that repository is bound to rather than whichever account signed in first',
            'f21c6255bb8fd8978cd332c27f71e18cdc3fc549',
          ],
          [
            'Added',
            "A repository's API functions surface seeds read-only GitHub actions that run as buttons, and its rail item can be hidden or restored per repository",
            'cddb019b5364bb855fd7e327632ed1dc3571a7ec',
          ],
          [
            'Added',
            'Releases can be selected in bulk and published or deleted together after a confirmation that lists exactly what is affected',
            'ef8623f9e358eaef2337cf6835fd10a9ec85bedc',
          ],
          [
            'Added',
            'Adding a submodule can create its remote repository at the same time, validating the name and description before anything is created',
            'ef8623f9e358eaef2337cf6835fd10a9ec85bedc',
          ],
          [
            'Added',
            'Toolbar text has its own appearance editor covering font, weight, colour, spacing, and decoration',
            'd7d4ac10cf9c0193d671713b113b3b20c1b7a982',
          ],
          [
            'Improved',
            'Bring-your-own-key model providers stay configurable in preferences for accounts without Copilot access',
            '4c7f31914000a846a2dd68340dafbcb08cd5c55c',
          ],
          [
            'Fixed',
            'A dialog pushed behind a newer one can be closed again instead of silently ignoring every dismiss action',
            '69a74d3c5b1048529ac1f93e9647bf1e6e182df9',
          ],
          [
            'Fixed',
            'Refreshing stash details keeps the section you were looking at selected instead of jumping back to Changes',
            '72d9d2d9133d8c484fcf85cee178994916688058',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Open an initialized submodule from the Submodule Manager as a temporary repository in the current workspace, with a Back control that returns to the repository that opened it and no new entry added to the repository list',
            '751c9aef03a39f8e26caccbbf0949d221f870174',
          ],
          [
            'New',
            'Choose an explicit language mode in Settings — English, Hong Kong Cantonese, or bilingual — that stays where it is set instead of following the Windows locale',
            '751c9aef03a39f8e26caccbbf0949d221f870174',
          ],
          [
            'Added',
            'Style the temporary-submodule Back control as tonal, filled accent, or outlined, and label it with the parent repository name, "Back to parent", or an icon alone that still announces its destination',
            '751c9aef03a39f8e26caccbbf0949d221f870174',
          ],
          [
            'Improved',
            'Opening a submodule whose checkout has been replaced by a symlink or junction is refused outright rather than reported as merely uninitialized',
            '98d93ccc8e6be4b5ae43c8166273157dfc8eef9c',
          ],
          [
            'Fixed',
            'Scheduled commits and commit-and-push-all send oversized files through the same automatic Cheap LFS pinning as a commit made by hand, instead of trying to commit them directly',
            '84884238ec1925781668705ff5cc1ba055513654',
          ],
          [
            'Added',
            'Cheap LFS compresses each upload part when compression actually saves space, leaves already-compressed data alone, and restores the original bytes on download',
            '3b14243935b9dc3579f4d6ceed17e07bc274b939',
          ],
          [
            'Added',
            'A "Remove lock file" action appears on the error notice when a stale .git/index.lock is blocking Git, so a crashed operation can be cleared without leaving the app',
            '3b14243935b9dc3579f4d6ceed17e07bc274b939',
          ],
          [
            'New',
            'Review pull requests without leaving the app — browse changed files in a tree, expand diff context, comment, reply, resolve threads, approve, request changes, and inspect checks',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'New',
            'Create a pull request from inside the app with its full metadata, and receive notifications as activity arrives on it',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'New',
            'Check out an exact branch or commit from another fork of the current repository',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'Added',
            'Manage the complete tag lifecycle, including creating, pushing, and deleting local and remote tags with a review step before anything destructive runs',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'Added',
            'Stash only the files you select, give stashes names, and manage several stashes at once including ones created outside the app',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'Added',
            'Browse GitHub Projects in the app, backed by a last-known-good cache that shows an explicit stale or unavailable state when the network is down',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'Added',
            'Compare CSV and TSV files structurally instead of line by line, and preview TGA images in the diff view',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'Added',
            'Delete several reviewed local branches in one pass, edit the global ignore file, save allowlisted custom Git command presets, and open repositories on network shares or inside WSL',
            '7c98044bcebe5f65e51aee60af1036080fbd5110',
          ],
          [
            'New',
            'Right-click any customizable element — or focus it and press Shift+F10 — to open an appearance editor anchored beside that exact element, covering the toolbar, repository list, tab strip, code and diff surface, repository logos, and individual tab titles',
            '04581544cf323d8a6bc458e8908fcf5e11d4b93a',
          ],
          [
            'Added',
            'Every appearance owner keeps its own version history with diffs, undo, redo, and restore, so one visual change can be rolled back without disturbing any other setting',
            '04581544cf323d8a6bc458e8908fcf5e11d4b93a',
          ],
          [
            'Added',
            'Add several repositories at once from File → Add local repository → Auto-detect repositories…, which scans a folder for Git repositories and lists what it found for review',
            '04581544cf323d8a6bc458e8908fcf5e11d4b93a',
          ],
          [
            'Improved',
            'The commit button reports large-file preparation and upload progress, so pinning a multi-gigabyte file no longer looks like an ordinary commit that has stalled',
            '04581544cf323d8a6bc458e8908fcf5e11d4b93a',
          ],
          [
            'Improved',
            'Large-file uploads re-read the source after transfer to confirm the bytes still match, roll back partly uploaded parts when an upload fails, and never follow a symlink into its target',
            'cdedb4afb86588553a72222a729bfe4fc1e232e3',
          ],
          [
            'Removed',
            'macOS builds are no longer produced; Desktop Material ships for Windows only',
            '9c8303e91b4e8830060f1385161220f78aca2f57',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Cheap LFS uploads an oversized file to a GitHub release asset and commits a small pointer in its place, streaming files up to 2 GB and splitting anything larger into parts that materialize back into the original file',
            '6b4a4ebe729be7a861960ae96e6660b4993c88b5',
          ],
          [
            'Improved',
            'Cheap LFS pins oversized files to a release while committing instead of blocking the commit, and the size warning gains a Pin to release button when automatic pinning is unavailable',
            'f72d480ed3e80f55991ffbb6b5031e74ed89f52c',
          ],
          [
            'Improved',
            'The subtree manager stays available in Repository Tools before a repository has any subtrees, so the first one can actually be added, with a guiding empty state',
            '166057feee3d47186a2e140ed5f9916aa66a327b',
          ],
          [
            'Added',
            'Every submodule row offers a Configure dialog for its URL, branch, update strategy, ignore rule, shallow and fetch settings, alongside Sync, Init and Deinit actions',
            '76c2ff19851797ebebd494e71ae0a97b5746afe0',
          ],
          [
            'New',
            'Help > View Log History opens an in-app log viewer with timeline, diffs, search and restore, together with a verbose logging option in Advanced preferences',
            '0b2562693123d892fced3d7bd1bf8dee62d919fb',
          ],
          [
            'Improved',
            'Every search and filter bar carries the same fuzzy, substring and regex mode control with match case and a regex builder, and remembers the chosen mode per surface',
            '1861ae483ac78eb4c401daee4094747f5db1436a',
          ],
          [
            'Improved',
            'OpenCode build repairs stream their output into the build terminal, and a repair keeps running when its dialog is closed instead of being cancelled',
            'efd2969e50eec601e4c68c98e0bf332e617b4858',
          ],
          [
            'Fixed',
            'Build & Run runs Node, Gradle and Maven wrapper stages on Windows instead of failing immediately, picks the right Go run target from the module layout, and recognizes .slnx solutions',
            '4671ddddc6f2c4a227acab10341bae6c284261d4',
          ],
          [
            'New',
            'Repository settings can deploy to an SSH working copy with Docker Compose after a successful push, restricted to remotes that carry no embedded credentials',
            '889b4641ea6c41347905f0233acc4c87eed0b5a4',
          ],
          [
            'Improved',
            'The notification inbox loads every page of GitHub notifications instead of stopping at the first, and gains a Clear all action',
            '889b4641ea6c41347905f0233acc4c87eed0b5a4',
          ],
          [
            'Improved',
            'The Releases workspace becomes a searchable, filterable dashboard with full release metadata and assets',
            '889b4641ea6c41347905f0233acc4c87eed0b5a4',
          ],
          [
            'Fixed',
            'Releases whose notes span multiple lines load normally instead of failing the entire Releases view, and multi-line notes can be typed when creating a release',
            'c5da3041db7faceafb09db78a076674608d3c49b',
          ],
          [
            'New',
            'Right-clicking a notification opens an automations builder for rules that call a webhook or run a local command when a matching notification arrives, with every rule disabled until deliberately armed',
            '9bff08f5a71c7e63d8c590ca1db17c32153ae297',
          ],
          [
            'Improved',
            'Clone progress shows the current git stage, percentage, transfer speed and an estimated time remaining, plus a distinct submodule-fetching phase',
            'b9549bba27516b3b9d6f8fbd8f675bada1fa30eb',
          ],
          [
            'Fixed',
            'Cloning several repositories at once accepts a base folder that already contains files, since each repository clones into its own subfolder',
            'd535e54deaaf4416628dbe31112769784b14c732',
          ],
          [
            'Improved',
            'Batch clone recovery survives interrupted runs, offering Use existing folder and Skip on affected repositories with an inline notice instead of a blocking error',
            'abe607f9bfbbb5648699651a7d87246efe96cf6c',
          ],
          [
            'Added',
            "A repository tab's menu opens a read-only settings history scoped to just that tab",
            'abe607f9bfbbb5648699651a7d87246efe96cf6c',
          ],
          [
            'Fixed',
            'The context menu opens at the pointer on the very first right-click instead of jumping to the top-left corner',
            'fbef3115a4fb3297f0ce9bc2500f0f1118ec04e1',
          ],
          [
            'Added',
            "Selecting a repository switches the active account to that repository's owner, so the visible identity matches the work, with a toggle in Advanced preferences",
            '3d59a9c1c8c200ed7ad23c261e45c73527e499b3',
          ],
          [
            'Fixed',
            "Pushing authenticates as the repository's owner account when several accounts share the same host, instead of whichever account the credential helper found first",
            '6e36d718fef71328e08bb5a767248af1d40bd04e',
          ],
          [
            'Added',
            'Commit & push all pulls first, then commits and pushes every repository with local changes from the repository list, after confirming the message and the affected repositories',
            '55f6730bf4aa0f94f06aacb39b71cb1621f14563',
          ],
          [
            'Added',
            'The branch control shows a compact colour-coded CI status for the checked-out branch even when it has no pull request',
            'e0a3bca3ec94fcb94cdb6c7ac416270e8a632433',
          ],
          [
            'Added',
            'A thin progress bar along the top edge shows an app update downloading, in a colour chosen under Settings > Appearance',
            'e0a3bca3ec94fcb94cdb6c7ac416270e8a632433',
          ],
          [
            'Added',
            'CI status and update-download text follows the system language, with Traditional and Simplified Chinese alongside English',
            '19c1e2a06d0746f4c371d37a1c102ae961011f90',
          ],
          [
            'Added',
            "Settings > Appearance can mark Desktop Material's own features with an accent edge and badge to make them easier to find, off by default",
            '7134b380b166a97240cbed2ceb1a181c1bc61b15',
          ],
          [
            'Improved',
            'The submodule changes view is redesigned with a clearer old-to-new commit transition, copy buttons and a View on GitHub action',
            '4dd55ed7f554584ff311873ad3085c7126c548b5',
          ],
          [
            'Improved',
            'The Repository Tools hub groups its tools into seven plain-language categories with a one-line explanation of what each tool is for',
            'a70d9f2cbed027511d26bffb87443ee091a93ea6',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Ctrl+F opens a command palette that searches and runs every named command in the app, with find-in-view kept as one of its commands',
            '1b5438636ae9f1c74ce1644ccb69571fa0629d02',
          ],
          [
            'Improved',
            'The Actions view splits into Runs, Workflows, and Caches tabs, each with its own filter bar, instead of one deeply scrolling stack',
            'db13cab6fd54ae754304b29578599b3d41bf8763',
          ],
          [
            'Improved',
            'Right-click menus are drawn in the app as Material menus with icons, a type-to-filter box, and inline submenus, and now open on surfaces such as the tab strip where nothing appeared before',
            '9b4f830cfad7dec5c051724318325c664c202a53',
          ],
          [
            'Improved',
            'Picking an account in Settings or the rail switcher makes it the active identity rather than only highlighting the row',
            '69112d637432143f7cb489db8afb9e2a3b3cee4a',
          ],
          [
            'Added',
            'A sign-in whose token predates the permissions the app needs is detected and offered a re-authorization dialog instead of failing later on releases and workflows',
            '69112d637432143f7cb489db8afb9e2a3b3cee4a',
          ],
          [
            'Added',
            'The clone dialog filters repositories by All, Public, Private, or Forked, and the submodule manager gains a name, path, and URL search with status chips',
            'c5010be7385e6a84544d15caa1a566db73c98f17',
          ],
          [
            'Fixed',
            'Clicks in the clone repository lists land on the row under the pointer instead of a neighbouring one on large or scaled displays',
            '4c094e5d39788abc568c047d1d47027720425f5d',
          ],
          [
            'Added',
            'Right-clicking a commit in History offers Create worktree from commit, opening a new worktree with a branch at that commit',
            'fe4142280dd974c6336d6a41f52f8d2dcfff6aba',
          ],
          [
            'Added',
            "Clone lists show each repository's submodule count and can clone submodules individually, and a repository with submodules gains a submodule manager in its tools hub",
            'ec382695a56135a2a0d2928ffc7aff520cda9c15',
          ],
          [
            'Fixed',
            'Dialogs and the repository tools hub keep their controls reachable instead of clipping them in a narrow or short window',
            '751752142b8efa6b240148b1e3573ec6750dc73a',
          ],
          [
            'New',
            'Repository Settings gains an SSH working copy panel for managing a checkout that lives on a remote host',
            'e5f77b259fc8d4b13fe00df727a2526df16e0bdb',
          ],
          [
            'Added',
            'A floating account switcher, an app-bar theme toggle that cycles light, dark, and system, and a first-run checklist arrive with the Material Design 3 refresh of History, settings, and the clone dialog',
            '126bf1aa7eb6fe5875a145630f7348e3b1fcbe7e',
          ],
          [
            'Improved',
            'Checkboxes, radio buttons, sliders, and progress bars are drawn as Material Design 3 controls and follow the light and dark themes',
            'ee54ef7ebeeba1bd38274c78575b9a251ac0670d',
          ],
          [
            'Improved',
            'Dialog corners, the title bar, window controls, and the check-run popover use Material colors and elevation instead of the leftover legacy styling',
            '904dd8d156f137189b3ac6471e4f07f63da5e37f',
          ],
          [
            'Added',
            'The Actions view can add a workflow to the repository from a searchable catalog of starter templates',
            'd36c87ae3490159c7c73d13e0af463ddc5cb332b',
          ],
          [
            'Improved',
            'Per-repository appearance is a full editor with a live tab and list-row preview, accent swatches, segmented density controls, and inline list-name typography instead of a stack of dropdowns',
            'aa059e47fbde44cb0d808baf5d0f92afee65cd52',
          ],
          [
            'Added',
            'A repository can use its own font for its row in the repository list',
            'be12dc2989f802ab72ab3e62d646568d1a88c84c',
          ],
          [
            'Fixed',
            'Build & Run terminal log text meets contrast requirements in both themes, and notification clear confirmations are announced to screen readers and can no longer be skipped by a second keypress',
            '6306eadbe1ca41dae6057c12cbafbc717f5e20e0',
          ],
          [
            'Fixed',
            'Check-run descriptions, branch details, toolbar chips, and menu rows grow with larger interface fonts instead of clipping, and the tab close button, tab rename field, and split-button options show a visible keyboard focus indicator',
            '3ba00720400430a3eb2819b8ffafac90a9d82eab',
          ],
          [
            'Fixed',
            'The sync pill, ahead/behind badge, and repository and branch side-sheet rows size themselves correctly, so counts no longer spill outside their chip and rows no longer overlap or mis-target clicks',
            '6820650561da7d85f3f39f570b063299720c7788',
          ],
          [
            'Improved',
            'The GitHub API operation catalogs gain a Go to page selector that jumps straight to any page instead of stepping through with Next and Last',
            'a06df89b9d49dce879b96289b580a26221d8b646',
          ],
          [
            'Added',
            'A multi-repository clone can be paused and resumed, survives a restart or interrupted process, and keeps failed or review-required items visible until dismissed',
            'd96a7c5a40e375f48e33df92a37fa2d10fa26c59',
          ],
          [
            'Added',
            'A crash shows a recovery card and restores the session instead of leaving a blank window',
            'd96a7c5a40e375f48e33df92a37fa2d10fa26c59',
          ],
          [
            'Improved',
            "Build & Run installs missing toolchains on Windows, macOS, and Linux, and retries a failed build after restoring the project's dependencies",
            'f7e922110db8316f0163bd87aa7ac9c438b77ffc',
          ],
          [
            'Added',
            'Build & Run detects Dockerfile and Docker Compose projects as first-class build profiles',
            '065c6040ebf69db5c149a1a99cbffc8923fe57ca',
          ],
          [
            'Improved',
            'The push and pull toolbar pill is tinted by the operation it is about to run, so fetch, pull, push, and force-push are distinguishable at a glance',
            '065c6040ebf69db5c149a1a99cbffc8923fe57ca',
          ],
          [
            'Added',
            'A per-repository option starts the selected Build & Run profile after a pull that brings in new commits',
            'd3c0b2ecb475080c590d01bbf802c0eb9a4bf583',
          ],
          [
            'Added',
            'Repository Tools gains ten guided Git operations covering branch sync, contributors, version description, whitespace and conflict-marker auditing, ignored files, merged branches, prune and clean previews, untracked cleanup, and unreachable commit recovery',
            '7c405d7e5a85a4d6836bc593b53928d5b54c55d7',
          ],
          [
            'Added',
            'Repository Tools can search tracked content at an optional branch, tag, or commit, and add, replace, or remove a commit note behind a review step',
            'e2cc08eb4f516dc0a9e07598c7e65b6f5d170d0c',
          ],
          [
            'Added',
            'Search tabs switches to a tab by name, alias, path, or clone URL',
            'c351c8f9dd1a3ed6ed25722f49f8e51f3ccad283',
          ],
          [
            'Added',
            'The repository list filters by the account and provider a repository is bound to, with explicit scopes for local-only, unavailable, and signed-out repositories',
            'c351c8f9dd1a3ed6ed25722f49f8e51f3ccad283',
          ],
          [
            'Added',
            'A vector logo studio gives a repository a custom mark that follows it into its tab and its row in the repository list, with presets, live preview, undo and redo, and import and export',
            'fb15895289341f2e197fe9857e55ebfefab65497',
          ],
          [
            'Added',
            'A validated REST or GraphQL operation can be saved as a reusable app function bound to a specific repository, provider, and account, with every mutation returning to a visible review step',
            'fb15895289341f2e197fe9857e55ebfefab65497',
          ],
          [
            'Added',
            'Windows can be installed with a single copyable command, documented on the site, the wiki, and the README',
            'e493b413137ab8c49567cdf6c6bda4b65f8c1085',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'A GitHub API section in each repository lets you search the full REST and GraphQL operation catalog, fill in parameters for the open repository, and run a request against the signed-in account',
            '116f9eb315b94e62faac0f7947e26e928acd88a7',
          ],
          [
            'Improved',
            'Adding a submodule now opens a clone-style dialog where you pick a repository from a provider or paste a URL, then choose the checkout path and an optional branch',
            '666581bde29bad44780f26d66d7640b1aa89333a',
          ],
          [
            'Improved',
            'Cancelling a workflow run is offered only while the run is still queued, waiting, or running, and the confirmation names the workflow, run number, repository, and branch',
            '29c7b4875a57884064c9245ddd280e4383e34136',
          ],
          [
            'New',
            'An app identity editor in Preferences customizes the name, logo, colour, and typography shown in the title bar and window title',
            '4e797f52b9ecb4d77f40bfa1e11629fb2f8e3b95',
          ],
          [
            'Added',
            'The notification centre gains search, source and kind filters, visible selection, bulk mark read, mark unread and delete, and a labelled Clear all with a confirmation',
            '67411a6bfaed2d411b35bd9e9026e487f23bc54a',
          ],
          [
            'Added',
            'Errors that only need acknowledging appear as a dismissible notice in the bottom-right corner instead of a blocking dialog, with a preference to go back to dialogs',
            '67411a6bfaed2d411b35bd9e9026e487f23bc54a',
          ],
          [
            'Added',
            'The current set of tabs can be exported to a file and imported again from the File menu, so a tab workspace moves between profiles and machines',
            '4e797f52b9ecb4d77f40bfa1e11629fb2f8e3b95',
          ],
          [
            'Improved',
            'Dragging folders over the window now shows a drop target, and releasing them adds each folder as a repository',
            '4e797f52b9ecb4d77f40bfa1e11629fb2f8e3b95',
          ],
          [
            'Added',
            'The tab strip adds an Arrange tabs surface for moving, sorting, and pinning tabs, plus a Close all tabs except those containing action alongside the existing close-matching one',
            '9a9e68854e7bb9f0d08c18cde340518792771999',
          ],
          [
            'Added',
            'The tab appearance editor gains word-processor style formatting with font, size, case, spacing, emphasis, decoration, alignment, and text and highlight colours with a live preview',
            '3b68d09d4f898c6c647329b3d1b606f814161792',
          ],
          [
            'Improved',
            'Starting a rebase revalidates the repository first, shows that it is preparing, reports a failure inline in the dialog, and ignores a second submission while the first is running',
            'f035d8c6fe6e43b98a22192587f426f24a86fc6b',
          ],
          [
            'Improved',
            'The repository provider panel lets you choose which account it uses and offers sign-in or re-authentication when that account cannot load pull requests and issues',
            'f035d8c6fe6e43b98a22192587f426f24a86fc6b',
          ],
          [
            'Improved',
            "Pull All reports each repository's progress and final result while it runs, and the Changes list and commit form use a more compact layout",
            '1bc8a226de12996ffd01625aac69d4777ec2087f',
          ],
          [
            'Improved',
            'Toolbar controls move into the overflow menu based on their real label widths, so long branch and repository names stay readable at narrow and short window sizes',
            'a9e140de718d8fed064f3ae059d0f3c40b456628',
          ],
          [
            'Improved',
            'Screen readers announce a name for the branch and other list filter fields',
            'c5205838dfc5ee2b7ce80ce488215a2cd903bb26',
          ],
          [
            'Fixed',
            'The Regex Builder no longer clips its palette and test area at small window sizes',
            'aa68ef2b6a876a9766717acb2b4cc6301821d77e',
          ],
          [
            'Fixed',
            'Closing the Regex Builder returns focus to the field that opened it',
            '81c1c12005947306b29688290e41e5f10087e0a0',
          ],
          [
            'Fixed',
            'The Remote Manager collapses to a single column at narrow dialog widths instead of cutting off its columns',
            '624f2afc4cee1056a22097d5c19510e334d251a7',
          ],
          [
            'Fixed',
            'The Repository tools panel scrolls vertically again when its content is taller than the window',
            '24d3cdd5fa14049dfe671fba43431268281804f1',
          ],
          [
            'Fixed',
            'Repository settings keeps its footer buttons reachable at short window heights',
            'bc69c304dcdd33a193e251a97e83cc8be0598754',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'The first-run welcome flow is rebuilt as a Material 3 surface with a workspace preview beside the sign-in options',
            '1c1330e5bbe9afa1f6fd5c758ea9271ae1f1e1c0',
          ],
          [
            'Added',
            'Toolbar controls that no longer fit at narrow window widths collapse into a keyboard-accessible overflow menu instead of being clipped',
            'd3d34c76792ba87dc897d0be6c79d4673e527815',
          ],
          [
            'Added',
            'Preferences gains an Appearance section for accent and surface palette, elevation, interface and monospace fonts, motion, toolbar labels, and density, saved with the active profile',
            'f5a38d837e34daca5213ca3f1900f1dafc12cec7',
          ],
          [
            'Added',
            'Repository settings can override the accent palette, surface palette, toolbar labels, and tab density for a single repository, inheriting the app defaults for anything left unset',
            'f5a38d837e34daca5213ca3f1900f1dafc12cec7',
          ],
          [
            'Improved',
            "The tab appearance editor can return a tab's text or background color to the default instead of only accepting a custom one",
            'f5a38d837e34daca5213ca3f1900f1dafc12cec7',
          ],
          [
            'Improved',
            'Pull All reports live per-repository progress with a running completed count, and dismissing the dialog no longer loses an in-flight run',
            '28043ad1b719c42544fdb540560e14c9270dc198',
          ],
          [
            'Improved',
            "The project site's feature gallery covers the full shipped feature set rather than a short highlight list",
            '49603840e9844d0300627b32a401bb11d4538ea2',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'The Actions tab includes a cache manager that lists every repository cache with its size, ref and last-accessed time alongside total cache usage, and can delete a single cache or every cache sharing a key',
            'e282eb2fce7c9c4af8b21c26554ca34f5faa4386',
          ],
          [
            'Added',
            'The clone dialog can select every repository in the list at once instead of ticking each one',
            '9e5f3b28a24f29462ab4a622e62a0090c6348148',
          ],
          [
            'Added',
            'An optional clone setting periodically checks for newly available repositories and clones them into the chosen base directory automatically',
            '9e5f3b28a24f29462ab4a622e62a0090c6348148',
          ],
          [
            'Improved',
            'Build and run recognizes Deno, PHP, Ruby, Swift package, Dart and Flutter, Elixir and Phoenix, Scala, Haskell and Zig projects',
            'cfcf621a305ccd081edc4ae36f5769b87952c2e3',
          ],
          [
            'Improved',
            'Build and run names each detected profile by its project folder so multi-project repositories are readable',
            'cfcf621a305ccd081edc4ae36f5769b87952c2e3',
          ],
          [
            'Improved',
            'Artifact downloads refuse unsafe download redirects, accepting only credential-free HTTPS locations that do not resolve to loopback or private network addresses',
            'fe8079fa88d9778cac5fb693531dd122e4ae4cca',
          ],
          [
            'Improved',
            'Artifact downloads release their network connection when a download fails or is canceled instead of leaving it open',
            'b6e78eecf3638fcdb1a81d27e7275c84e641a5f6',
          ],
          [
            'Improved',
            "Sparse-checkout changes stop with a clear unavailable reason instead of running when the repository's worktree path is in an unsafe state",
            '43abf67d5bd91c196112a807ca6878794abc8b58',
          ],
          [
            'Improved',
            'The Actions tab starts loading on its own once a repository is connected to GitHub, instead of staying empty until the view is reopened',
            'e282eb2fce7c9c4af8b21c26554ca34f5faa4386',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'A sparse checkout manager lets you pick which folders of a large repository are checked out to disk',
            '859d1b221a2d2f4622c776c36afaf2989a2effc4',
          ],
          [
            'Added',
            'A shallow repository can be deepened back to its full history from the repository tools',
            '462b0c72816e36226159d0f0fee9ca49f465cc85',
          ],
          [
            'New',
            'The notification centre lists GitHub notifications and opens each one at the pull request, issue, or workflow run it came from',
            'eec5c74617d809674f55142208881845b1a133fa',
          ],
          [
            'New',
            'A Git bundle can be imported from the repository tools, with a preview of the refs it carries before anything is applied',
            '964f1dfeeb341c661a3fcffe3d00cb176b3885b5',
          ],
          [
            'New',
            'GitHub issues can be created from inside the app, with title, body, labels, and assignees',
            'b618fc7ece6e94658a88339a0476499bc2528fb5',
          ],
          [
            'New',
            "A GitHub Issues view lists, filters, and updates the current repository's issues without opening a browser",
            '51e5a4694c21e3f1fb89d97c0d10417f695b3206',
          ],
          [
            'New',
            'Pull requests can be created, reviewed, merged, and closed inside the app instead of on the web',
            '0bc17f48b706dbcdb0ef33877551784991dcbb48',
          ],
          [
            'New',
            "An Actions run inspector shows each run's jobs, streamed logs, and any deployment reviews waiting on approval",
            'cae570ed7ac697ab5370977f147bdd824b4bf859',
          ],
          [
            'New',
            'Workflow run artifacts can be browsed, downloaded, and checked against their attestations directly from the Actions view',
            'cec14273a1b7e6ffc61ed9d794a5d125b5b64e1e',
          ],
          [
            'Added',
            'Workflow artifact lists page through older entries instead of stopping at the first page of results',
            '29de6ec70a6ac6e507bd5d8f487b66542309cba1',
          ],
          [
            'New',
            'A stash manager lists every stash in the repository with a preview of its contents and apply, pop, and drop actions',
            'ee084adc0d687d920cbae71f026d3dc9fac0fab2',
          ],
          [
            'New',
            'Guided bisect sessions run a good/bad search from the repository tools and report the first bad commit',
            '5ca8a9d26922fad3f681826a0bfc0873a8376950',
          ],
          [
            'New',
            'GitHub releases can be listed, drafted, edited, published, and given assets from inside the app',
            '7888be34c758ff0bd6e27f4323bd319398213656',
          ],
          [
            'New',
            'A remote manager in repository settings adds, renames, retargets, and removes remotes',
            '680e3ed8dfafd7448eb8faac31a375c72921b28b',
          ],
          [
            'New',
            'A repository hooks manager shows the installed Git hooks and lets each one be reviewed, enabled, or disabled',
            '801c23d1533428c253e3c0e3cff9113fdcf687a1',
          ],
          [
            'New',
            'A branch rules inspector shows which rulesets and protections apply to a branch and what would block a push',
            '8f61c97ecf06f51114f661a8be3d9171f7599152',
          ],
          [
            'New',
            'Repository tools cover commit signing setup and Git LFS administration, including tracked patterns and stored objects',
            '00188097d46b1a2b861df0ef7bd681942b841696',
          ],
          [
            'New',
            'A structured commit rewrite flow rewords, squashes, and edits recent commits without hand-written rebase commands',
            'b4fa4d325eed48a3c3f6d83029bf9b9ce99372c8',
          ],
          [
            'Added',
            'The merge dialog previews the exact files that would conflict before the merge is started',
            '21b96c702b2e5a91a4182b908ea944d870955b32',
          ],
          [
            'Added',
            'Worktrees can be locked, unlocked, moved, and pruned from the worktree dropdown',
            'c2931853269ddfe5794fb10835c26e625638a95a',
          ],
          [
            'Added',
            'A branch can be exported as a patch series and received patches applied back onto a branch from the repository tools',
            '97a4d0eded7cabf46c72c58aca6f80811ae3097a',
          ],
          [
            'Added',
            'Branches can be hidden from the branch list through their right-click menu, and the choice is remembered across restarts',
            '1a6bf5010eda600a1f1c1754022eb0275eae3f0c',
          ],
          [
            'Fixed',
            'Cloning retries with the signed-in account chosen for the clone instead of failing outright when the first set of credentials is rejected',
            '8df7fdb073ce05f6c5b2c314a398e68ee78c5e2a',
          ],
          [
            'Fixed',
            'Pull All retries a repository with a matching signed-in account instead of stopping at the first authentication failure',
            'a1532fb9e1618d29a22afb7fbaf17440207e40dd',
          ],
          [
            'Improved',
            'Removing the remote a repository is currently published to now warns before the remote is deleted',
            '8b940850f033068c307b0a5d2a4a2c4c4c769a12',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'The whole workspace is rebuilt on Material Design 3, with a top app bar, a left navigation rail, floating repository and branch pills, and elevated Changes, History and diff cards',
            'a95cea307db33ef0c8bc4c14061a4a147829df44',
          ],
          [
            'Improved',
            'Dialogs float above the app instead of blocking it, so settings and other sheets can stay open while working in the repository',
            '690ea60a6ddf2b54185645d0fcc20a0078c14926',
          ],
          [
            'New',
            'Any file can be opened in a dedicated history and blame view showing every commit that touched it and who last changed each line',
            '285a04e69114ad3de20b85ef60d0430b0bb32339',
          ],
          [
            'Added',
            'An earlier version of a file can be restored directly from its history view',
            '164f81ded010568a45d7a453b132dfde6c63ad2a',
          ],
          [
            'New',
            'A guided repository tools screen runs archive export, full-history bundle export and verification, signature audit and sparse checkout without leaving the app',
            '96b6a88cfc431b3c05231a93cedcba4b02187c39',
          ],
          [
            'New',
            'A repository Actions panel lists workflow runs, streams job logs, and dispatches, re-runs or cancels a run behind a confirmation',
            '786a52936a47200c0fcb09f9090f44496f78d751',
          ],
          [
            'New',
            'A Build & Run tab in Repository Settings detects a build profile per project, installs a missing toolchain before building, and keeps its log panel collapsible to a slim bar',
            '644fa87bdfcdb011ec2294572406cf56ec8c6af1',
          ],
          [
            'New',
            'A notification centre bell opens a panel with the full history of app notifications, filterable by type',
            '383030a24fbe4efc01aa509613dfde9160c72edb',
          ],
          [
            'New',
            'Every search bar offers plain text, fuzzy and regular expression matching, with a guided regex builder available beside the field',
            'f4194c63498eb92804949f4be8f0b7732fdc91ca',
          ],
          [
            'New',
            'GitLab and Bitbucket accounts can sign in alongside GitHub, with repository browsing, cloning, pull requests and commit status routed to the right host',
            'b52cb4c0f63780f779d7d43229b0514222016b82',
          ],
          [
            'New',
            'History draws a commit graph beside the timeline and marks merge commits distinctly',
            'f0a2cf72cfa1a854b3e3a2a6a2f6165b0888317e',
          ],
          [
            'Added',
            'History can be searched and filtered by message, author, hash and other commit metadata',
            'da3270d05b519045e26a81a9d9867627e02d6138',
          ],
          [
            'New',
            'A Submodules tab in Repository Settings initializes, updates, adds and removes submodules',
            '083f62e80810f4f8c530ebfbd3faf022a870ae30',
          ],
          [
            'Improved',
            'Repository Settings manages every configured remote rather than only the default one',
            'd70303b75ca8b7316dc86a38606776eef3bc438f',
          ],
          [
            'New',
            'Multiple stashes can be kept per branch and applied or dropped individually',
            '83bfa8d55a644ed60c3701be890e2c06096450f5',
          ],
          [
            'New',
            'A gitignore manager suggests and merges templates for the current repository from Repository Settings',
            '2a75fa23fab6df9e4b59981aa29bbd7d88c0cabe',
          ],
          [
            'New',
            'The Clone dialog can select several repositories at once and clone them in one batch',
            'c6434ad50c0445e1a52df5ae4761f31f5ebe9c27',
          ],
          [
            'Added',
            'The repository list can be exported to a file and imported again on another machine',
            '5142d4fb6e8283cf883da4579b1f7d4bb8f3da4f',
          ],
          [
            'Added',
            'Repositories can be pinned and sorted into custom groups, and the Recent group can be hidden',
            'f826ff9ad1c73dfdd54c24022f165563e8682159',
          ],
          [
            'New',
            'Each repository can fetch and pull on its own schedule, with the interval configurable per account',
            '87b2d183b45c06e11ad17ab3e1f009daea7f2536',
          ],
          [
            'New',
            'Repositories open in browser-style tabs across multiple windows, with tab order and window layout restored on restart',
            'fad3bf32aa7f5636949e256e949f61a9ee33ab8e',
          ],
          [
            'New',
            'Tabs have their own appearance editor with a searchable font picker, a full colour picker and size controls that grow the tab frame',
            '4f3a209c88ed29d1ffae6b375a746a59d58c8cae',
          ],
          [
            'Added',
            'The tab context menu closes tabs to the left, to the right, all others, or every tab whose title matches entered text or a pattern',
            'ce41c07a9338b425ba3a530ec1654f08f0c214fc',
          ],
          [
            'Added',
            'Every branch and linked worktree can be merged into the default branch in one guarded action',
            'da7a0b09864f812d3926e7bad041345b900ec2cc',
          ],
          [
            'Added',
            'Pull all fetches and pulls every added repository in one action, reporting the ones it had to skip',
            '8b1b578e86bc0b919ea6b69d6150c8d883cca583',
          ],
          [
            'Added',
            'A single action stages, commits and pushes the current changes when it is safe to do so',
            '246de0b77593e71a23a21ecd160fde356ea3df5c',
          ],
          [
            'Added',
            'Discard all changes offers a permanent variant that skips the trash and also removes untracked files',
            'b22d3dd74e933d40d2ea5437b95471a531e644f6',
          ],
          [
            'New',
            'The interface scale is adjustable, including an auto-fit mode that sizes the layout to the window',
            'dc743e43880edf5dad9a614078ad68ae5b62e394',
          ],
          [
            'Improved',
            'Settings, dialogs, popovers, history and build panels stay readable and clickable at small window sizes and high display scaling instead of clipping or overflowing sideways',
            '70ed7ea7bca417a77d64e36d58f6d8de5dcf792d',
          ],
          [
            'New',
            'A token-gated local server exposes repository commands to external tools, with access preferences and a command-line client',
            'a35f12fc5251f10756a913c0fffffeaf8b0e118a',
          ],
          [
            'Improved',
            'The command-line launcher is installed as desktop-material and accepts repository paths and options directly',
            '86c136566660ef58006169246aea1ebf16a49e8c',
          ],
          [
            'Improved',
            "Updates are checked against this build's own release feed rather than the upstream endpoint",
            '2ae45c83ab5a1a528d108155f9d4bee33fbcf5ff',
          ],
          [
            'Added',
            'SVG files in a diff can be viewed as rendered images or as sanitized source',
            'f36cb1f135d91ad8c91450cf666c3fcfc91fcefb',
          ],
          [
            'Added',
            'The commit composer shows the name and email a commit will actually use and where that setting comes from',
            '3b31d74f20196c0f4ee41b3eccb12e3de6ef9f30',
          ],
          [
            'Added',
            'Branch, commit, repository and worktree lists show accessible tooltips for names truncated by the column width',
            '8f5960a0bb42d149da8873cb5df6a52aa47d4d3f',
          ],
          [
            'Added',
            'The Create Tag dialog suggests tag names used previously in the repository',
            '6d42b3ce0a0e4263a32bffb7dcf3141192c17441',
          ],
          [
            'Added',
            'Installed WSL distributions appear as shell choices when opening a repository in a terminal',
            'b79771192d868346fc5f3f7e075a3f45d1daf283',
          ],
          [
            'Removed',
            'All usage and crash telemetry reporting is removed, and the welcome screen no longer offers to enable it',
            '05f404d38fc37f9ee2ab86fed39d997c8a6fbf82',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Open repositories appear as browser-style tabs above the toolbar, with middle-click close, double-click rename, and tab order remembered between launches',
            '18b387604bb4ace6a1c137466e93b9247c8690ec',
          ],
          [
            'Added',
            "Customize Appearance in a tab's context menu opens a tab text style editor with bold, italic, underline, alignment, font size, font family, and color, previewed live and saved per tab",
            '007845ca870d00cea9365132652299a8b4bbf22c',
          ],
          [
            'New',
            'Sign in with several accounts on the same host at once instead of being limited to one GitHub.com and one Enterprise account',
            'c49fe25cd723f39bef268adacf9e5ff3fd430d12',
          ],
          [
            'Improved',
            'The Accounts tab in Preferences lists every signed-in GitHub.com and Enterprise account as its own card and offers an Add account action for each host',
            'b4407f162d34aecd5b1558059547b4902a896733',
          ],
          [
            'Added',
            'Repository settings let you pick which signed-in account a repository authenticates with, so each repository keeps working under the identity you choose',
            'e91b56cd0d0f9ff96e48deca4a7dad408a695e24',
          ],
          [
            'New',
            'Each signed-in account keeps its own settings profile, so preferences follow the account you are currently using and are snapshotted every time they change',
            '982636147771de2512283fdc2dcf20b4b5c7674e',
          ],
          [
            'New',
            'Settings history, opened from Edit or with Ctrl+Alt+Z, shows a timeline of every settings change with its diff and lets you undo, redo, or restore any earlier point without losing the newer state',
            '4114fa2bb00d8dfc67c84b7ed16d0f506050bb30',
          ],
          [
            'Improved',
            'The application shell is restyled on Material Design 3, refreshing surfaces, the toolbar, the sidebar, and buttons in both light and dark themes',
            '5d2042331b7197a408d33d8e0c87a87a91b2e850',
          ],
          [
            'Improved',
            'Dark mode now uses the correct Material Design 3 error colors, so error text and highlights stay readable on dark surfaces',
            '0ff26c6b8b1157115cfc5768a7dd33ee098d758b',
          ],
          [
            'Added',
            'Every build publishes a downloadable Windows installer straight to its release',
            '52b2abfa0788f1a32d4ac3d8e6aa7266788f3793',
          ],
          [
            'Added',
            'A project website and wiki cover the user guide, regex guide, automation, and developer setup, with screenshots of the redesigned interface',
            'd367c92a5465125ecf21f898789e344785a7226e',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Keep Cheap LFS recovery and materialization sidecar names bounded so valid long Windows filenames no longer fail with ENAMETOOLONG',
          ],
          [
            'Fixed',
            'Resolve error that prevented Copilot-based features from working correctly on Windows - #22509',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Invoking Desktop from the command line inside a worktree now opens the existing repository with the worktree selected instead of prompting to add a new repository - #22378',
          ],
          [
            'Fixed',
            'Scrolling no longer gets stuck when the pointer is over a tall group in the repository list - #22387. Thanks @peteski22!',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Middle-clicking a diff hunk gutter does not select or deselect lines - #22432',
          ],
          [
            'Fixed',
            'Invoking Desktop from the command line inside a worktree now opens the existing repository with the worktree selected instead of prompting to add a new repository - #22416',
          ],
          [
            'Fixed',
            'Copilot sessions from generating commit messages or resolving conflicts do not show up in VS Code - #22410',
          ],
          [
            'Fixed',
            'Resolve issue where git hooks that shell out to git could break due to an incorrect GIT_EXEC_PATH on macOS - #22411',
          ],
        ],
      },
      {
        ...
        t: '16:28',
        e: [
          ['Fixed', 'Copilot Max plan users are recognized correctly - #22400'],
          ['Fixed', 'The default Copilot model is Auto'],
          ['Fixed', 'Improved loading times for Copilot features - #22394'],
          [
            'Fixed',
            'Copilot model picker no longer extends beyond window dimensions in small window sizes - #22391',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Worktree list is updated after after renaming or deleting worktrees - #22335 Thanks @pol-rivero!',
          ],
          [
            'Fixed',
            "The toolbar correctly calculates available space when worktree dropdown isn't visible - #22356. Thanks @pol-rivero!",
          ],
          [
            'Fixed',
            'Toolbar space allocation calculates available space based on order of toolbar buttons - #22364. Thanks @pol-rivero!',
          ],
          [
            'Fixed',
            'Resolve issue where error messages in the Preferences dialog were not displayed correctly - #22363',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Resolve Copilot conflict resolution data loss where file content outside conflicted regions was overwritten when using AI-assisted conflict resolution - #22349',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            "Add 'Always use Copilot when conflicts are detected' setting and a nudge dialog that appears after five manual uses to encourage enabling it - #22285",
          ],
          [
            'Added',
            "Add the Copilot conflict resolution Changes tab, allowing users to see a diff of Copilot's suggested resolution - #22333",
          ],
          [
            'Added',
            'Allow users to stop an ongoing request to generate a commit message with Copilot - #22324. Thanks @say25!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'New',
            'Git worktree support for managing multiple working directories of the same repository - #22102',
          ],
          [
            'Fixed',
            'Items in lists such as branches and changed files are properly announced by screen readers on Windows - #22219',
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Show "No newline at end of file" as visible text in the diff view instead of requiring a tooltip hover - #22204',
          ],
          [
            'Improved',
            'Show a descriptive error dialog when restoring stashed changes fails due to conflicting changes in the working directory - #22205',
          ],
          [
            'Fixed',
            'Screen reader now correctly announces added and removed line counts in the pull request preview dialog - #22202',
          ],
        ],
      },
      {
        ...
        t: '16:16',
        e: [
          ['Fixed', 'Fix launching custom shells - #22186'],
          ['Fixed', 'Fix crash trying to run a non-existent script - #22167'],
          [
            'Fixed',
            'Restore keyboard focus to the commit button after the commit progress dialog closes - #22192',
          ],
          ['Added', 'Add model selection for Copilot - #21745'],
          [
            'Added',
            'Add support for custom model providers for Copilot - #22000',
          ],
          [
            'Added',
            'Use repo rules to guide commit messages generation by Copilot - #22007',
          ],
        ],
      },
      {
        ...
        d: '2026-05-26',
        t: '11:12',
        e: [['Fixed', 'Fix launching custom shells']],
      },
      {
        v: '3.5.10',
        d: '2026-05-22',
        t: '12:10',
        e: [
          ['Fixed', 'Intermittent crash trying to load Copilot models'],
          [
            'Added',
      ...
      },
      {
        ...
        e: [
          ...
          ['Fixed', 'Fix rendering long lists of changed files - #21630'],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Update Copilot SDK to 0.2.1 and fix Copilot CLI process spawning issues on Windows - #21930',
          ],
          [
            'Improved',
            'Enable diff expansion and syntax highlighting for up to 1MB - #21876',
      ...
      },
      {
        ...
        d: '2026-04-14',
        t: '15:42',
        e: [['Improved', 'Update Git for Windows to v2.53.0.windows.3']],
      },
      {
        v: '3.5.7',
        d: '2026-03-31',
      ...
      },
      {
        ...
        e: [
          ...
          ['Fixed', 'Remove trailing $ typo in hooks output - #21638'],
          ['Improved', 'Update Git to 2.53.0'],
          ['Improved', 'Update Git for Windows to 2.53.0.windows.2'],
          ['Improved', 'Update Git Credential Manager to 2.7.3'],
        ],
      },
      {
        v: '3.5.6-beta1',
        ...
        e: [
          ...
          ['Fixed', 'Remove trailing $ typo in hooks output - #21638'],
          ['Improved', 'Update Git to 2.53.0'],
          ['Improved', 'Update Git Credential Manager to 2.7.0'],
        ],
      },
      {
        v: '3.5.5',
      ...
      },
      {
        ...
        t: '09:58',
        e: [
          ['Improved', 'Locate Git for Windows via PATH and registry - #21621'],
          ['Improved', 'Include hook exit code in terminal output - #21620'],
        ],
      },
      {
        v: '3.5.5-beta5',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Updated Git LFS to 3.7.1 to address CVE-2025-26625 - #21223',
          ],
          [
            'Fixed',
            'Menu bar does not flicker when profile modal is open - #21150. Thanks @zekariasasaminew!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        t: '10:49',
        e: [
          ['Added', 'Add Ptyxis shell integration - #20963. Thanks @logonoff!'],
          [
            'Fixed',
      ...
      },
      {
        ...
        d: '2025-09-30',
        t: '09:41',
        e: [['Improved', 'Upgrade Electron to v38.2.0 - #21060']],
      },
      {
        v: '3.5.3-beta3',
        d: '2025-09-17',
        ...
        e: [
          ...
          ['Improved', 'Upgrade Electron to v38.1.0 - #21012'],
        ],
      },
      {
        v: '3.5.3-beta2',
      ...
      },
      {
        ...
        t: '15:20',
        e: [
          ['Fixed', 'Disambiguate repositories in the recent group - #20582'],
          [
            'Fixed',
          ...
          [
            'Improved',
            'VoiceOver announces all changes in image diff sliders - #20625',
          ],
          [
            'Improved',
            'The whitespace hint popover does not announce landmark information to screen reader users - #20618',
          ],
          [
            'Improved',
            'Filter changes text box follows expected focus order upon changes view opening - #20621',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: '2025-03-07',
        t: '09:44',
        e: [['Fixed', 'Prevent crash due to non-critical error - #20150']],
      },
      {
        v: '3.4.18-beta1',
        d: '2025-03-03',
      ...
      },
      {
        ...
        d: '2025-01-21',
        t: '22:00',
        e: [['Fixed', 'Restore ability to sign in on Windows']],
      },
      {
        v: '3.4.14',
        d: '2025-01-20',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fix diffing images when multiple commits are selected - #20329',
          ],
          [
            'Improved',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add support for DDS image files - #5337. Thanks @mkafrin!',
          ],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Fix misaligned resizable toolbar buttons - #19330. Thanks @jpedroso!',
          ],
          [
            'Fixed',
            'Files configured to use the binary merge driver are now treated as binary files when resolving conflicts - #9846',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            "Don't show certificate error dialog when probing for endpoint kind - #18991",
          ],
          ...
          [
            'Fixed',
            'Migrate existing GHE account endpoints to the new `api.` subdomain - #19319',
          ],
          [
            'Fixed',
            'Right-clicking on diff checkmarks displays the context menu - #19302',
          ],
          [
            'Fixed',
            'Arguments with spaces are passed correctly to custom editors or shells on Windows - #19218',
          ],
          [
            'Removed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Workaround for issues with empty environment variable in third-party tools - #19273',
          ],
          ['Fixed', 'Unset GIT_SEQUENCE_EDITOR when rebasing - #15413'],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Quotes are preserved in custom integration arguments - #19218',
          ],
          [
            'Fixed',
            'Symbolic links on Windows can be used as custom editor and shell - #19217',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add Cursor integration for Windows - #19158. Thanks @colinabear!',
          ],
          ['Fixed', "Users can clone wiki's - #19152"],
          [
            'Improved',
            'Inform users when attempting to create a repository out of an existing subdirectory of another repository - #19148',
          ],
          [
            'Improved',
            'When publishing a new repository, publish the default branch first as opposed to the currently checked out branch - #19151',
          ],
          [
            'Improved',
            'The "Create a New Repository" dialog informs the user of the path to be created - #19147',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'The custom editor and shell integrations handles when there are no predefined editors or shells - #19160',
          ],
          [
            'Fixed',
            'The "Create a New Repository" dialog allows creation of repositories in repository subfolders - #19137',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Increased contrast ratio of icon in the diff file warnings - #19097',
          ],
          [
            'Fixed',
            'Use "alertdialog" role for "Push Local Changes" dialog - #19098',
          ],
          ['Fixed', 'Add emoji descriptions for screen readers - #19101'],
          ['Improved', 'The squash dialog provides input labels - #19100'],
          [
            'Improved',
            'Added search input visual labeling in the form of a search icon - #19103',
          ],
          [
            'Improved',
            'Use CmdOrCtrl+Q for Exit shortcut on Linux - #19093. Thanks @shiftkey!',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add Zed as an external editor option for Linux - #18962. Thanks @adil192!',
          ],
          ...
          [
            'Fixed',
            'Context menu actions in the diff are accessible via keyboard - #18946',
          ],
          [
            'Fixed',
            'Add/Remove Co-authors hint text is positioned correctly when scrolling through the changes list - #18929',
          ],
          ['Fixed', 'VoiceOver can now use browser mode on the diff. - #18935'],
          [
            'Fixed',
            'Increased contrast of several texts and icons in the app - #18922',
          ],
          [
            'Fixed',
            'Add aria-expanded and aria-controls attributes to Stashed Changes button - #18924',
          ],
          [
            'Fixed',
            'Hunk header text color contrast ratio is greater than 4.5:1 - #18916',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Option to use Git Credential Manager for repositories hosted outside of GitHub.com - #18700',
          ],
          [
            'New',
            'Allow customizing tab character width in spaces - #15561. Thanks @Repiteo',
          ],
          [
            'Fixed',
            'Remote urls containing spaces are now displayed in their entirety in the remote settings screen - #18876',
          ],
          [
            'Fixed',
            'Newly uploaded images are rendered in Pull Request comments and reviews - #18830',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Users running Windows on arm64 processors are able to authenticate - #18825',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Using hooks on Windows no longer results in a "command not found" error - #18739',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Prevent crashes when external editors fail to launch - #17717. Thanks @tsvetilian-ty!',
          ],
          ['Fixed', "Fix 'delete branch' message - #18706. Thanks @zetaloop!"],
          [
            'Improved',
            'Use system feedback to draw user attention when a dialog is shown in background - #17220. Thanks @yuzawa-san!',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Add accessibility settings to toggle link underlines and diff check marks - #18227, #18035',
          ],
          [
            'Fixed',
            'Support multiple accounts for remote urls that differ in path - #18676, #18651',
          ],
          [
            'Fixed',
            'Refreshing repository indicators will not invalidate credentials - #18622',
          ],
          [
            'Fixed',
            'Clear stored credentials when authentication fails on insecure http hosts - #18588',
          ],
          [
            'Improved',
            'The generic git auth dialog contents are announced to users of screen readers - #18670',
          ],
          [
            'Improved',
            'The diff line numbers and line group controls show check marks so color is not the sole medium to determine inclusion into a commit - #18077',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Prevent Pull Request comment or review dialog from moving constantly under some circumstances - #18596',
          ],
          [
            'Fixed',
            'Prevent Pull Request notification dialogs from truncating long Pull Request titles - #18596',
          ],
          [
            'Fixed',
            'The welcome start flow content does not overlap or clip when zoomed - #18565',
          ],
          [
            'Fixed',
            'Clear stored credentials when authentication fails on insecure http hosts - #18588',
          ...
          [
            'Improved',
            'Improved accessibility of checks failed notification dialog by moving "Re-run checks" button out of the heading element - #18596',
          ],
          [
            'Improved',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Pushing and pulling repositories using Git LFS no longer causes an indefinite loop - #18582',
          ],
          [
            'Improved',
            'Improve the accessibility of the tabs in the preferences dialog for users of screen readers - #18567',
          ],
          [
            'Improved',
            'Always focus the first focusable element in the preferences dialog on open - #18567',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Resolved auth failures when interacting with repositories hosted on non-GitHub hosts - #18568 #18570 #18569',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Remove unnecessary br elements to make the app easier to navigate with screen readers - #18444, #18436',
          ],
          [
            'Fixed',
            'Prevent clipping of dialog controls and content when app is zoomed - #18412',
          ],
          [
            'Improved',
          ...
          [
            'Improved',
            'Increase contrast on modified and conflicted octicons - #18560',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Add banner to announce the accessibility settings - #18460',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Hypen replacement and invalid sanitized name warnings and errors in the create branch and create repository dialogs are associated to the input by the aria-describedby attribute - #18404',
          ],
          [
            'Improved',
            'Add VapourSynth script files (.vpy) to test/x-python - #18364. Thanks @couleurm!',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Bring back support for macOS 10.13 and 10.14 and prevent upgrading from them - #18316',
          ],
          [
            'Fixed',
            'Added announcing the number of results to the diff search via screen readers - #18306',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'In the changes diff, groups of two rows that represent one line number change have a check all control - #18232',
          ],
          [
            'Fixed',
            'Copying lines in side by side diffs does not add new lines between each line when pasted - #18249',
          ],
          [
            'Fixed',
            'On Windows, PATH environment variable with values longer than 1024 are not truncated - #18244',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Added visible and semantic check all button for a group of consecutive selectable rows in the diff - #18201',
          ],
          ['Fixed', "Ignore a file's parent directories on Windows - #18206"],
          [
            'Improved',
            'Add a setting for visibility of diff check marks when committing - #18227',
          ],
          [
            'Improved',
            'Add support for toggling link underlines globally - #18035',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'The diff line numbers show check marks so color is not the sole medium to determine inclusion into a commit - #18077',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'The "Reveal in Finder" context menu option in the conflict resolution dialog no longer causers Finder to be unresponsive - #17933',
          ],
          [
            'Fixed',
            'Clicking on the commit message length warning does not close the squash commit dialog - #17966',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'By default, tooltips can be dismissed with the escape key - #17836',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Focus moves to closes expansion button or diff container after expansion - #17499',
          ],
          [
            'Improved',
            'Tooltips can be dismissed with the escape key - #17823',
          ],
          [
            'Improved',
            'Semantically grouping our settings radio and checkbox groups so their group headers will be announced to screen reader users. - #17787',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Commit summary descriptions are scrollable when the content is long - #17708',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Prevent multiple announcing of success banners with Windows NVDA screen reader  - #17705',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'The commit summary description overflow is limited to two lines when collapsed. - #17618',
          ],
          [
            'Improved',
            'The commit summary description has a grey background color when expanded. - #17618',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: '2023-09-21',
        t: '09:54',
        e: [['Improved', 'Upgrade to Electron v24.8.3 - #17416']],
      },
      {
        v: '3.3.3-beta2',
        d: '2023-09-21',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Allow cloning repositories that have git as suffix - #17221',
          ],
          [
            'Fixed',
            'Fix accessibility semantics of root items of the app menu bar - #17254',
          ...
          [
            'Improved',
            'Dropdown select buttons menu is keyboard navigable and have aria attributes - #17271',
          ],
          [
            'Improved',
            'Prevent interrupting verbose announcements of branch count on branch dropdown open for screen reader users - #17225',
      ...
      },
      {
        ...
        d: '2023-08-17',
        t: '17:33',
        e: [['Fixed', 'Fix the inability to log into GHES - #17237']],
      },
      {
        v: '3.2.9',
        d: '2023-08-17',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Fix selecting/deselecting changed files with the keyboard - #17207. Thanks @koenpunt!',
          ],
          [
            'Improved',
            "The stash restore button's description is associated to the restore button - #17204",
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Allow screen readers to announce "overwrite stash" and "discard stash" confirmation dialogs - #17197',
          ],
          [
            'Fixed',
            'Improve readability of file statuses for keyboard-only users - #17192',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Initial support for repository rules - #16707. Thanks @vaindil!',
          ],
          [
            'Fixed',
            'Enable context menu keyboard shortcut for file lists - #17143',
          ...
          [
            'Fixed',
            'Screen readers announce branch group names correctly when there are no recent branches - #17142',
          ],
          [
            'Fixed',
            'Screen readers announce the status of files within a commit - #17144',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Screen readers announce number of pull requests found after refreshing the list - #17031',
          ],
          [
            'Improved',
            'The context menu for the History view items can be invoked by keyboard shortcuts - #17035',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            '"Clone a Repository" dialog list is keyboard navigable - #16977',
          ],
          [
            'Improved',
            'Checkboxes in dialogs can receive initial keyboard focus - #17014',
          ],
          [
            'Improved',
            'The progress state of the pull, push, fetch button is announced by screen readers - #16985',
          ],
          [
            'Improved',
            'Inline errors are consistently announced by screen readers - #16850',
          ],
          [
            'Improved',
            'Group title and position is correctly announced by screen readers in repository and branch lists - #16968',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Preferences renamed to Settings on macOS to follow platform convention - #16907',
          ],
          [
            'Fixed',
            'Allow filtering autocomplete results using uppercase characters - #16886',
          ...
          [
            'Improved',
            'The "pull, push, fetch" dropdown button has an aria-label for screen reader users - #16839',
          ],
          [
            'Improved',
            'The aria role of alert is applied to dialog error banners so they are announced by screen readers - #16809',
          ],
          [
            'Improved',
            'Add Double Click to Open in Default Editor - #2620. Thanks @digitalmaster!',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Entering in double forward slash does not  target directory in cloning dialog - #15842. Thanks @IgnazioGul!',
          ],
          [
            'Fixed',
            'In the "No Repositories" screen, controls at the bottom stay inside window when it is resized - #16502. Thanks @samuelko123!',
          ...
          [
            'Fixed',
            'Autocompletion list is always visible regardless of its position on the screen - #16650 #16609',
          ],
          [
            'Improved',
            'Improve screen reader support of the "Create Alias" dialog - #16802',
      ...
      },
      {
        ...
        d: '2023-04-25',
        t: '19:00',
        e: [['Improved', 'Upgrade embedded Git to 2.39.3']],
      },
      {
        v: '3.2.2-beta2',
        d: '2023-04-25',
        ...
        e: [
          ...
          [
            'Removed',
            'Remove unshipped high contrast theme and dependencies - #16559',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Users can resize the app sidebar via keyboard shortcuts - #16332',
          ],
          [
            'Improved',
            'Misattributed commit popover does not clip when app is zoomed - #16407',
          ...
          [
            'Improved',
            'Commit completion status is announced by screen readers - #16371',
          ],
          [
            'Improved',
            'Windows menu scroll bars only present when menu is scrollable - #16367',
          ],
          [
            'Improved',
            'Committing status after submitting a commit is screen reader announced - #16340',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Make autocompletion suggestions more accessible for screen readers - #16324',
          ],
          [
            'Improved',
            "Preference dialog height doesn't change much between sections - #16313",
          ],
          [
            'Improved',
            'Learn more links are descriptive for screen readers - #16274',
          ...
          [
            'Improved',
            'Add offset focus ring for buttons, vertical tabs etc - #16288',
          ],
          [
            'Improved',
            "Windows app main menu's do not clip when zoom is set to 200% - #16290",
          ],
          ['Improved', 'Button and text box contrast bumps - #16287'],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Make the add/remove co-authors button keyboard accessible - #16200',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: '2023-02-22',
        t: '06:46',
        e: [['Fixed', 'Fixed production build startup crash - #16191']],
      },
      {
        v: '3.1.9-beta1',
        d: '2023-02-17',
        ...
        e: [
          ...
          [
            'Added',
            'Add JetBrains DataSpell support on Windows - #16020. Thanks @tsvetilian-ty!',
          ],
          [
            'Added',
            'Add JetBrains DataSpell support on macOS- #16020. Thanks @jm-rivera!',
          ],
          [
            'Added',
            'Editors installed with JetBrains Toolbox supported on Linux - #16029. Thanks @adil192!',
          ...
          [
            'Improved',
            'The file status of a changed file is announced with voice over - #16098',
          ],
          [
            'Improved',
            'The changes list announces file selection position with voice over - #16108',
          ],
          [
            'Improved',
            "The 'x' close button on dialogs is keyboard accessible - #16110",
      ...
      },
      {
        ...
        d: '2023-02-15',
        t: '10:22',
        e: [['Improved', 'Upgrade embedded Git to 2.39.2']],
      },
      {
        v: '3.1.7-beta1',
        d: '2023-02-15',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Trim leading and trailing whitespaces in URLs of repository remotes - #15821. Thanks @Shivareddy-Aluri!',
          ],
          [
            'Fixed',
            'Fix support for the latest versions of RStudio on Windows - #15810',
      ...
      },
      {
        ...
        d: '2023-01-18',
        t: '08:37',
        e: [['Improved', 'Upgrade embedded Git to 2.35.6']],
      },
      {
        v: '3.1.4-beta1',
        d: '2023-01-18',
        ...
        e: [
          ...
          [
            'Improved',
            'Pull request preview dialog only uses remote branches for base branch options - #15768',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Ensure selected list items stay selected when scrolling - #2957',
          ],
          [
            'Fixed',
            'Stick to one tooltip at a time in the repository list  - #15583',
          ...
          [
            'Fixed',
            'Preview Pull Request opens when there is not a local default branch - #15704',
          ],
          [
            'Fixed',
            'Preview Pull Request suggested next action available on first app open without interaction - #15703',
          ],
          [
            'Improved',
            'Ability to copy tag names from the commit list - #15137. Thanks @Shivareddy-Aluri!',
          ...
          [
            'Improved',
            'Stacked popups remember their state when hidden due to another popup opening - #15668',
          ],
          [
            'Improved',
            "Create pull request from pull request preview opens to compare against the user's selected base branch - #15706",
          ],
          [
            'Improved',
            'On Preview Pull Request dialog, submit button closes the dialog - #15695',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            "Using the key command of 'Shift' + 'ArrowDown' in the commit list adds the next commit to the current selection - #15536",
          ],
          [
            'Fixed',
            'Notifications of Pull Request reviews are displayed for forked repositories - #15580',
          ...
          [
            'Improved',
            'User can preview a Pull Request from the suggested next actions.  - #15588',
          ],
          [
            'Improved',
            'The dropdown selection component is keyboard navigable - #15620',
          ...
          [
            'Improved',
            "'Preview Pull Request' menu item availability is consistent with other menu items - #15590",
          ],
          [
            'Improved',
            "The diff view now highlights Arduino's `.ino` files as C++ source - #15555. Thanks @j-f1!",
          ...
          [
            'Improved',
            'Popups are stacked. Opening a popup will not discard an existing popup - #15496',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Prevent closing the GitHub Desktop while it's being updated - #7055, #5197",
          ],
          [
            'Fixed',
            'Notifications are shown only when they are relevant to the current repository - #15487',
          ...
          [
            'Fixed',
            'Fix repository change indicator not visible if selected and in focus - #7651. Thanks @angusdev!',
          ],
          [
            'Fixed',
            "Close 'Resolve conflicts before Rebase' dialog will not disable menu items - #13081. Thanks @angusdev!",
          ...
          [
            'Fixed',
            'Fix tooltips of long commit author emails not breaking properly - #15424. Thanks @angusdev!',
          ],
          [
            'Fixed',
            'Clone repository progress bar no longer hidden by repository list - #11953. Thanks @angusdev!',
          ...
          [
            'Improved',
            'Pull request preview dialog width and height is responsive - #15500',
          ],
        ],
      },
      {
        ...
        d: '2022-10-18',
        t: '20:35',
        e: [['Improved', 'Upgrade embedded Git to 2.35.5']],
      },
      {
        v: '3.1.2',
        d: '2022-10-18',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'You can preview the changes a pull request from your current branch would make - #11517',
          ],
          [
            'Fixed',
          ...
          [
            'Improved',
            'Add support for zooming out at the 67%, 75%, 80% and 90% zoom levels - #15401. Thanks @sathvikrijo!',
          ],
          [
            'Improved',
            'Add option to disable discard stash confirmation - #15379. Thanks @tsvetilian-ty!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Add option to disable Undo Commit popup - #15134. Thanks @geophilusd!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add support for Lite XL editor on Linux & macOS - #15180. Thanks @KaMeHb-UA!',
          ],
          [
            'Added',
            'Add Neovide support on macOS - #14929. Thanks @Yohannfra!',
          ],
          [
            'Fixed',
            'Text selection is preserved while scrolling diffs in split mode - #13701',
          ],
          [
            'Improved',
            'Update submodules when fetching, pulling and checking out branches - #8221 #9174',
          ...
          [
            'Improved',
            'Avoid truncating long menu item labels on Windows - #14868',
          ],
          [
            'Improved',
            'Add "Learn more" link to "Commit Reachability" dialog - #15208',
          ],
          [
            'Improved',
            'Improve submodule support with a new diff screen with more detailed information - #15176',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add Emacs integration for macOS - #15130. Thanks @zipperer!',
          ],
          [
            'Fixed',
            'Do not show login prompt when repositories are fetched - #15163',
      ...
      },
      {
        ...
        d: '2022-07-12',
        t: '14:47',
        e: [['Improved', 'Upgrade embedded Git to 2.35.4']],
      },
      {
        v: '3.0.4-beta1',
        d: '2022-07-12',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'On Windows, remember the apps zoom level on update - #5315',
          ],
          ['Fixed', 'Fix Markdown syntax highlighting - #14710'],
          [
            'Improved',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fix issue with some repositories not being properly persisted - #14748',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add support for Aptana Studio - #14669. Thanks @tsvetilian-ty!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Use fast-forward flag as default for pulling divergent paths - #14431',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Show progress indicator when trusting a repository directory - #14410',
          ],
          [
            'Improved',
            'Reduced noise on the rerun dialog user interface - #14322',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Upgrade embedded Git to v2.35.3 on macOS, v2.35.3.windows.1 on Windows, and Git LFS to v3.1.2',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fix relative time of pull request review notification dialogs - #14261',
          ],
          [
            'Fixed',
            'Fix CI check status popover not closing when clicking on PR badge - #14256',
          ...
          [
            'Improved',
            'Close keywords are now formatted and have informational tooltips in markdown - #14253',
          ],
          [
            'Improved',
            'Commit mentions in markdown are now formatted and linked - #14282',
          ],
          [
            'Improved',
            'Add a link under "Enable notifications" settings to the user\'s OS system notification settings - #14288',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Add support for notifications of pull request reviews - #14175',
          ],
          ['Fixed', 'Pull requests adhere to temporal laws again - #14238'],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Dismiss "initialize LFS" dialog when clicking `Not Now` button - #14187',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Improves added and deleted line borders for high contrast mode - #12922',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fix duplicated first character on Windows when dealing with submodules or repos-within-repos - #12314',
          ],
          [
            'Fixed',
            'Treat the old and new format of private email address equally when showing commit attribution warning - #13887',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'App no longer crashes intermittently when running remote Git operations - #13916',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Changes within lines are presented the same way in side-by-side and unified modes - #13838',
          ],
          [
            'Improved',
            'Select integration tab automatically when changing default editor  - #13856. Thanks @uttiya10!',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Initial support for system notifications when checks fail in Windows - #13655',
          ],
          [
            'Fixed',
            'Fix CLI tool on macOS Monterey - #13764. Thanks @spotlightishere!',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Initial support for system notifications when checks fail in macOS - #13655',
          ],
          [
            'Added',
            'Support pushing workflow files for GitHub Actions to GitHub Enterprise Server - #13640',
          ...
          [
            'Improved',
            'Take alias into account when sorting repositories - #13429',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Add dynamic constraints for resizable components - #2745',
          ],
          [
            'Improved',
            'Remove re-run button for repositories that cannot re-run checks. - #13460',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Stashing dialog no longer hangs when intiating cherry-pick - #13419',
          ],
          [
            'Fixed',
            'Rebase no longer hangs after conflicts resolved when intiated through pull conflict error - #13204',
          ],
          [
            'Fixed',
            'Discarding files and repositories successfully moves items to trash - #13433',
          ],
          [
            'Improved',
            'Added check runs overall completeness indicator in check run popover header - #13423',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Adds a re-run dialog to inform user which check runs will be re-run - #13369',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Group CI check runs by runner app and event - #13348, #13349, #13344',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Show previous similar tags in the tag creation dialog - #12509. Thanks @mahezsh!',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Tokens are not considered invalid when accessing GitHub Enterprise from outside of the company's VPN - #12943",
          ],
          [
            'Improved',
            'Upgrade embedded Git to v2.32.0 on macOS, and to v2.32.0.windows.2 on Windows - #13000',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Remove high-contrast specific hover effects from light and dark theme - #12952',
          ],
          [
            'Fixed',
            'Show "add repo" dialog when opening repo from CLI - #12935',
          ...
          [
            'Fixed',
            'Continue merge flow after merge conflicts are resolved with exterior conflict tool - #12881',
          ],
          [
            'Fixed',
            'Remove glitches when diffs are shown for the first time - #12903',
          ],
          [
            'Improved',
            'Remove gaps in the commit message container revealing a different background - #12900. Thanks @haykam821!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'App no longer crashes on successful merge after conflicts resolved - #12888',
          ],
          [
            'Fixed',
            'Use same width for hunk expansion handles as we do for line numbers - #12887',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add syntax highlighting for dart - #12827. Thanks @say25!',
          ],
      ...
      },
      {
        ...
        d: '2021-08-24',
        t: '11:34',
        e: [['Fixed', 'Fix scrolling performance issue for large diffs.']],
      },
      {
        v: '2.9.1',
        d: '2021-08-23',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Wrong SSH key passphrases are not stored after multiple failed attempts and then one successful - #12804',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Show SSH prompts (key passphrase, adding host, etc.) to macOS users via dialog - #12782',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Fixed authentication errors in some Git operations - #12796',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Show SSH prompts (key passphrase, adding host, etc.) to Windows users via dialog - #3457 #8761',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Added support for more versions of JetBrains IDEs on Windows - #12778',
          ],
          [
            'Improved',
            'Windows users can use the system OpenSSH for their Git repositories - #5641',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Removed border of Repository and Branch foldouts in dark theme - #12478. Thanks @meJevin!',
          ],
          [
            'Improved',
            'Double-click an option when switching branches to quickly confirm how you want changed files to be handled - #12522. Thanks @j-f1!',
          ],
          [
            'Improved',
            'Use "Recycle Bin" name only on Windows - #12544. Thanks @shiftkey!',
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Scroll history to top after creating a branch from a commit - #12432',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Only attempt to reorder commits when it's necessary - #12422",
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Update from default branch now merges as expected - #12412',
          ],
          [
            'Improved',
            'Create intros for the new drag and drop features :tada: - #12419',
          ],
          [
            'Improved',
            'Squash merge and rebase options are available in comparison view - #12416',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Reorder commits with drag and drop in the history tab - #2507',
          ],
          [
            'New',
            'Reset your branch to a previous commit up to the most recent pushed commit in your history - #12393',
          ],
          ['New', 'Amend the most recent commit on your branch - #1644'],
          [
            'Add',
            'Allow rebase, squashing, or merging when choosing how to update your current branch - #12396, #12382, 12362',
          ],
          ...
          [
            'Fixed',
            'Fix coauthor styling in commit message dialog for squashing - #12356',
          ],
          [
            'Fixed',
            'Selecting a coauthor and committing adds coauthor trailer - #12355',
          ],
          [
            'Fixed',
            "Lists of commits, repositories or changes don't disappear after switching between apps",
          ],
          [
            'Improved',
            'Add force-push warning to squash and reorder operations - #12403',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Add VS Code, VS Code Insiders and VSCodium to supported Windows ARM64 editors - #12174. Thanks @dennisameling!',
          ],
          ['Fixed', 'Long emails are truncated in the Git config - #12159'],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Thank you note language improved and retrieves all past release notes to retroactively thank all contributors',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Show the build architecture in the About dialog - #12140',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Add complete support for macOS on Apple silicon devices - #12091',
          ],
          [
            'Improved',
            'From now on, macOS x64 builds running on Apple silicon devices will auto update to arm64 builds',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Preliminary support for macOS on Apple silicon devices - #9691. Thanks @dennisameling!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'During cloning progress and on hover, show full progress description - #11375. Thanks @maifeeulasad!',
          ],
          ['Improved', 'Cherry-pick multiple non sequential commits - #12030'],
        ],
      },
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Expanding diffs now works as expected in unified view - #11972',
          ],
          [
            'Improved',
            'Show an alert when the app fails to move itself to the Applications folder on macOS - #11958',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Expand diffs to get more context about your changes - #11965',
          ],
          [
            'New',
            'Preliminary support for Windows ARM64 - #9034. Thanks @dennisameling!',
          ],
          [
            'Added',
            'Hide Whitespace in diffs on both Changes and History tabs - #6818. Thanks @say25!',
          ],
          [
            'Fixed',
            'Show correct state of remote branch when deleting local branches - #11923',
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Update how privacy and usage stats info are provided to the user - #11845',
          ],
          [
            'Added',
            'Create branch during cherry-picking via the context menu - #11903',
          ...
          [
            'Added',
            'Suggest macOS users to move the app to `/Applications` to prevent issues - #11846',
          ],
          [
            'Fixed',
            'Dragging commits onto current branch no longer results in a broken state - #11915',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'User can no longer get into a bad persistent cherry-picking drag state - #11875',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Add ability for users to navigate branch menu tabs during cherry-pick - #11834',
          ],
          [
            'Improved',
            'Add ability for scroll during a drag based on mouse position when over a scrollable element - #11849',
          ],
          [
            'Improved',
            'Use conflict dialog to handle conflict for non-existent files during cherry-pick - #11866',
          ],
          [
            'Fixed',
            'Theme settings correctly persist user selection - #11814. Thanks @say25!',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Give user more time to undo in the cherry-pick success banner - #11822',
          ],
          [
            'Improved',
            'Improved cherry-picking drop target discoverability - #11827',
          ],
          ['Improved', 'Use Git language to describe cherry-pick - #11835'],
          [
            'Fixed',
            'After cherry-picking complete, show latest cherry-picked commit as selected in history - #11833',
          ],
          [
            'Fixed',
            'Preserve and convert legacy theme setting - #11814. Thanks @say25!',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Add support for RStudio Editor on MacOS - #11690. Thanks @geophilusd!',
          ],
          ['Improved', 'Use system theme as default - #9959. Thanks @say25!'],
          [
            'Improved',
            'Improve UX of cherry picking multiple commits with drag and drop - #11800',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Remote Git operations failed in some circumstances - #11696 #11701',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Cherry picking! Copy commits from one branch to another - #1685',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add .avif image support - #11625. Thanks @brendonbarreto!',
          ],
          [
            'Fixed',
            'Performing remote Git operations in rare cases displays an error message instead of crashing the app - #11694',
          ],
          [
            'Improved',
            'Clicking on "Add Co-Author" moves the focus to the co-authors text field - #11621',
          ],
        ],
      },
      {
        ...
        d: '2021-03-04',
        t: '15:50',
        e: [['Fixed', 'Performing remote Git operations could crash the app']],
      },
      {
        v: '2.6.4',
        d: '2021-03-03',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Remote Git operations are now faster and less prone to errors on Windows - #11510',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            'Add branch context menu with rename and delete to branch dropdown list - #5803 #10432',
          ],
          [
            'Fixed',
            'Always respect the default branch name chosen by the user - #11447',
          ...
          [
            'Fixed',
            'Notepad++ is not closed anymore when GitHub Desktop closes - #11518',
          ],
          [
            'Improved',
            'Suggest emails from GitHub accounts and warn about misattributed commits in onboarding and Preferences - #11561 #11566',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Updated about modal dialog on macOS to match the new Big Sur icon - #11511',
          ],
        ],
      },
      {
        ...
        d: '2021-02-01',
        t: '12:48',
        e: [['Improved', 'Update app icon for macOS Big Sur - #10855']],
      },
      {
        v: '2.6.3-beta1',
        d: '2021-01-28',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Keep focus in dropdown when pressing tab multiple times - #11278',
          ],
          ['Improved', 'Upgrade embedded Git LFS to 2.13.2 - #11394'],
          [
            'Improved',
            'Add detection of Sublime Text 4 and 2 as editor on macOS. - #11263. Thanks @yurikoles!',
          ],
          [
            'Fixed',
            'Fork behavior changes are now reflected in the app immediately - #11327',
          ...
          [
            'Fixed',
            'Commit message remains in text box until user chooses to commit - #7251',
          ],
        ],
      },
      {
        ...
        d: '2021-01-14',
        t: '06:44',
        e: [['Removed', 'Release removed in favor of 2.6.2-beta4']],
      },
      {
        v: '2.6.2-beta2',
        d: '2020-12-23',
        ...
        e: [
          [
            'Fixed',
            "Forked repository remotes are no longer removed when there's local branches tracking them - #11266",
          ],
          [
            'Fixed',
            'Avoid bright flash for users of the dark theme when launching the app maximized - #5631. Thanks @AndreiMaga!',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Addressed an issue where pull requests could fail to update until the user switched repositories - #11241',
          ],
          [
            'Fixed',
            "Don't offer to stash or move changes when clicking on the currently checked out branch in the branch list - #11235",
          ],
          [
            'Fixed',
            "Checking out a pull request from a fork repeatedly now detects that there's already a branch that can be reused - #11238",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Desktop would fail to launch for some users due to objects in the database using an old format - #11176',
          ],
          [
            'Fixed',
            'Desktop would fail to launch for a small percentage of users that had several non-GitHub repositories in the app - #11192',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Refactor checkout branch and stash logic - #9297 #10956 #8099 #7617',
          ],
          [
            'Fixed',
            'Let the user know when a checkout fails due to use of assume-unchanged or skip-worktree - #9297',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fixes overflow issues with long branch names - #5970. Thanks @juliarvalenti!',
          ],
          [
            'Removed',
            'Sign in to GitHub.com with username/password is no longer supported',
          ],
        ],
      },
      {
        ...
        d: '2020-11-05',
        t: '22:34',
        e: [['Improved', 'Upgrade embedded Git LFS - #10973']],
      },
      {
        v: '2.5.7',
        d: '2020-11-05',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Comparison of different size image changes no longer overflow the bounds of the diff view - #2480 #9717',
          ],
          [
            'Fixed',
            'Repository indicator refresh can no longer be manually triggered when disabled - #10905',
          ...
          [
            'Fixed',
            'Choosing to resolve a conflicted file added in both the source and target branch no longer results in merge conflict markers appearing in the merge commit - #10820',
          ],
          [
            'Fixed',
            'Small partial commit of very large text files no longer runs the risk of failing due to unexpected diff results - #10640',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Actions in the context menu of a non-selected file in history no longer acts on the previously selected item - #10743',
          ],
          ['Added', 'Add `toml` syntax highlight - #10763. Thanks @samundra!'],
          [
            'Added',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Align resolve button text and size icon appropriately - #10646',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Checking out a PR attempts to locate an existing branch tracking the PR base branch - #10598',
          ],
          [
            'Fixed',
            'Only show full screen toast notification when making the app window full-screen. Thanks @Sam-Spencer - #7916',
          ...
          [
            'Improved',
            'Allow using Enter key to confirm in rebase and merge dialogs - #10511',
          ],
          [
            'Removed',
            'Remove setting to disable all certificate validation in favor of new best-effort approach - #10581',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Add AspNet and Diff/Patch Syntax Highlights - #10410. Thanks @say25!',
          ],
          [
            'Improved',
            'Updated icons and border radiuses to align with GitHub.com - #10396, #10224',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Support for specifying the default branch for new repositories - #10262',
          ],
          [
            'Improved',
            'Enable discarding submodule working directory changes - #8218',
          ...
          [
            'Improved',
            'Fix label alignment in radio-button component styles - #10397',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Dialog now clears filters on esc and closes on double esc - #6369. Thanks @AndreiMaga!',
          ],
          ['Fixed', 'Fix BBEdit integration - #9050. Thanks @grumpybozo!'],
          ...
          [
            'Improved',
            'Autocompletion of users and issues from a fork - #10084',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Set initial value of opt out checkbox in Discard line confirmation dialog to false - #9989',
          ],
          [
            'Fixed',
            'Select correct branch to compare when two branches have similar names - #9977',
          ...
          [
            'Improved',
            'Add detection to disable username and password authentication when the API is no longer available - #9231',
          ],
          [
            'Improved',
            'Remove redundant progress text from Git error messages - #9945',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            "Offer ability to delete tags that haven't been pushed - #9796",
          ],
          [
            'Fixed',
            'Checkout PR branch when using "Open in GitHub Desktop" from github.com - #9873',
          ],
          [
            'Fixed',
            'Handle Enter key presses in Clone Repository Dialog - #5234 #8804. Thanks @ruggi99!',
          ],
          [
            'Fixed',
            'Avoid errors in restoring a stash when a branch is also named "stash" - #9844',
          ...
          [
            'Fixed',
            'Avoid performing background network operations to calculate unpushed tags - #9828',
          ],
          [
            'Fixed',
            'Rework Ctrl+Tab to switch between Changes and History anytime the app has focus - #5911. Thanks @JMcKiern!',
          ...
          [
            'Improved',
            'Update design of list scrollbars on Windows to prevent overlapping with content - #9786',
          ],
          [
            'Unshipped',
            'Remove prompt for notifying when your branch has diverged from the default branch - #9804',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Prevent Git authentication errors from prompting to retry clone instead of authentication dialog - #9777',
          ],
          [
            'Improved',
            'Avoid executing unwanted Git hooks when fetching unpushed tags - #9793',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Add missing "Cancel" button in onboarding sign-in flow - #9715',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Add ability to always choose the file from one branch or the other when resolving merge conflicts - #9702',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Display tags in commit list and show tag creation option - #9682',
          ],
          [
            'Improved',
            'Emphasize sign in via browser option in Welcome flow - #9663',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            'Show unpushed indicator on commits that have unpushed tags - #9667',
          ],
          [
            'Added',
            'Add context menu for highlighted text in diff view - #5100. Thanks @HashimotoYT!',
          ...
          [
            'Improved',
            'Indicate in the Push/Pull/Fetch button when there are local unpushed tags - #9576',
          ],
          [
            'Improved',
            'Offer to retry cloning if it fails - #926. Thanks @Daniel-McCarthy!',
          ],
      ...
      },
      {
        ...
        d: '2020-04-21',
        t: '15:20',
        e: [['Fixed', 'Update embedded Git to address security vulnerability']],
      },
      {
        v: '2.4.2',
        d: '2020-04-21',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Prevent autocomplete suggestions from overlapping in some cases - #9474',
          ],
          ['Fixed', 'Update embedded Git to address security vulnerability'],
          ['Improved', 'Redesign metadata shown in commit history - #9428'],
        ],
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Indicate which commits are un-pushed in "History" tab - #5873',
          ],
          [
            'Added',
            'Show progress bar in taskbar during pushing and pulling changes - #8433. Thanks @ChamodyaDias!',
          ],
          [
            'Added',
            'Add support for JetBrains Rider as external editor - #9368 #9365. Thanks @wengfatt and @say25!',
          ...
          [
            'Fixed',
            'Use correct install location of Typora to fix detection issue - #9417. Thanks @TerryChan!',
          ],
          [
            'Fixed',
            'Display pull requests from upstream repository in pull request list - #6383',
          ...
          [
            'Improved',
            'Notify consistently when default or upstream branch has new commits that are not present on your branch - #9320 #9328 #9319',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Preserve the footer within a resizable list when shrinking or expanding - #9344',
          ],
          [
            'Fixed',
            'Save the user\'s position within "History" and "Changes" tabs when switching - #9061',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'New branches in forks are created from the default branch of the upstream repo - #7762',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Direct new issues created from a local fork to its upstream on GitHub - #9232',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Support disabling certificate revocation checks on Windows - #3326',
          ],
          [
            'Improved',
            'Expand system dark mode detection to Windows - #9015. Thanks @say25!',
          ],
          [
            'Improved',
            'Allow "Open in Desktop" button from pull requests on GitHub to open in a local fork in Desktop - #9012',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Checkout correct PR branch from “open this in GitHub Desktop” link on GitHub.com pull request page - #9108',
          ],
          [
            'Fixed',
            'Ensure branch protection warning works when branch names contain special characters - #9086',
          ...
          [
            'Fixed',
            'Fix graphic indicating files selected in Dark Mode - #8716. Thanks @say25!',
          ],
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Testing upgrade from Electron v6 to v7']],
      },
      {
        v: '2.3.0-test1',
        d: null,
        t: null,
        e: [[null, 'Testing upgrade from Electron v5 to v6']],
      },
      {
        v: '2.3.2-beta1',
        d: '2020-01-29',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Remove stray characters from Git progress indicators - #8962',
          ],
          [
            'Fixed',
            'Show proper dialog when push fails due to missing workflow scope - #8958',
          ...
          [
            'Added',
            'Show link to upstream pull requests in pull request list - #8965',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Prompt users to make a fork if they fail to push to a GitHub repository due to permissions  - #8548',
          ],
          [
            'Added',
            "Show a commit warning if the user can't push to the repository - #8938",
          ],
          [
            'Fixed',
            'Route the user to the correct URL when opening a pull request from a fork in the browser - #8928',
          ],
          [
            'Improved',
            'Only show branch protection warning when changed files are present - #8795',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Users can configure Desktop to always bring or leave changes when switching branches - #7746',
          ],
          [
            'Added',
            'Prompt users to re-authorize if required by any of their GitHub organizations - #8910',
          ...
          [
            'Fixed',
            'Recognize if the current branch of a fork has a pull request to the upstream repo - #8549',
          ],
          [
            'Fixed',
            'Remove false branch protection warning when switching branches - #8743',
          ...
          [
            'Fixed',
            'Update branch protection state for checkout outside of Desktop - #8790',
          ],
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [['Fixed', 'Sign Windows installers using SHA256 file digest']],
      },
      {
        v: '2.2.4',
        d: '2019-12-11',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Make newly cloned repositories load pull requests correctly - #8745',
          ],
          [
            'Improved',
            'Make no newline indicator in file diffs readable by screenreaders. - #6494. Thanks @jmhammock!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            "Warn user if they're committing to a repo they don't have write permission for - #8665",
          ],
          [
            'Improved',
            "Don't prompt to stash changes when switching away from protected branch - #8664",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Testing entitlements + notarization for mac app']],
      },
      {
        v: '2.2.3-test4',
        d: null,
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Testing notarization for mac app']],
      },
      {
        v: '2.2.3-test1',
        d: null,
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Helpful animations during the onboarding tutorial - #8487',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Retain commit summary placeholder in tutorial repo - #8354',
          ],
          ...
          [
            'Improved',
            'Specific error message when tutorial creation fails due to repository already existing - #8351',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Add "Welcome" and "You\'re done!" screens to onboarding tutorial - #8232',
          ],
          ...
          [
            'Fixed',
            'Mark pull request step in tutorial done more quickly - #8317',
          ],
          [
            'Fixed',
            'Prevent triggering multiple tutorial creation flows in parallel - #8288',
          ],
          [
            'Fixed',
            'Surface errors from branch creation to user - #8306 #5997 #8106',
          ...
          [
            'Fixed',
            'Reliably show "Open editor" button in tutorial after editor has been installed - #8315',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Commit summaries with comma delimited issues are parsed - #8162. Thanks @say25!',
          ],
          [
            'Fixed',
            'Commit description shadow visibility updates when typing - #7994. Thanks @KarstenRa!',
      ...
      },
      {
        ...
        d: '2019-08-20',
        t: '13:24',
        e: [['Fixed', 'Update embedded Git on Windows - #8133']],
      },
      {
        v: '2.1.2-beta1',
        d: '2019-08-19',
        ...
        e: [
          [
            'Added',
            'Option to hide whitespace in historical commits - #8045. Thanks @say25!',
          ],
          [
            'Fixed',
            'Small images are scaled down too much in two-up image rendering - #7520',
          ...
          [
            'Fixed',
            'Disable some unavailable actions while committing - #3814 #5934. Thanks @HashimotoYT!',
          ],
          ['Fixed', 'Branch pruner errors on "orphaned" branches - #7983'],
          [
            'Fixed',
          ...
          [
            'Improved',
            'Re-word "No local changes" view summary - #8007. Thanks @rexogamer!',
          ],
          [
            'Improved',
            'Expand hover area on repository list items - #7910. Thanks @say25!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Text overflow in error popup when an editor cannot be launched - #7988',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Incorrect proportions for "stashed changes" button - #7964',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'WSL Support - #7821 #7891. Thanks @ADustyOldMuffin @say25!',
          ],
          [
            'Fixed',
            'Tooltip does not display on the entire hit area for list items - #7910. Thanks @say25!',
          ],
          [
            'Improved',
            'Error handling when trying to rebase onto an invalid ref - #7871',
          ],
          [
            'Improved',
            "Trigger diff search even when CodeMirror doesn't have focus - #7899",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Commit form will warn user when working on a protected branch - #7826',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            '"Unable to restore" warning message appears when restoring stash - #7652',
          ],
          [
            'Fixed',
            'Unresponsive app on macOS if user switches away from file dialog - #7636',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Upgrading infrastructure to Node 10']],
      },
      {
        v: '2.0.4',
        d: '2019-06-12',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Crash when attempting to update pull requests with partially updated repository information - #7688',
          ],
          [
            'Fixed',
            'Crash when loading repositories after signing in through the welcome flow - #7699',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Show explanation for manually conflicted text files in diff viewer - #7611',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Restore Desktop to main screen when external monitor removed - #7418 #2107. Thanks @say25!',
          ],
          [
            'Improved',
            'Performance for bringing uncommitted changes to another branch - #7474',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Added',
            'Accelerator and access key to "Exit" menu item - #6507. Thanks @AndreiMaga!',
          ],
          [
            'Fixed',
            'Pressing "Shift" + "Alt" in Commit summary moves input-focus to app menu - #6366. Thanks @AndreiMaga!',
          ],
          [
            'Fixed',
            'Incorrectly encoding URLs affects issue filtering - #7506',
          ...
          [
            'Improved',
            'Command line interface warns with helpful message when given a remote URL - #7452. Thanks @msztech!',
          ],
          [
            'Improved',
            'Lowercase pronoun in "Revert this commit" menu item - #7534',
          ...
          [
            'Improved',
            '"Pull Requests" list reflects pull requests from GitHub more quickly - #7501',
          ],
          [
            'Removed',
            'Branch and pull request filter text persistence - #7437',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            '"Stashed changes" button accessibility improvements - #7274',
          ],
          [
            'Improved',
            'Performance improvements for bringing changes to another branch - #7471',
          ],
          [
            'Improved',
            'Performance improvements for detecting conflicts from a restored stash - #7476',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Stash viewer does not disable restore button when changes present - #7409',
          ],
          ['Fixed', 'Stash viewer does not center "no content" text - #7299'],
          [
            'Fixed',
            'Stash viewer pane width not remembered between sessions - #7416',
          ],
          [
            'Fixed',
            '"Esc" key does not close Repository or Branch list - #7177. Thanks @roottool!',
          ...
          [
            'Fixed',
            'Stash not cleaned up when it conflicts with working directory contents - #7383',
          ],
          [
            'Improved',
            'Branch names remain accurate in dialog when stashing and switching branches - #7402',
          ],
          [
            'Improved',
            'Moved "Discard all changes" to Branch menu to prevent unintentionally discarding all changes - #7394. Thanks @ahuth!',
          ],
          [
            'Improved',
            'UI responsiveness when using keyboard to choose branch in rebase flow - #7407',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Handle warnings if stash creation encounters file permission issue - #7351',
          ],
          [
            'Fixed',
            'Add "View stash entry" action to suggested next steps - #7353',
          ],
          [
            'Fixed',
            'Handle and recover from failed rebase flow starts - #7223',
          ],
          [
            'Fixed',
            'Reverse button order when viewing a stash on macOS - #7273',
          ],
          [
            'Fixed',
            'Prevent console errors due to underlying component unmounts - #6970',
          ...
          [
            'Fixed',
            'Rebase success banner always includes base branch name - #7220',
          ],
          [
            'Improved',
            'Added explanatory text for "Restore" button for stashes - #7303',
          ],
          ['Improved', 'Ask for confirmation before discarding stash - #7348'],
          ['Improved', 'Order stashed changes files alphabetically - #7327'],
          [
            'Improved',
            'Clarify "Overwrite Stash Confirmation" dialog text - #7361',
          ],
          [
            'Improved',
            'Message shown in rebase setup when target branch is already rebased  - #7343',
          ],
          ['Improved', 'Update stashing prompt verbiage - #7393.'],
          ['Improved', 'Update "Start Rebase" dialog verbiage - #7391'],
          [
            'Improved',
            'Changes list now reflects what will be committed when handling rebase conflicts - #7006',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Manual conflict resolution choice not updated when resolving rebase conflicts - #7255',
          ],
          [
            'Fixed',
            "Menu items don't display the expected verbiage for force push and removing a repository - #4976 #7138",
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Users can choose to bring changes with them to a new branch or stash them on the current branch when switching branches - #6107',
          ],
          [
            'Added',
            'GitHub Desktop keyboard shortcuts available in Help menu - #7184',
          ],
          [
            'Added',
            '.resx file extension highlighting support - #7235. Thanks @say25!',
          ],
          [
            'Fixed',
            'Attempting to revert commits not on current branch results in an error - #6300. Thanks @msftrncs!',
          ...
          [
            'Improved',
            'Warn users before rebase if operation will require a force push after rebase complete - #6963',
          ],
          [
            'Improved',
            'Do not show the number of pull requests when there are no open pull requests - #7258',
          ],
          [
            'Improved',
            'Accessibility attributes for dialog - #6496. Thanks @HirdayGupta!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Merge/Rebase conflicts banners do not clear when aborting the operation outside Desktop - #7046',
          ],
          [
            'Fixed',
            'Missing tooltips for change indicators in the sidebar - #7174',
          ...
          [
            'Improved',
            'Pull requests load faster and PR build status updates automatically - #7163',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Recently opened repositories appear at the top of the repository list - #7132',
          ],
          [
            'Fixed',
            'Error when selecting diff text while diff is updating - #7131',
          ],
          ['Fixed', 'Crash when unable to create log file on disk - #7096'],
          [
            'Fixed',
            'Race condition with remote lookup could cause push to go to incorrect remote - #6986',
          ],
          [
            'Fixed',
            'Mistaken classification of all crashes being related to launch - #7126',
          ...
          [
            'Fixed',
            'Prevent menus from being disabled by activity in inactive repositories - #6313',
          ],
          [
            'Fixed',
          ...
          [
            'Fixed',
            'Emoji rendering in app broken when account name has special characters - #6909',
          ],
          [
            'Fixed',
            'Files staged outside Desktop for deletion are incorrectly marked as modified after committing - #4133',
          ...
          [
            'Improved',
            'Visual feedback on "Remove Repository" and "Discard Changes" dialogs to show progress - #7015. Thanks @HashimotoYT!',
          ],
          [
            'Improved',
            'Onboarding language for blank slate components - #6638. Thanks @jamesgeorge007!',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Publish Repository does not let you publish to an organization on your Enterprise account - #7052',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Publish Repository does not let you choose an organization on your Enterprise account - #7052',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Removed',
            'Option to discard when files would be overwritten by a checkout - #7016',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Provide option to discard when files would be overwritten by a checkout - #6755. Thanks @mathieudutour!',
          ],
          [
            'Fixed',
            'No left padding for :emoji:/@user/#issue autocomplete forms. - #6895. Thanks @murrelljenna!',
          ...
          [
            'Fixed',
            'Reinstate missing image and fix illustration to work in the dark theme when there are no local changes - #6894',
          ],
          [
            'Fixed',
            'Display question mark image when there is no commit selected in dark theme - #6915. Thanks @say25!',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Moving the mouse pointer outside of the visible diff while selecting a range of lines in a partial commit will now automatically scroll the diff - #658',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Context menu doesn't open when right clicking on the edges of files in Changes list - #6296. Thanks @JQuinnie!",
          ],
          [
            'Improved',
            'Enable Git protocol v2 for fetch/push/pull operations - #6142',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Updated verbiage when clicking on changed files to make it more explicit what will occur when you ignore the file(s) - #6689. Thanks @PaulViola!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Autocomplete selection does not overflow text area - #6459',
          ],
          [
            'Fixed',
            'No local changes views incorrectly rendering ampersands - #6596',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'New',
            '"No local changes" view makes it easy to find and accomplish common actions - #6445',
          ],
          [
            'Fixed',
            'Automatically locate a missing repository when it cannot be found - #6228. Thanks @msftrncs!',
          ...
          [
            'Improved',
            "Merge success banner no longer shown when attempted merge doesn't complete - #6282",
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Added',
            'Include ability for users to add new repositories when there are none available - #5566 #6474',
          ],
          [
            'Added',
            'Support JetBrains Webstorm as an external editor - #6077. Thanks @KennethSweezy!',
          ...
          [
            'Fixed',
            'Enter when using keyboard to navigate app menu executed menu action twice - #5344',
          ],
          [
            'Improved',
            'Image diff menu no longer covered by large images - #6520. Thanks @06b!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Dismissable merge conflict dialog and associated banner - #6379 #6380',
          ],
          [
            'Fixed',
            'Fix feature flag for readme overwrite warning so that it shows on beta - #6412',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Display warning if existing readme file will be overwritten - #6338. Thanks @Daniel-McCarthy!',
          ],
          [
            'Improved',
            'Add check for attempts to commit >100 MB files without Git LFS - #997. Thanks @Daniel-McCarthy!',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Maintains state on tabs for different methods of cloning repositories - #5937',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Improved',
            'Clarified internal documentation - #6348. Thanks @bblarney!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Merge dialog displays current branch in header - #6027',
          ],
          [
            'Improved',
            'Clarify the direction of merging branches - #5930. Thanks @JQuinnie!',
          ...
          [
            'Improved',
            'Updated license and .gitignore templates for initializing a new repository - #6024. Thanks @say25!',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Repository switcher has a convenient "Add" button to add other repositories - #5878',
          ],
          [
            'New',
            'macOS tray icon now supports drag-and-drop to add local repositories - #5048',
          ],
          [
            'Added',
            'Keyboard shortcut for "Rename Branch" menu item - #5964. Thanks @agisilaos!',
      ...
      },
      {
        ...
        e: [
          [
            'Added',
            'Added keyboard shortcut to delete a branch - #5018. Thanks @JakeHL!',
          ],
          [
            'Fixed',
            'Fix release notes text overflowing dialog box - #5854. Thanks @amarsiingh!',
          ],
          ['Improved', 'Avoid unnecessarily reloading commit history - #5470'],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fix emoji autocomplete not rendering in some situations - #5859',
          ],
          [
            'Fixed',
            'Support Python 3 in Desktop CLI on macOS - #5843. Thanks @munir131!',
      ...
      },
      {
        ...
        t: null,
        e: [
          [null, 'Testing changes to how Desktop performs CI platform checks'],
        ],
      },
      {
        v: '1.4.1-test1',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'When an update is available for GitHub Desktop, the release notes can be viewed in Desktop - #2774',
          ],
          ['New', 'Detect merge conflicts when comparing branches - #4588'],
          [
            'Fixed',
          ...
          [
            'Improved',
            'Skip optional locks when checking status of repository - #5376',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            "Don't hide commit details when commit summary description is expanded. - #5471. Thanks @aryyya!",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Cloning message uses remote repo name not file destination - #5413. Thanks @lisavogtsf!',
          ],
          [
            'Improved',
            'Support VSCode user scope installation - #5281. Thanks @saschanaz!',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Testing infrastructure changes']],
      },
      {
        v: '1.3.3-test5',
        d: null,
        t: null,
        e: [[null, 'Testing the new CircleCI config changes']],
      },
      {
        v: '1.3.3-test4',
        d: null,
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Bugfix for background checks not being aware of missing repositories - #5282',
          ],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'New',
            'Repository list displays uncommitted changes indicator and ahead/behind information - #2259 #5095',
          ],
          [
            'Added',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Ensure commit message is cleared after successful commit - #4046',
          ],
          ['Fixed', 'History omits latest commit from list - #5243'],
        ],
      },
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Test deployment for electron version bump.']],
      },
      {
        v: '1.3.0-beta1',
        d: '2018-07-11',
        ...
        e: [
          ...
          [
            'New',
            'Repository list displays uncommitted changes count and ahead/behind information - #2259',
          ],
          [
            'Added',
            'Syntax highlighting for PowerShell files- #5081. Thanks @say25!',
          ...
          [
            'Fixed',
            'Display something when repository is located at drive root - #4924',
          ],
          [
            'Fixed',
            'Relax checks for merge commits for GitHub Enterprise repositories - #4329',
          ...
          [
            'Improved',
            'Repository list badge style tweaks and tweaks for dark theme - #5095',
          ],
          [
            'Improved',
            'Change primary button color to blue for dark theme - #5074',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Sanity check deployment for refactored scripts']],
      },
      {
        v: '1.2.7-beta0',
        d: '2018-06-25',
      ...
      },
      {
        ...
        t: null,
        e: [
          [null, 'Confirming latest Git LFS version addresses reported issues'],
        ],
      },
      {
        v: '1.2.4-beta3',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Upgraded embedded Git to 2.17.0']],
      },
      {
        v: '1.2.1-beta1',
        d: '2018-05-29',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Testing the Webpack v4 output from the project']],
      },
      {
        v: '1.2.0',
        d: '2018-05-22',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Open in Shell on Linux ensures Git is available on the user's PATH - #4619. Thanks @ziggy42!",
          ],
          [
            'Fixed',
            'Keyboard focus issues when navigating Pull Request list - #4673',
          ],
          [
            'Improved',
            'Automatically add valid repository when using command line interface - #4513. Thanks @ggajos!',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [[null, 'Actually upgrading fs-extra to v6 in the app']],
      },
      {
        v: '1.1.2-test4',
        d: null,
        t: null,
        e: [[null, 'Upgrading fs-extra to v6']],
      },
      {
        v: '1.1.2-beta5',
        d: '2018-05-04',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'New Compare tab allowing visualization of the relationship between branches',
          ],
          [
            'New',
            'Support for selecting more than one file in the changes list - #1712. Thanks @icosamuel!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Fetch to ensure "Open in Desktop" has a branch to checkout - #3006',
          ],
          [
            'Fixed',
            'Handle the click event when opening a binary file - #4446',
          ],
          [
            'Fixed',
            'Skip fast-forwarding when there are a lot of eligible local branches - #4392',
          ],
          [
            'Fixed',
            'Image diffs not working for files with upper-case file extension - #4466',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [['New', 'Comparison Branch demo build']],
      },
      {
        v: '1.1.2-test2',
        d: null,
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "'Open File in External Editor' does not use existing window - #4381",
          ],
          [
            'Fixed',
            'Always ask for confirmation when discarding all changes - #4423',
          ],
          [
            'Improved',
            'Pull request status text now matches format on GitHub - #3521',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Keep caret position after inserting completion - #3835. Thanks @CarlRosell!',
          ],
          [
            'Fixed',
            'Handle error events when watching files used to get Git LFS output - #4117',
          ...
          [
            'Fixed',
            'Disable input fields summary and description while commit in progress - #3893. Thanks @crea7or!',
          ],
          [
            'Fixed',
            'Ensure pull request cache is cleared after last pull request merged - #4122',
          ...
          [
            'Fixed',
            'Delete gitignore file when entries cleared in Repository Settings - #1896',
          ],
          [
            'Fixed',
            'Add visual indicator that a folder can be dropped on Desktop - #4004. Thanks @agisilaos!',
          ...
          [
            'Improved',
            'Move forget password link to after the password dialog to maintain expected tab order - #4283. Thanks @iamnapo!',
          ],
          [
            'Improved',
            'More descriptive text in repository toolbar button when no repositories are tracked - #4268. Thanks @agisilaos!',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [['Improved', 'Electron 1.8.3 upgrade (again)']],
      },
      {
        v: '1.1.1-test1',
        d: null,
        ...
        e: [
          [
            'Improved',
            'Forcing a focus on the window after the OAuth dance is done',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Improved',
            'Update embedded Git to improve error handling when using stdin - #4058',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Improve detection of pull requests associated with current branch - #3991',
          ],
          [
            'Fixed',
            'Disable drag-and-drop interaction when a popup is in the foreground - #3996',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Enable fuzzy search in the repository, branch, PR, and clone FilterLists - #911. Thanks @j-f1!',
          ],
          [
            'Improved',
            'Tidy up commit summary and description layout in commit list - #3922. Thanks @willnode!',
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [['Improved', 'Electron 1.8.2 upgrade']],
      },
      {
        v: '1.0.14-beta3',
        d: '2018-02-07',
        ...
        e: [
          ...
          [
            'Improved',
            'Show progress when initializing remote for fork - #3953',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Expanded avatar list hidden behind commit details - #3884',
          ],
          ['Fixed', 'Renames not detected when viewing commit diffs - #3673'],
          [
            'Fixed',
      ...
      },
      {
        ...
        d: '2018-01-29',
        t: '21:24',
        e: [['New', 'Commit together with co-authors - #3879']],
      },
      {
        v: '1.0.13',
        d: '2018-01-29',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Allows double dashes in branch name - #3599. Thanks @JQuinnie!',
          ],
          ['Fixed', 'Pull Request store may not have status defined - #3869'],
          [
            'Fixed',
            'Render the Pull Request badge when no commit statuses found - #3608',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Windows: Detects available editors and shells now works even when the group policy blocks write registry access - #3105 #3405',
          ],
          ['Fixed', 'Windows: Menu items are no longer truncated - #3547'],
          [
            'Fixed',
            'Windows: Prevent disabled menu items from being accessed - #3391 #1521',
          ],
          [
            'Fixed',
            'Preserve the selected pull request when a manual fetch is done - #3524',
          ],
          [
            'Fixed',
            'Update pull request badge after switching branches or pull requests - #3454',
          ],
          [
            'Fixed',
            'Restore keyboard arrow navigation for pull request list - #3499',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        d: null,
        t: null,
        e: [['Improved', 'now with a new major version of electron-packager']],
      },
      {
        v: '1.0.11-beta0',
        d: '2017-12-06',
        ...
        e: [
          ...
          [
            'Fixed',
            'URL encode branch names when creating a pull request - #3509',
          ],
          [
            'Fixed',
            'Windows: detecting available editors and shells now works even when the group policy blocks write registry access - #3105 #3405',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Change "Create Pull Request" to "Show Pull Request" when there is already a pull request open for the branch - #2524',
          ],
          [
            'New',
            'VSCode Insiders build is now a supported external editor - #3441. Thanks @say25!',
          ...
          [
            'New',
            'Hyper is now a supported shell - #3455. Thanks @JordanMussi!',
          ],
          ['New', 'Cypher is now syntax highlighted - #3440. Thanks @say25!'],
          [
            'New',
          ...
          [
            'Improved',
            'Use the same colors in pull request dropdown as we use on GitHub.com - #3451',
          ],
          ...
          [
            'Improved',
            'Refresh the pull request list when the Push/Pull/Fetch button is clicked - #3448',
          ],
          ['Improved', 'Ignore menu events sent when a modal is shown - #3308'],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Vue.js code is now syntax highlighted! - #3368. Thanks @wanecek!',
          ],
          [
            'New',
            'CoffeeScript is now syntax highlighted! - #3356. Thanks @agisilaos!',
          ...
          [
            'Improved',
            'Use smarter middle truncation for branch names - #3357',
          ],
          [
            'Fixed',
            'Windows: Removed the title attribute on the Windows buttons so that they no longer leave their tooltips hanging around - #3348. Thanks @j-f1!',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'New',
            'Linux: Add Atom and Sublime Text support - #3133. Thanks @ziggy42!',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'The "Create without pushing" button when creating a new pull request wouldn\'t actually do anything - #2917',
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Allow users to create repositories with descriptions - #2719. Thanks @davidcelis!',
          ],
          [
            'New',
      ...
      },
      {
        ...
        d: '2017-07-31',
        t: '15:16',
        e: [['Fixed', 'Issues with auto-updating to 0.7.1.']],
      },
      {
        v: '0.7.2-beta0',
        d: '2017-07-31',
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Improved',
            'Better error message when publishing a repository fails - #2089',
          ],
          [
            'Improved',
            "Windows: Don't recreate the desktop shortcut if it's been deleted - #1759",
          ],
          ['Fixed', "Cloning a repository's wiki - #1624"],
          ['Fixed', "Don't call GitHub Enterprise GitHub.com - #2094"],
          [
            'Fixed',
            "Don't push after publishing a new repository if the branch is unborn - #2086",
          ],
          ['Fixed', "Don't close dialogs when clicking the title bar - #2056"],
          [
            'Fixed',
            "Windows: Clicking 'Show in Explorer' doesn't bring Explorer to the front - #2127",
          ],
          [
            'Fixed',
            "Windows: Opening links doesn't bring the browser to the front - #1945",
          ],
          [
            'Fixed',
            "macOS: Closing the window wouldn't exit fullscreen -  #1901",
          ],
          [
            'Fixed',
            'Scale blankslate images so they look nicer on high resolution displays - #1946',
          ],
          [
            'Fixed',
            'Windows: Installer not completing or getting stuck in a loop - #1875 #1863',
          ],
          [
            'Fixed',
            "Move the 'Forgot Password' link to fix the tab order of the sign in view - #2200",
          ],
        ],
      },
      {
      ...
      },
      {
        ...
        e: [
          ...
          [
            'New',
            "Added the 'Open in External Editor' contextual menu item to changed files - #2023",
          ],
          [
            'New',
            "Added the 'Show' and 'Open Command Prompt' contextual menu items to repositories - #1554",
          ],
          [
            'New',
            'Windows: Support self-signed or untrusted certificates - #671',
          ],
          ['New', 'Copy the SHA to the clipboard when clicked - #1501'],
          [
            'Improved',
            "Provide the option of initializing a new repository when adding a directory that isn't already one - #969",
          ],
          [
            'Improved',
            'Link to the working directory when there are no changes - #1871',
          ],
          [
            'Improved',
            'Hitting Enter when selecting a base branch creates the new branch - #1780',
          ],
          [
            'Improved',
            'Prefix repository names with their owner if they are ambiguous - #1848',
          ],
          ['Fixed', 'Sort and filter licenses like GitHub.com - #1987'],
          [
            'Fixed',
            'Long branch names not getting truncated in the Rename Branch dialog - #1891',
          ],
          ['Fixed', 'Prune old log files - #1540'],
          [
            'Fixed',
            'Ensure the local path is valid before trying to create a new repository - #1487',
          ],
          ['Fixed', 'Support cloning repository wikis - #1624'],
          [
            'Fixed',
            'Disable the Select All checkbox when there are no changes - #1389',
          ],
          [
            'Fixed',
            "Changed docx files wouldn't show anything in the diff panel - #1990",
          ],
          [
            'Fixed',
            'Disable the Merge button when there are no commits to merge - #1359',
          ],
          [
            'Fixed',
            'Username/password authentication not working for GitHub Enterprise - #2064',
          ],
          ['Fixed', 'Better error messages when an API call fails - #2017'],
          ['Fixed', "Create the 'logs' directory if it doesn't exist - #1550"],
          [
            'Fixed',
            "Enable the 'Remove' menu item for missing repositories - #1776",
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Uncaught exception when hitting the arrow keys after showing autocompletions - #1971',
          ],
          [
            'Fixed',
            'Clear the organizations list when publishing a new repository and switching between tabs - #1969',
          ],
          [
            'Fixed',
            'Push properly when a tracking branch has a different name from the local branch - #1967',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Disable push/pull menu items when there is no remote - #1448',
          ],
          [
            'Fixed',
            'Better error message when the GitHub Enterprise version is too old - #1628',
          ],
          ['Fixed', 'Error parsing non-JSON responses - #1505 #1522'],
          [
            'Fixed',
            "Updated the 'Install Git' help documentation link - #1797",
          ],
          ['Fixed', 'Disable menu items while in the Welcome flow - #1529'],
          [
            'Fixed',
            'Windows: Fall back to HOME if Document cannot be found - #1825',
          ],
          ['Improved', 'Close the window when an exception occurs - #1562'],
          ['Improved', 'Always use merge when pulling - #1627'],
          [
            'Improved',
            "Move the 'New Branch' menu item into the Branch menu - #1757",
          ],
          [
            'Improved',
            "Remove Repository's default button is now Cancel - #1751",
          ],
          ...
          [
            'Improved',
            'Prefer the GitHub repository name instead of the name on disk - #664',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Switching tabs in Preferences/Settings or Repository Settings would close the dialog - #1724',
          ],
          [
            'Improved',
            'Standardized colors which improves contrast and readability - #1713',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Windows: Handle protocol events which launch the app - #1582',
          ],
          [
            'Fixed',
            'Opting out of stats reporting in the Welcome flow - #1698',
          ],
          ['Fixed', 'Commit description text being too light - #1695'],
          [
            'Fixed',
            'Exception on startup if the app was activated too quickly - #1564',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'macOS: The buttons in the Untrusted Server dialog not doing anything - #1622',
          ],
          [
            'Fixed',
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Save the default path after creating a new repository - #1486',
          ],
          [
            'Fixed',
            'Only let the user launch the browser once for the OAuth flow - #1427',
          ],
          ...
          [
            'Fixed',
            "Windows: Invoking some menu items would break the window's snapped state - #1603",
          ],
          ['Fixed', 'macOS: Errors authenticating while pushing - #1514'],
          [
            'Fixed',
            "Don't linkify links in the History list or in Undo - #1548 #1608 #1474",
          ],
          [
            'Fixed',
            'Diffs not working when certain git config values were set - #1559',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Only create the `logs` directory if it doesn't already exist - #1510",
          ],
          [
            'Fixed',
            "Uncaught exception creating a new repository if you aren't a member of any orgs - #1507",
          ],
          ['Fixed', 'Only report the first uncaught exception - #1517'],
          [
            'Fixed',
            'Include the name of the default branch in the New Branch dialog - #1449',
          ],
          [
            'Fixed',
            'Uncaught exception if a network error occurred while loading user email addresses - #1522 #1508',
          ],
          [
            'Fixed',
            'Uncaught exception while performing a contextual menu action - #1532',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Display errors that happen while publishing a repository - #1396',
          ],
          ...
          [
            'Improved',
            'Request confirmation before removing a repository - #1233',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'New',
            'Windows: A nice little gif while installing the app - #1440',
          ],
          ...
          [
            'Improved',
            'Windows: A new application identifier, less likely to collide with other apps - #1441',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "Don't let the two-factor authentication dialog be submitted while it's empty - #1386",
          ],
          ...
          [
            'Fixed',
            'A second window would be opened during the OAuth dance - #1382',
          ],
          [
            'Fixed',
            "Don't include the comment from the default merge commit message - #1367",
          ],
          ['Fixed', 'Show progress while committing - #923'],
          [
            'Fixed',
            'Windows: Merge Branch sizing would be wrong on high DPI monitors - #1210',
          ],
          ['Fixed', 'Windows: Resize the app from the top left corner - #1424'],
          [
            'Fixed',
            "Changing the destination path for cloning a repository now appends the repository's name - #1408",
          ],
          [
            'Fixed',
            'The blank slate view could be visible briefly when the app launched - #1398',
          ],
          ['Improved', 'Performance updating menu items - #1321'],
          [
            'Improved',
            'Windows: Dim the title bar when the app loses focus - #1189',
          ],
        ],
      },
      {
        ...
        d: '2017-05-05',
        t: '16:18',
        e: [['Fixed', 'An uncaught exception when adding a user - #1394']],
      },
      {
        v: '0.0.38',
        d: '2017-05-05',
        ...
        e: [
          ...
          [
            'Fixed',
            "Updating the default branch on GitHub wouldn't be reflected in the app - #1028 #1314",
          ],
          [
            'Fixed',
            'Long repository names would overflow their container - #1331',
          ],
          [
            'Fixed',
            'Removed development menu items in production builds - #1031 #1251 #1323 #1340',
          ],
          [
            'Fixed',
            "Create Branch no longer changes as it's animating closed - #1304",
          ],
          [
            'Fixed',
            'Windows: Cut / Copy / Paste menu items not working - #1379',
          ],
          [
            'Improved',
            'Show a better error message when the user tries to authenticate with a personal access token - #1313',
          ],
          [
            'Improved',
            'Link to the repository New Issue page from the Help menu - #1349',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            "Better display of the 'no newline at end of file' indicator - #1253",
          ],
          [
            'Fixed',
            'macOS: Destructive dialogs now use the expected button order - #1315',
          ],
      ...
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Bugs around associating an email address with a GitHub user - #975',
          ],
          [
            'Fixed',
            'Use the correct reference name for an unborn branch - #1283',
          ],
          ...
          [
            'Improved',
            'More consistent use of sentence case on Windows - #1316',
          ],
      ...
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            "macOS: Don't show the titlebar while full screened - #1247",
          ],
          ...
          [
            'Fixed',
            'Auto updater errors not being propagated properly - #1266',
          ],
          [
            'Fixed',
            'Only show the current branch tooltip on the branches button - #1275',
          ],
          ['Fixed', 'Double path truncation - #1270'],
          [
            'Fixed',
            "Sometimes toggling a file's checkbox would get undone - #1248",
          ],
          [
            'Fixed',
            'Uncaught exception when internet connectivity was lost - #1048',
          ],
          [
            'Fixed',
            "Cloned repositories wouldn't be associated with their GitHub repository - #1285",
          ],
          ['Improved', 'Better performance on large repositories - #1281'],
          [
            'Improved',
            'Commit summary is now expandable when the summary is long - #519',
          ],
          [
            'Improved',
            'The SHA in historical commits is now selectable - #1154',
          ],
          [
            'Improved',
            'The Create Branch dialog was polished and refined - #1137',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'macOS: Users can choose whether to accept untrusted certificates - #671',
          ],
          [
            'New',
            'Windows: Users are prompted to install git when opening a shell if it is not installed - #813',
          ],
          [
            'New',
            'Checkout progress is shown if branch switching takes a while - #1208',
          ],
          [
            'New',
            'Commit summary and description are automatically populated for merge conflicts - #1228',
          ],
          ...
          [
            'Fixed',
            'Windows: Maximized windows are no longer positioned slightly off screen - #1202',
          ],
          ['Fixed', 'JSON parse errors - #1243'],
          [
            'Fixed',
            'GitHub Enterprise repositories were not associated with the proper Enterprise repository - #1242',
          ],
          ['Fixed', 'Timestamps in the Branches list would wrap - #1255'],
          [
            'Fixed',
            "Merges created from pulling wouldn't use the right git author - #1262",
          ],
          [
            'Improved',
            'Check for update errors are suppressed if they happen in the background - #1104, #1195',
          ],
          [
            'Improved',
            'The shortcut to show the repositories list is now command or control-T - #1220',
          ],
      ...
      },
      {
        ...
        d: '2017-04-13',
        t: '14:51',
        e: [['Fixed', "Update Now wouldn't update now - #1209"]],
      },
      {
        v: '0.0.32',
        d: '2017-04-13',
        ...
        e: [
          [
            'New',
            'You can now disable stats reporting from Preferences > Advanced - #1120',
          ],
          ...
          [
            'Fixed',
            'Logging out of one account would log out of all accounts - #1192',
          ],
          ['Fixed', 'Renamed files truncation - #695'],
          [
            'Fixed',
            'Git on Windows now integrates with the system certificate store - #706',
          ],
          [
            'Fixed',
            'Cloning with an account/repoository shortcut would always fail - #1150',
          ],
          ['Fixed', 'OS version reporting - #1130'],
          ['Fixed', 'Publish a new repository would always fail - #1046'],
          [
            'Fixed',
            'Authentication would fail for the first repository after logging in - #1118',
          ],
          [
            'Fixed',
            "Don't flood the user with errors if a repository disappears on disk - #1132",
          ],
          [
            'Improved',
            'The Merge dialog uses the Branches list instead of a drop down menu - #749',
          ],
          [
            'Improved',
            'Lots of design polish - #1188, #1183, #1170, #1184, #1181, #1179, #1142, #1125',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Prompt user to login when authentication error occurs - #903',
          ],
          [
            'New',
            'Windows application has a new app menu, replaces previous hamburger menu - #991',
          ],
          [
            'New',
            'Refreshed colours to align with GitHub website scheme -  #1077',
          ],
          ['New', 'Custom about dialog on all platforms - #1102'],
          [
            'Fixed',
            'Improved error handling when probing for a GitHub Enterprise server - #1026',
          ],
          ['Fixed', 'User can cancel 2FA flow - #1057'],
          ['Fixed', 'Tidy up current set of menu items - #1063'],
          [
            'Fixed',
            'Manually focus the window when a URL action has been received - #1072',
          ],
          [
            'Fixed',
            'Disable middle-click event to prevent new windows being launched - #1074',
          ],
          [
            'Fixed',
            'Pre-fill the account name in the Welcome wizard, not login - #1078',
          ],
          [
            'Fixed',
            "Diffs wouldn't work if an external diff program was configured - #1123",
          ],
          [
            'Improved',
            'Lots of design polish work - #1113, #1099, #1094, #1077',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Crash when invoking menu item due to incorrect method signature - #1041',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'New',
            'Commit summary and description fields now display issues and mentions as links for GitHub repositories - #941',
          ],
          [
            'New',
            'Show placeholder when the repository cannot be found on disk - #946',
          ],
          [
            'New',
            'New Repository actions moved out of popover and into new menu - #1018',
          ],
          [
            'Fixed',
            'Display a helpful error message when an unverified user signs into GitHub Desktop - #1010',
          ],
          ['Fixed', 'Fix kerning issue when access keys displayed - #1033'],
          [
            'Fixed',
            'Protected branches show a descriptive error when the push is rejected - #1036',
          ],
          [
            'Fixed',
            "'Open in shell' on Windows opens to repository location - #1037",
          ],
        ],
      },
      {
        ...
        d: '2017-03-08',
        t: '15:02',
        e: [['Fixed', 'Bumping release notes to test deployments again']],
      },
      {
        v: '0.0.27',
        d: '2017-03-08',
        ...
        e: [
          [
            'Fixed',
            '2FA dialog when authenticating has information for SMS authentication - #1009',
          ],
          [
            'Fixed',
            'Autocomplete for users handles accounts containing `-` - #1008',
          ],
        ],
      },
      {
        ...
        e: [
          [
            'Fixed',
            'Address deployment issue by properly documenting release notes',
          ],
        ],
      },
      {
        ...
        e: [
          ...
          [
            'Fixed',
            'Handle Enter key in repository and branch list when no matches exist - #995',
          ],
          [
            'Fixed',
            "'Add Repository' button displays in dropdown when repository list empty - #984",
          ],
          [
            'Fixed',
            'Correct icon displayed for non-GitHub repository - #964 #955',
          ],
          ['Fixed', 'Enter key when inside dialog submits form - #956'],
          ['Fixed', 'Updated URL handler entry on macOS - #945'],
          [
            'Fixed',
            'Commit button is disabled while commit in progress - #940',
          ],
          [
            'Fixed',
            'Handle index state change when gitginore change is discarded - #935',
          ],
          [
            'Fixed',
            "'Create New Branch' view squashes branch list when expanded - #927",
          ],
          [
            'Fixed',
            "Application creates repository path if it doesn't exist on disk - #925",
          ],
          [
            'Improved',
            'Preferences sign-in flow updated to standalone dialogs - #961',
          ],
        ],
      },
      {
        ...
        t: '10:29',
        e: [
          [null, 'Changed a thing'],
          [null, 'Added another thing'],
        ],
      },
    ],
  }
  ...
  global.DesktopMaterialDocsChangelogCatalog = catalog
