 ...
 *
 * Both English and Cantonese renderings of the title and description are
 * included so a query typed in either language matches regardless of the
 * viewer's chosen display mode. The title (index 0) and description (index 1)
 * come first so the shared matcher can highlight them.
 */
