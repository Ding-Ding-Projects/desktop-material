...
export const SettingsSearchCatalog: ReadonlyArray<ISettingsSearchEntry> =
  Object.freeze([
    ...
    {
      id: 'appearance-personal-vocabulary',
      tab: PreferencesTab.Appearance,
      titleKey: 'settings.personalVocabularyTitle',
      descriptionKey: 'settings.personalVocabularyDescription',
      keywords: [
        'vocabulary',
        'personal',
        'words',
    ...
    {
      id: 'appearance-dialog-emoji',
      tab: PreferencesTab.Appearance,
      titleKey: 'settingsSearch.entry.appearanceDialogEmoji.title',
      descriptionKey: 'settingsSearch.entry.appearanceDialogEmoji.desc',
      keywords: [
        'emoji',
        'emojis',
        'dialog',
    ...
    {
      id: 'appearance-classic-experience',
      tab: PreferencesTab.Appearance,
      titleKey: 'classicExperience.heading',
      ...
      teleportTargetId: 'settingsClassicExperience',
    },
    {
    ...
    },
    {
      ...
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: [
        'schedule',
        'scheduled',
        'date',
    ...
    },
    {
      ...
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsEnabled',
      descriptionKey: 'appearance.scheduledSettingsRuleHelp',
      keywords: ['schedule', 'enabled', 'active', '啟用', '生效'],
    },
    {
      id: 'appearance-scheduled-language',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsLanguage',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: [
        'schedule',
        'language',
        'english',
    ...
    },
    {
      ...
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsTheme',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'theme', 'light', 'dark', 'system', '主題'],
    },
    {
      id: 'appearance-scheduled-highlight',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsHighlightFeatures',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'highlight', 'customization', '標示', '自訂'],
    },
    {
      id: 'appearance-scheduled-accent-palette',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsAccentPalette',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'accent', 'palette', 'color', '主色'],
    },
    {
      id: 'appearance-scheduled-update-progress-palette',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsUpdateProgressPalette',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'update', 'progress', 'palette', '更新進度'],
    },
    {
      id: 'appearance-scheduled-surface-palette',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsSurfacePalette',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'surface', 'palette', '表面'],
    },
    {
      id: 'appearance-scheduled-elevation',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsElevation',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'elevation', 'shadow', '陰影'],
    },
    {
      id: 'appearance-scheduled-ui-font',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsUIFont',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'font', 'typeface', 'ui', '字型'],
    },
    {
      id: 'appearance-scheduled-monospace-font',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsMonospaceFont',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'font', 'monospace', '等寬'],
    },
    {
      id: 'appearance-scheduled-motion',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsMotion',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'motion', 'reduced', '動態'],
    },
    {
      id: 'appearance-scheduled-toolbar-labels',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsToolbarLabels',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'toolbar', 'labels', 'icons', '工具列'],
    },
    {
      id: 'appearance-scheduled-toolbar-density',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsToolbarDensity',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'toolbar', 'density', 'compact', '密度'],
    },
    {
      id: 'appearance-scheduled-repository-list-density',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsRepositoryListDensity',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'repository', 'list', 'density', 'repo', '列表'],
    },
    {
      id: 'appearance-scheduled-tab-density',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsTabDensity',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'tab', 'density', 'compact', '分頁'],
    },
    {
      id: 'appearance-scheduled-tab-width',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsTabWidth',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'tab', 'width', 'compact', 'wide', '寬度'],
    },
    {
      id: 'appearance-scheduled-tab-close-buttons',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsTabCloseButtons',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'tab', 'close', 'buttons', '關閉'],
    },
    {
      id: 'appearance-scheduled-submodule-back-style',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsSubmoduleBackStyle',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'submodule', 'back', 'style', '子模組', '返回'],
    },
    {
      id: 'appearance-scheduled-submodule-back-label',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsSubmoduleBackLabel',
      descriptionKey: 'appearance.scheduledSettingsValueDescription',
      keywords: ['schedule', 'submodule', 'back', 'label', '文字'],
    },
    {
      id: 'appearance-scheduled-start-date',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsStartDate',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'start date', 'calendar', '日期', '開始日期'],
    },
    {
      id: 'appearance-scheduled-end-date',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsEndDate',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'end date', 'calendar', '日期', '結束日期'],
    },
    {
      id: 'appearance-scheduled-start-time',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsStartTime',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'start time', 'clock', '時間', '開始時間'],
    },
    {
      id: 'appearance-scheduled-end-time',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsEndTime',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'end time', 'clock', '時間', '結束時間'],
    },
    {
      id: 'appearance-scheduled-all-days',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsAllDays',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'daily', 'every day', '每日'],
    },
    {
      id: 'appearance-scheduled-weekdays',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsWeekdays',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'weekday', 'days', '星期', '日子'],
    },
    {
      id: 'appearance-scheduled-source',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsSource',
      descriptionKey: 'appearance.scheduledSettingsDescription',
      keywords: ['schedule', 'local', 'api', 'home assistant', '來源'],
    },
    {
      id: 'appearance-scheduled-api-endpoint',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsAPIEndpoint',
      descriptionKey: 'appearance.scheduledSettingsAPIHelp',
      keywords: ['schedule', 'api', 'endpoint', 'https', '端點'],
    },
    {
      id: 'appearance-scheduled-home-assistant-url',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsHomeAssistantBaseURL',
      descriptionKey: 'appearance.scheduledSettingsHomeAssistantHelp',
      keywords: ['schedule', 'home assistant', 'ha', 'url', '網址'],
    },
    {
      id: 'appearance-scheduled-home-assistant-entity',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsHomeAssistantEntity',
      descriptionKey: 'appearance.scheduledSettingsHomeAssistantHelp',
      keywords: [
        'schedule',
        'home assistant',
    ...
    {
      id: 'appearance-scheduled-home-assistant-token',
      tab: PreferencesTab.Appearance,
      titleKey: 'appearance.scheduledSettingsHomeAssistantToken',
      descriptionKey: 'appearance.scheduledSettingsHomeAssistantHelp',
      keywords: ['schedule', 'home assistant', 'token', 'credential', '密鑰'],
    },
    ...
    // Self-hosted server
    {
      ...
      titleKey: 'settingsSearch.entry.selfHostedServer.title',
      descriptionKey: 'settingsSearch.entry.selfHostedServer.desc',
      keywords: ['self-hosted', 'server', 'provision', '本機伺服器'],
    },
    ...
    {
      id: 'sound-narrator-voice',
      tab: PreferencesTab.Sound,
      titleKey: 'settings.soundNarratorVoiceTitle',
      descriptionKey: 'settings.soundNarratorVoiceDescription',
      keywords: [
        'voice',
        'narrator',
        'speech',
