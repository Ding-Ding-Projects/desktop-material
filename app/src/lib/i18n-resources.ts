export type TranslationKey =
  ...
  | 'copilotConflict.skippedHeading'
  | 'copilotConflict.resolutionNotApplied'
  | 'copilotConflict.partialApplication'
  | 'copilotConflict.retryDiff'
  | 'copilotConflict.unableLoadDiff'
  | 'copilotConflict.noResolution'
  | 'copilotConflict.currentFile'
  | 'copilotConflict.incomingFile'
  | 'copilotConflict.useCurrentFile'
  | 'copilotConflict.useIncomingFile'
  | 'copilotConflict.keepFile'
  | 'copilotConflict.deleteFile'
  | 'copilotConflict.copilotChoice'
...
export const englishTranslations: Readonly<Record<TranslationKey, string>> = {
  ...
  'copilotConflict.skippedHeading': '{count} Skipped by Copilot',
  'copilotConflict.resolutionNotApplied': 'Resolution not applied',
  'copilotConflict.partialApplication':
    'Some resolutions were not applied. Resolve each listed file manually before continuing.',
  'copilotConflict.retryDiff': 'Retry loading diff',
  'copilotConflict.unableLoadDiff':
    'Unable to load the diff for this file. Try again or resolve it manually.',
  'copilotConflict.noResolution':
    'No Copilot resolution is available for this file.',
  'copilotConflict.currentFile': 'Use current file',
  'copilotConflict.incomingFile': 'Use incoming file',
  'copilotConflict.useCurrentFile': 'Use current file',
  'copilotConflict.useIncomingFile': 'Use incoming file',
  'copilotConflict.keepFile': 'Keep file',
  'copilotConflict.deleteFile': 'Delete file',
  'copilotConflict.copilotChoice': 'Copilot',
  'copilotConflict.modifyDeleteRecommendation':
    'Copilot provided a keep or delete recommendation. Choose the manual action from Summary.',
  'copilotConflict.editedResultsAuthorityUnavailable':
    'Edited conflict results require the guarded application authority.',
  'copilotConflict.editedResultsNotApplied':
    'Edited conflict results were not all applied.',
  'copilotConflict.continueBlocked':
    'Some files were skipped or refused. Resolve them manually before continuing.',
  'palette.setCopilotAlwaysResolveConflicts':
...
> = {
  ...
  'copilotConflict.skippedHeading': 'Copilot 跳過咗 {count} 個檔案',
  'copilotConflict.resolutionNotApplied': '解決方案未套用',
  'copilotConflict.partialApplication':
    '有啲解決方案未能套用，請先逐個手動處理下面列出嘅檔案先可以繼續。',
  'copilotConflict.retryDiff': '重試載入 diff',
  'copilotConflict.unableLoadDiff':
    '呢個檔案嘅 diff 載入唔到，可以重試，或者手動處理。',
  'copilotConflict.noResolution': '呢個檔案冇 Copilot 解決方案。',
  'copilotConflict.currentFile': '使用目前檔案',
  'copilotConflict.incomingFile': '使用傳入檔案',
  'copilotConflict.useCurrentFile': '使用目前檔案',
  'copilotConflict.useIncomingFile': '使用傳入檔案',
  'copilotConflict.keepFile': '保留檔案',
  'copilotConflict.deleteFile': '刪除檔案',
  'copilotConflict.copilotChoice': 'Copilot',
  'copilotConflict.modifyDeleteRecommendation':
    'Copilot 提議保留或者刪除，請喺 Summary 揀返手動動作。',
  'copilotConflict.editedResultsAuthorityUnavailable':
    '手改嘅衝突結果要經安全套用權限處理。',
  'copilotConflict.editedResultsNotApplied': '手改嘅衝突結果未能全部套用。',
  'copilotConflict.continueBlocked':
    '有檔案被跳過或者拒絕，請先手動處理先可以繼續。',
