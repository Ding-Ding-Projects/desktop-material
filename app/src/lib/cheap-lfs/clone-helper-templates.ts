export const CHEAP_LFS_CLONE_HELPER_MANAGED_BY =
  'desktop-material-cheap-lfs-clone-helper/v1'

export const CHEAP_LFS_CLONE_HELPER_TEXT_MARKER =
  'desktop-material-managed-cheap-lfs-clone-helper:v1'

export const CHEAP_LFS_CLONE_HELPER_MAXIMUM_INVENTORY_BYTES = 8 * 1024 * 1024
export const CHEAP_LFS_CLONE_HELPER_MAXIMUM_ENTRIES = 4096

/**
 * Standalone, dependency-free Node runtime checked into a managed repository.
 *
 * It deliberately does not import Desktop Material. A fresh clone only needs
 * Node and GitHub CLI, and both platform wrappers execute these same bytes.
 */
export const CHEAP_LFS_CLONE_HELPER_HYDRATE_MJS = String.raw`// desktop-material-managed-cheap-lfs-clone-helper:v1
...
export const CHEAP_LFS_CLONE_HELPER_HYDRATE_PS1 = String.raw`# desktop-material-managed-cheap-lfs-clone-helper:v1
...
export const CHEAP_LFS_CLONE_HELPER_HYDRATE_SH = String.raw`#!/usr/bin/env sh
# desktop-material-managed-cheap-lfs-clone-helper:v1
set -eu
...
export const CHEAP_LFS_CLONE_HELPER_README = `<!-- desktop-material-managed-cheap-lfs-clone-helper:v1 -->
