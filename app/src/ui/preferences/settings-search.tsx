...
> {
  ...
  public componentDidUpdate(prevProps: ISettingsSearchProps) {
    if (prevProps.results !== this.props.results) {
      ...
      const clamped = count === 0 ? -1 : Math.min(this.state.highlightedIndex, count - 1)
                      ...
                      >
                        <span className="settings-search-result-copy">
                          <strong className="settings-search-result-title">
                            {this.renderHighlighted(title, match.matches.title)}
                          </strong>
  ...
  private renderStatus() {
    ...
    return (
      <div
        className="settings-search-status"
        role="status"
        aria-live="polite"
      >
        {message}
    ...
    return (
      <div className="settings-search">
        <div className="settings-search-field">
          ...
          />
          <input
            data-search-surface-id={SettingsSearchSurfaceId}
        ...
        <FilterModeControl
          searchSurfaceId={SettingsSearchSurfaceId}
