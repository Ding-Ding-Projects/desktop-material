...
import { ISettingsSearchEntry } from '../../lib/settings-search/settings-search-catalog'
import {
  persistFilterMode,
...
import { SettingsSearchSurfaceId } from './settings-search'
...
> {
  ...
  private settingsSearchResults: ReadonlyArray<
        ...
        <div className="preferences-container">
          <div className="preferences-rail">
            ...
            >
              ...
              {this.renderRailTab(PreferencesTab.Git, octicons.gitCommit, 'Git')}
              {this.renderRailTab(
