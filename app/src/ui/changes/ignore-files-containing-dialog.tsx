...
> {
  ...
  private updatePattern = (event: React.FormEvent<HTMLInputElement>) => {
    this.setState({ pattern: event.currentTarget.value, error: null })
  }
    ...
    return (
      ...
      >
        <DialogContent>
          ...
          <label htmlFor="ignore-files-containing-pattern">
            {t('ignoreFilesContaining.patternLabel')}
          </label>
          <input
            id="ignore-files-containing-pattern"
            type="text"
            value={this.state.pattern}
            onChange={this.updatePattern}
            disabled={this.state.isSaving}
            aria-describedby="ignore-files-containing-preview"
          />
          <div
            role="group"
