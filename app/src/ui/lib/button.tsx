...
export interface IButtonProps {
  ...
  /**
   * Coordinate this button with every other entry path for the same action.
   * When omitted, asynchronous re-entry is still blocked for this instance.
   */
...
export class Button extends React.Component<IButtonProps, {}> {
  ...
  private onClick = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    return singleFlightActions.run(this.activationKey, () => onClick(event))
  }
