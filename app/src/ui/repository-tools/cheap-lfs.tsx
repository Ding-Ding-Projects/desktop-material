    ...
    return (
      ...
      >
        ...
        <p className="cheap-lfs-pin-help">
          {provider === 'release'
            ? 'Files up to 500 MiB upload as a single asset; larger files are split automatically into 500 MiB parts. A published prerelease is created without changing the stable Latest release.'
