...
export class App extends React.Component<IAppProps, IAppState> {
  ...
  /** Which shell avatar owns the one floating account switcher. */
  ...
  /**
   * Render the restored Material shell unconditionally.
   *
   * The classic toolbar remains a live compatibility control inside the
   * shell, but there is no second app-wide interface mode to drift away from
   * the checked-in History design.
   */
  private renderApp() {
    // Point the controllers at the selected repository before building the
    // views so a repository switch cannot render stale destination data.
  ...
  /**
   * The single application chrome shared by every destination.
   *
   * `navigation` remains injectable for focused accessibility coverage of
   * the rail component; the production App always uses the design's drawer.
   */
