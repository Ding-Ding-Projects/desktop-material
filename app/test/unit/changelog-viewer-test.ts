  ...
  const releases = [
    {
      ...
      time: '09:30',
      entries: [
        { category: 'Fixed', text: 'Stop the crash on launch' },
        { category: 'Added', text: 'A regex builder' },
      ],
    },
    {
      version: '1.9.0',
      date: '2026-01-05',
      time: '17:45',
      entries: [{ category: 'Fixed', text: 'Repair the date picker' }],
    },
    {
      version: '1.8.0-beta1',
      date: null,
      time: null,
      entries: [{ category: null, text: 'An uncategorized change' }],
    },
  ]
  ...
  const releases = [
    {
      ...
      date: '2026-03-10',
      time: '09:30',
      entries: [{ category: 'Fixed', text: 'Stop the crash' }],
    },
    {
      version: '1.8.0-beta1',
      date: null,
