...
const NewCommandEvents = [
  ...
  'palette:close-tab',
  'palette:close-other-tabs',
  'palette:close-tabs-to-left',
  'palette:close-tabs-to-right',
  'palette:favorite-tab',
  'palette:rename-tab',
  'palette:move-tab-to-group',
  'palette:collapse-tab-group',
  'palette:delete-tab-group',
  'palette:sort-tabs-label-ascending',
  'palette:sort-tabs-label-descending',
  'palette:sort-tabs-opened-newest',
  'palette:sort-tabs-opened-oldest',
  'palette:sort-tabs-status-attention-first',
  'palette:sort-tabs-status-clean-first',
  'palette:sort-tabs-favorite-first',
  'palette:sort-tabs-favorite-last',
  'palette:undo-settings-change',
  'palette:redo-settings-change',
  'palette:sign-in-dotcom',
  'palette:sign-in-enterprise',
]
