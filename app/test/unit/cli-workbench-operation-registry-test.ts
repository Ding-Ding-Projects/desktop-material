  ...
  it('rejects unknown IDs, extra fields, and injection-shaped values', async () => {
    ...
    try {
      const rejected: ReadonlyArray<unknown> = [
        ...
        { id: 'content-search', pattern: 'x', patternMode: 'perl' },
        { id: 'content-search', pattern: 'x', patternMode: 'fixed-strings' },
        { id: 'content-search', pattern: 'x', patternMode: true },
        { id: 'content-search', pattern: 'x', ignoreCase: false },
        { id: 'content-search', pattern: 'x', ignoreCase: 'yes' },
        {
          id: 'content-search',
          pattern: 'x',
          patternMode: 'extended-regexp',
