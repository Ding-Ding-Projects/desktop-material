...
| **P1 Git** | Command palette; full interactive-rebase todo editor; shallow and sparse controls; signing settings; hooks, LFS, remotes, worktrees, patch exchange, and bundle import/verify | **Restore-file and export slices done; remaining functions planned** |
