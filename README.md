...
| Worktree merge and delete menu | ![Linked worktree right-click menu showing its action filter, Merge, Delete, and lock actions](docs/assets/screenshots/worktree-context-menu-merge-delete.png) |
| Worktree merge preview | ![Merge into main preview with the linked feature branch selected and one commit ready for review](docs/assets/screenshots/worktree-merge-preview-from-context-menu.png) |
