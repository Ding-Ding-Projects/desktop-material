...
| **P0 — verification pending** | Deepen a shallow repository's history | **Implemented and pushed at `462b0c7281`; focused tests and a disposable real-Git depth 1 → 3 → full-history proof pass; fresh production/off-screen UI evidence remains before Done** |
| **P0 — next** | Create a pull request; review, update, and merge a pull request; download Actions artifacts with provenance; inspect the effective branch rules for the current branch | **In progress** |
