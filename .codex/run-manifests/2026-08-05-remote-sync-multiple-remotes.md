...
- Ordered background interactions:
  ...
  5. Do not trigger the network action: the fixture was used for UI evidence, while the sequential multi-remote fetch selection is covered by focused unit tests.
